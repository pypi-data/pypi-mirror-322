...
class H2OEngineServiceApi(object):
    ...
    def h2_o_engine_service_get_h2_o_engine(
        ...
        **kwargs
        ...
        >>> thread = api.h2_o_engine_service_get_h2_o_engine(name_11, async_req=True)
        >>> result = thread.get()

        Args:
            name_11 (str): H2OEngine resource name. Format: workspaces/{workspace}/h2oEngines/{h2o_engine}  Authorization may require the following permission on the engine's parent workspace: * actions/enginemanager/h2oEngines/GET
