...
class NotebookEngineProfileServiceApi(object):
    ...
    def notebook_engine_profile_service_get_notebook_engine_profile(
        ...
        **kwargs
        ...
        >>> thread = api.notebook_engine_profile_service_get_notebook_engine_profile(name_15, async_req=True)
        >>> result = thread.get()

        Args:
            name_15 (str): NotebookEngineProfile resource name. Format: workspaces/{workspace}/notebookEngineProfiles/{notebook_engine_profile}  Authorization may require the following permission on the profile's parent workspace: * actions/enginemanager/notebookEngineProfiles/GET
