...
def test_create_h2o_global_workspace(h2o_engine_client, delete_all_h2os_before_after):
...
def test_create_multiple_namespaces(h2o_engine_client, delete_all_h2os_before_after):
    # When
    e1_id = "engine1"
...
def test_lifecycle(h2o_engine_client, delete_all_h2os_before_after):
    # When
    e = h2o_engine_client.create_engine(
        workspace_id=AIEM_WORKSPACE_2_ID,
        version="latest",
