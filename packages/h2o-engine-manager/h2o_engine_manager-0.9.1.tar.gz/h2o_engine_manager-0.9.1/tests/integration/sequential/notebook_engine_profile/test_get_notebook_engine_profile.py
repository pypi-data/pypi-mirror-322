...
def test_get_notebook_engine_profile(
    ...
    profile_by_super_admin: NotebookEngineProfile = notebook_engine_profile_client_super_admin.get_notebook_engine_profile(
        name="workspaces/global/notebookEngineProfiles/p1"
    )

    # Admin can get this profile because has assigned role.
    profile_by_admin: NotebookEngineProfile = notebook_engine_profile_client_admin.get_notebook_engine_profile(
        name="workspaces/global/notebookEngineProfiles/p1"
    )
    ...
    assert profile_by_admin.name == "workspaces/global/notebookEngineProfiles/p1"
