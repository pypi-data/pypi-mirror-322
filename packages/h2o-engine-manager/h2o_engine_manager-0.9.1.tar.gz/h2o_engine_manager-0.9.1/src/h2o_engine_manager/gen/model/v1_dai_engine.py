...
class V1DAIEngine(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            profile (str): Optional. The resource name of the DAIEngineProfile that is assigned to this DAIEngine. Format is `workspaces/*/daiEngineProfiles/*`.. [optional]  # noqa: E501
