...
class H2OEngineProfileServiceApi(object):
    ...
    def h2_o_engine_profile_service_get_h2_o_engine_profile(
        ...
        **kwargs
        ...
        >>> thread = api.h2_o_engine_profile_service_get_h2_o_engine_profile(name_10, async_req=True)
        >>> result = thread.get()

        Args:
            name_10 (str): H2OEngineProfile resource name. Format: workspaces/{workspace}/h2oEngineProfiles/{h2o_engine_profile}  Authorization may require the following permission on the profile's parent workspace: * actions/enginemanager/h2oEngineProfiles/GET
