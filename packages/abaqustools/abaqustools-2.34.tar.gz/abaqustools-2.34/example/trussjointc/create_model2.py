...
kw.material(fid,'DECK',15e3,0.3,1200)
...
for k in np.arange(0,7):
    ...
    node1=nodes_el_chord[k,1]
    node2=nodes_el_chord[k,2]
...
for k in np.arange(0,8):
    ...
    # Stiffness for x,y,z,rx,ry,rz (local system)
    # kj1=[1e12,1e12,1e12,1e12,1e12,1e12]
    kj1=[1e10,1e10,1e10,1e10,0,0]
    kj2=[1e10,1e10,1e10,1e10,0,0]
    #kj2=[1e99,1e99,1e99,1e99,1e99,1e99]
...
kw.shellgrid(fid,'DECK','DECK','DECK',0.2,0,0,0,1,1,100,10,500e3,1e3)
...
kw.boundary(fid,'new','support',[1,4,0],'part_truss')
