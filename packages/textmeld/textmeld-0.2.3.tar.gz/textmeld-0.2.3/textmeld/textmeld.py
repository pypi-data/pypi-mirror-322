...
class TextMeld:
    ...
    def should_exclude_from_content(self, file_path: str) -> bool:
        ...
        return any(fnmatch.fnmatch(normalized_path, pattern.rstrip('/')) for pattern in self.exclude_patterns)
    ...
    def _generate_tree(self, directory: str, prefix: str = "") -> str:
        ...
        for i, item in enumerate(items):
            ...
            # print(directory, item, "--", self.should_exclude_from_content(item))
