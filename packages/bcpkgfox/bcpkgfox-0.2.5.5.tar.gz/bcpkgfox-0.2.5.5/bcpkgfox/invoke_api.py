...
def invoke_api_list(link: str, token: str, print_response: Optional[bool] = False) -> dict:
    """
...
def invoke_api_proc(link: str, payload_vars: dict, token: str, method: Optional[str] = "POST", print_response: Optional[bool] = False) -> str:
    """
    Exemplo de uso abaixo:
    ...
    for attempt in range(1, max_attempts + 1):
        try:
            ...
            response_insert = http_methods[method](url, json=payload, headers=headers)
