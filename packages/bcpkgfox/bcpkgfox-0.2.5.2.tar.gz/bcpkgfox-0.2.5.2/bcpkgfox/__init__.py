...
def create_dirs(specifics_dirs: Optional[list] = None, disable_print_response: str = False) -> str:
    ...
    for dir_ in dirs_sub.values():
        for pasta in sub_pastas.values():
...
def initialize_driver():
    global driver
    if driver is None:
        driver = get_driver.backcode__dont_use__launch_browser(dir_dir)
        return driver
