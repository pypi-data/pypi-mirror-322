...
def format_readable_output(blocks: List[Dict]) -> DocumentContent:
    ...
    try:
                    ...
                    for rel in block["Relationships"]:
                        if rel["Type"] == "VALUE":
                            for value_id in rel["Ids"]:
                                ...
                                if value_block:
                                    # Store geometry information for the value
                                    value_geometry = value_block.get("Geometry", {})

                                    # Check for selection elements in the value block
                                    ...
                                    # If no selection element found, get regular text
        ...
        # Also process standalone SELECTION_ELEMENT blocks
        for block in blocks:
                ...
                form_fields.append(
                    {
                        ...
                        "geometry": {
                            "key_bbox": {},  # Empty since it's a standalone element
                            "value_bbox": block.get("Geometry", {}).get(
                                "BoundingBox", {}
                            ),
                            "key_polygon": [],  # Empty since it's a standalone element
