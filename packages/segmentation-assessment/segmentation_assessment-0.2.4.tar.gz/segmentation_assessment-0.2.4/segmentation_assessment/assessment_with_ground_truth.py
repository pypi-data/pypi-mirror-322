...
function.distribution_number_object(title="number_objects.png")
...
function.distribution_number_object(dico_algo_max=dico_algo_max,dico_algo_min=dico_algo_min,title="number_objects_filtered.png")
