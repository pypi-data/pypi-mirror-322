...
if __name__ == "__main__":
    # Required for PyInstaller and Windows
    multiprocessing.set_start_method("spawn", force=True)  # Use "spawn" explicitly
    multiprocessing.freeze_support()  # Ensure compatibility with PyInstaller
    mem_fit_free_diffusion(param, tau, yexp, weights=1)