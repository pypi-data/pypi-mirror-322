...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, name=None, repository=None, base_path=None, pulp_labels=None, content_guard=None, no_content_change_since=None, pulp_href=None, pulp_created=None, prn=None, hidden=False, pulp_last_updated=None, repository_version=None, registry_path=None, remote=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
