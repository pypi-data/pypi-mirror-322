...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, versions_href=None, name=None, manifest_signing_service=None, description=None, retain_repo_versions=None, pulp_labels=None, pulp_href=None, latest_version_href=None, pulp_created=None, prn=None, pulp_last_updated=None, local_vars_configuration=None):  # noqa: E501
