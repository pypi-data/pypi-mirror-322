...
def create_postgres_engine(*, host, username, database, password, sslmode, sync_azure_credential) -> AsyncEngine:
...
def create_postgres_engine_from_env(sync_azure_credential=None) -> AsyncEngine:
...
def create_postgres_engine_from_args(args, sync_azure_credential=None) -> AsyncEngine:
