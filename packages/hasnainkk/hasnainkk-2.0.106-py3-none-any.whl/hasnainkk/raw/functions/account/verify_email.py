...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <hasnainkk.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <hasnainkk.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <hasnainkk.raw.base.account.EmailVerified>`
    """
