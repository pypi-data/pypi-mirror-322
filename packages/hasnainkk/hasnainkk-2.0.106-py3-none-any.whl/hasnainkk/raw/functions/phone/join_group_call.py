...
class JoinGroupCall(TLObject):  # type: ignore
    ...
    Parameters:
        call (:obj:`InputGroupCall <hasnainkk.raw.base.InputGroupCall>`):
            N/A

        join_as (:obj:`InputPeer <hasnainkk.raw.base.InputPeer>`):
            N/A

        params (:obj:`DataJSON <hasnainkk.raw.base.DataJSON>`):
            N/A
