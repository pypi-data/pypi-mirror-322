...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.InputMedia`.
    ...
    Parameters:
        file (:obj:`InputFile <hasnainkk.raw.base.InputFile>`):
            N/A

        mime_type (``str``):
            N/A

        attributes (List of :obj:`DocumentAttribute <hasnainkk.raw.base.DocumentAttribute>`):
            N/A
        ...
        thumb (:obj:`InputFile <hasnainkk.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <hasnainkk.raw.base.InputDocument>`, *optional*):
            N/A
