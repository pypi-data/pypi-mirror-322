...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <hasnainkk.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <hasnainkk.raw.base.GroupCallParticipant>`):
            N/A
