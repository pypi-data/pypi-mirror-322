...
class ForumTopic(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.ForumTopic`.
    ...
    Parameters:
        ...
        from_id (:obj:`Peer <hasnainkk.raw.base.Peer>`):
            N/A
        ...
        draft (:obj:`DraftMessage <hasnainkk.raw.base.DraftMessage>`, *optional*):
            N/A
