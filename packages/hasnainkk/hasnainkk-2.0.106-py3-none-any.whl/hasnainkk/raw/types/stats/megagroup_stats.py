...
class MegagroupStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.stats.MegagroupStats`.
    ...
    Parameters:
        period (:obj:`StatsDateRangeDays <hasnainkk.raw.base.StatsDateRangeDays>`):
            N/A

        members (:obj:`StatsAbsValueAndPrev <hasnainkk.raw.base.StatsAbsValueAndPrev>`):
            N/A

        messages (:obj:`StatsAbsValueAndPrev <hasnainkk.raw.base.StatsAbsValueAndPrev>`):
            N/A

        viewers (:obj:`StatsAbsValueAndPrev <hasnainkk.raw.base.StatsAbsValueAndPrev>`):
            N/A

        posters (:obj:`StatsAbsValueAndPrev <hasnainkk.raw.base.StatsAbsValueAndPrev>`):
            N/A

        growth_graph (:obj:`StatsGraph <hasnainkk.raw.base.StatsGraph>`):
            N/A

        members_graph (:obj:`StatsGraph <hasnainkk.raw.base.StatsGraph>`):
            N/A

        new_members_by_source_graph (:obj:`StatsGraph <hasnainkk.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <hasnainkk.raw.base.StatsGraph>`):
            N/A

        messages_graph (:obj:`StatsGraph <hasnainkk.raw.base.StatsGraph>`):
            N/A

        actions_graph (:obj:`StatsGraph <hasnainkk.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <hasnainkk.raw.base.StatsGraph>`):
            N/A

        weekdays_graph (:obj:`StatsGraph <hasnainkk.raw.base.StatsGraph>`):
            N/A

        top_posters (List of :obj:`StatsGroupTopPoster <hasnainkk.raw.base.StatsGroupTopPoster>`):
            N/A

        top_admins (List of :obj:`StatsGroupTopAdmin <hasnainkk.raw.base.StatsGroupTopAdmin>`):
            N/A

        top_inviters (List of :obj:`StatsGroupTopInviter <hasnainkk.raw.base.StatsGroupTopInviter>`):
            N/A

        users (List of :obj:`User <hasnainkk.raw.base.User>`):
            N/A

    Functions:
        This object can be returned by 1 function.

        .. currentmodule:: hasnainkk.raw.functions
