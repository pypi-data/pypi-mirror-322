...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <hasnainkk.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <hasnainkk.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <hasnainkk.raw.base.PremiumSubscriptionOption>`):
            N/A
