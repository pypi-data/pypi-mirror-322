...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <hasnainkk.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <hasnainkk.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <hasnainkk.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <hasnainkk.raw.base.updates.State>`):
            N/A
