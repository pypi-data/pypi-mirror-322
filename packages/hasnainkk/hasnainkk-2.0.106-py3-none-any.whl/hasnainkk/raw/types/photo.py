...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <hasnainkk.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <hasnainkk.raw.base.VideoSize>`, *optional*):
            N/A
