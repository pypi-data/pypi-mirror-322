...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <hasnainkk.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <hasnainkk.raw.base.PhoneConnection>`):
            N/A
