...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <hasnainkk.raw.base.PollAnswerVoters>`, *optional*):
            N/A
        ...
        solution_entities (List of :obj:`MessageEntity <hasnainkk.raw.base.MessageEntity>`, *optional*):
            N/A
