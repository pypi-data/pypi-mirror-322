...
class BotInlineResult(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.BotInlineResult`.
    ...
    Parameters:
        ...
        send_message (:obj:`BotInlineMessage <hasnainkk.raw.base.BotInlineMessage>`):
            N/A
        ...
        thumb (:obj:`WebDocument <hasnainkk.raw.base.WebDocument>`, *optional*):
            N/A

        content (:obj:`WebDocument <hasnainkk.raw.base.WebDocument>`, *optional*):
            N/A
