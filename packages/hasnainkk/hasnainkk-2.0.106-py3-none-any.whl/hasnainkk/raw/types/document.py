...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.Document`.
    ...
    Parameters:
        ...
        thumbs (List of :obj:`PhotoSize <hasnainkk.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <hasnainkk.raw.base.VideoSize>`, *optional*):
            N/A
