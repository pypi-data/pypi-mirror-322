...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <hasnainkk.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <hasnainkk.raw.base.Reaction>`, *optional*):
            N/A
