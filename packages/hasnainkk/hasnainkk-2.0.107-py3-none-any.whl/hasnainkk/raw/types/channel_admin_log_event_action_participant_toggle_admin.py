...
class ChannelAdminLogEventActionParticipantToggleAdmin(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.ChannelAdminLogEventAction`.
    ...
    Parameters:
        prev_participant (:obj:`ChannelParticipant <hasnainkk.raw.base.ChannelParticipant>`):
            N/A

        new_participant (:obj:`ChannelParticipant <hasnainkk.raw.base.ChannelParticipant>`):
            N/A
