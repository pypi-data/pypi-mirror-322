...
class User(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.User`.
    ...
    Parameters:
        ...
        photo (:obj:`UserProfilePhoto <hasnainkk.raw.base.UserProfilePhoto>`, *optional*):
            N/A

        status (:obj:`UserStatus <hasnainkk.raw.base.UserStatus>`, *optional*):
            N/A
        ...
        emoji_status (:obj:`EmojiStatus <hasnainkk.raw.base.EmojiStatus>`, *optional*):
            N/A
