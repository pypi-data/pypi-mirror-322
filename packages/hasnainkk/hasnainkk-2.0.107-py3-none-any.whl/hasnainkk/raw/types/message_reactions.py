...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <hasnainkk.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <hasnainkk.raw.base.MessagePeerReaction>`, *optional*):
            N/A
