...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <hasnainkk.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <hasnainkk.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A

        switch_webview (:obj:`InlineBotWebView <hasnainkk.raw.base.InlineBotWebView>`, *optional*):
            N/A
