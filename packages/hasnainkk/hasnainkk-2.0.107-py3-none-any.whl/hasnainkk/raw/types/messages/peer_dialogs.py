...
class PeerDialogs(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs (List of :obj:`Dialog <hasnainkk.raw.base.Dialog>`):
            N/A

        messages (List of :obj:`Message <hasnainkk.raw.base.Message>`):
            N/A
