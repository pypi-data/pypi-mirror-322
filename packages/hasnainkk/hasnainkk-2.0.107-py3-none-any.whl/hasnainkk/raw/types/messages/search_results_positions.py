...
class SearchResultsPositions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.messages.SearchResultsPositions`.
    ...
    Parameters:
        ...
        positions (List of :obj:`SearchResultsPosition <hasnainkk.raw.base.SearchResultsPosition>`):
            N/A
