...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <hasnainkk.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <hasnainkk.raw.base.Peer>`):
            N/A
