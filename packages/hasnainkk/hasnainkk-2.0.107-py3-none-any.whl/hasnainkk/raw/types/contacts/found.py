...
class Found(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.contacts.Found`.
    ...
    Parameters:
        my_results (List of :obj:`Peer <hasnainkk.raw.base.Peer>`):
            N/A

        results (List of :obj:`Peer <hasnainkk.raw.base.Peer>`):
            N/A
