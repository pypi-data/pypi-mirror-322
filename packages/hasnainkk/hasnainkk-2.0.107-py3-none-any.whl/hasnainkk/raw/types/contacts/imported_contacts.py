...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <hasnainkk.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <hasnainkk.raw.base.PopularContact>`):
            N/A
