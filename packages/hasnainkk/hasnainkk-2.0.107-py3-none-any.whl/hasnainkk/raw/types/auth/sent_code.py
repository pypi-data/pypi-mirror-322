...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <hasnainkk.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <hasnainkk.raw.base.auth.CodeType>`, *optional*):
            N/A
