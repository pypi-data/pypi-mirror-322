...
class ChatInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.ChatInvite`.
    ...
    Parameters:
        ...
        photo (:obj:`Photo <hasnainkk.raw.base.Photo>`):
            N/A
        ...
        participants (List of :obj:`User <hasnainkk.raw.base.User>`, *optional*):
            N/A
