...
class PageBlockRelatedArticles(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.PageBlock`.
    ...
    Parameters:
        title (:obj:`RichText <hasnainkk.raw.base.RichText>`):
            N/A

        articles (List of :obj:`PageRelatedArticle <hasnainkk.raw.base.PageRelatedArticle>`):
            N/A
