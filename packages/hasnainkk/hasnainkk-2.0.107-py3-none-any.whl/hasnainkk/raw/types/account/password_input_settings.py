...
class PasswordInputSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.account.PasswordInputSettings`.
    ...
    Parameters:
        new_algo (:obj:`PasswordKdfAlgo <hasnainkk.raw.base.PasswordKdfAlgo>`, *optional*):
            N/A
        ...
        new_secure_settings (:obj:`SecureSecretSettings <hasnainkk.raw.base.SecureSecretSettings>`, *optional*):
            N/A
