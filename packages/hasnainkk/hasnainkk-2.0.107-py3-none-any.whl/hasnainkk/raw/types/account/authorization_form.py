...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hasnainkk.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <hasnainkk.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <hasnainkk.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <hasnainkk.raw.base.SecureValueError>`):
            N/A
