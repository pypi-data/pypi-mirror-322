...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~hasnainkk.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <hasnainkk.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <hasnainkk.raw.base.JSONValue>`, *optional*):
            N/A

    Returns:
        Any object from :obj:`~hasnainkk.raw.types`
    """
