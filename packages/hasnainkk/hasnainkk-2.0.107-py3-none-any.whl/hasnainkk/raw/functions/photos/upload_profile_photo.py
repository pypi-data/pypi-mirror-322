...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <hasnainkk.raw.base.InputUser>`, *optional*):
            N/A

        file (:obj:`InputFile <hasnainkk.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <hasnainkk.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <hasnainkk.raw.base.VideoSize>`, *optional*):
            N/A

    Returns:
        :obj:`photos.Photo <hasnainkk.raw.base.photos.Photo>`
    """
