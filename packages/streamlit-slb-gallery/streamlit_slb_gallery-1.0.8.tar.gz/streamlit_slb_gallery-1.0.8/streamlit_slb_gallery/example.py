...
def show_main_content():
    ...
    st.session_state["selected_datetime_from"] = st.selectbox(key="start_date", label="Start Date", options=["2024-07-01 06:00:00","2024-07-02 06:00:00","2024-07-03 06:00:00","2024-07-04 06:00:00","2024-07-05 06:00:00"], )	
    st.session_state["selected_datetime_to"] = st.selectbox(key="end_date", label="Start Date", options=["2024-07-01 06:00:00","2024-07-02 06:00:00","2024-07-03 06:00:00","2024-07-04 06:00:00","2024-07-05 06:00:00"])	
...
def show_streamlit_slb_gallery():      
    if "selected_datetime_from" in st.session_state and "selected_datetime_to" in st.session_state:
        st.session_state.selected_data = streamlit_slb_gallery(
            ...
            token="eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6IllUY2VPNUlKeXlxUjZqekRTNWlBYnBlNDJKdyIsImtpZCI6IllUY2VPNUlKeXlxUjZqekRTNWlBYnBlNDJKdyJ9..dNLYjNacaJFF-UTM25eS3yHAyuAud3FFLI2QjNsQw18-GB21ew9KGQvWWceU_ePewqDPgjZCnO7HAouPIiJSXUc9zgMOvjUrznLQG36igBXSFoKz3tUoMNheuI4_izCrwqIyLZXjTamsGq-B5TZG4ZgIQUAZuwUM01GOAHzknXbWGkheOu9SmRW8bpCgZ9Ovu95ao5jomnWwA930SEjUevSJCAWQdeckPu8ZyKCae9Vg0MiNAJZQcItEbbMMh3ilT8vYegWahmDmWvhVRvU5YVf93Rkg3WDuPbVZoMQh6Bx_SbRS9Be7jwQSan4cOxN7ST5BVxGxb_PWTtZ3XkzzIQ",
