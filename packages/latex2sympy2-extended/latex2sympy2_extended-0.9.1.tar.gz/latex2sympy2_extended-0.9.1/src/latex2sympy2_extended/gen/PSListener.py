...
class PSListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by PSParser#number_with_commas.
    def enterNumber_with_commas(self, ctx:PSParser.Number_with_commasContext):
        pass

    # Exit a parse tree produced by PSParser#number_with_commas.
    def exitNumber_with_commas(self, ctx:PSParser.Number_with_commasContext):
        pass
