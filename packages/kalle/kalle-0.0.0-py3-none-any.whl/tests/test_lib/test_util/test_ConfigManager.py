...
class TestConfigManager(unittest.TestCase):
  ...
  def test_config_init(self):
    ...
    self.assertEqual(self.config.google_app_credentials_path, None)
    self.assertEqual(self.config.conversation_file, None)
  ...
  def test_config_properties(self):
    ...
    properties_to_test = [
        ...
        ("conversation_file", "tests/fixtures/kalle_data/conversations/conversation_default.json"),
    ]
