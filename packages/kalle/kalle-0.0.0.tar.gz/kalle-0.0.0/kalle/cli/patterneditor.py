...
from textual.containers import HorizontalGroup, VerticalScroll, VerticalGroup, Horizontal, Vertical
from textual.widget import Widget
from textual.widgets import Label, Input, Button, TextArea, Footer, Header, Static, DirectoryTree, Log, Select, SelectionList, Rule
...
class Editor(VerticalGroup):
  ...
  def compose(self) -> ComposeResult:
    ...
    profile_options = []
    for i, k in enumerate(config_manager.profiles.keys()):
