...
def test_location_written_correctly_to_csv(setup_empty_csv_repository):
    ...
    location_in_csv = os.path.normpath(all_resources[schemas.DataResource.names.location][0])
    ...
    assert location_in_csv == expected_location_in_csv, (
        f"Expected {expected_location_in_csv}, but got {location_in_csv}"
    )
    assert last_update_in_csv == expected_last_update, (
...
def test_convert_conc_pair(setup_empty_csv_repository):
    ...
    expected_data = {
        ...
        "product": [
            ...
            "fi_17100",
            "fi_17100",
            "C_munic_renew_waste|C_munic_non_renew_waste",
            "C_elec_POWM",
            "C_DOIL",
            "C_DOIL",
        ],
