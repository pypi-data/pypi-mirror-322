...
class CollectionInSpec:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        object_type = cast(Union[Literal["CollectionInSpec"], Unset], d.pop("object_type", UNSET))
        if object_type != "CollectionInSpec" and not isinstance(object_type, Unset):
            raise ValueError(f"object_type must match const 'CollectionInSpec', got '{object_type}'")
