...
from backtestsuite import __version__, __author__
...
setup(
    ...
    keywords=("backtestsuite", "backtest,Analysis"),
    ...
    packages=find_packages(exclude=['dist', 'docs', 'backtestsuite.egg-info']),
