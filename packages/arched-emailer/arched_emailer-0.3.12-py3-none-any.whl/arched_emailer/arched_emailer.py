...
class ArchedEmailer:
    ...
    def _initialize_logger(self, log_file: Optional[str]=None, log_level: Optional[str] = None):
        """
        ...
        self.log("debug", f"Logger initialized with log file: {log_file} and level: {log_level}")
    ...
    def init_app(self, app, intercept_errors: Optional[bool] = True, add_current_user: bool = True, ignore_url_patterns=None, **kwargs):
        ...
        self._initialize_logger(log_level="DEBUG")
        ...
        if intercept_errors:
            ...
            def handle_http_exception(error):
                ...
                self.log("debug", "Re-raising the exception after processing.")
                raise error
