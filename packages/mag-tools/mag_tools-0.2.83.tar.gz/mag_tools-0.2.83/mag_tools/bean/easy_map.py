...
class EasyMap(Dict[K, V]):
    ...
    def add_string(self, key: K, value: str) -> 'EasyMap[K, V]':
        return self.add(key, value)

    def add_int(self, key: K, value: int) -> 'EasyMap[K, V]':
        return self.add(key, value)

    def add_datetime(self, key: K, value: datetime) -> 'EasyMap[K, V]':
        return self.add(key, value)

    def add_date(self, key: K, value: date) -> 'EasyMap[K, V]':
        return self.add(key, value)

    def add_time(self, key: K, value: time) -> 'EasyMap[K, V]':
        return self.add(key, value)

    def add_bool(self, key: K, value: bool) -> 'EasyMap[K, V]':
        return self.add(key, value)

    def add_float(self, key: K, value: float) -> 'EasyMap[K, V]':
        return self.add(key, value)

    def add_decimal(self, key: K, value: Decimal) -> 'EasyMap[K, V]':
        return self.add(key, value)

    def add_enum(self, key: K, value: BaseEnum) -> 'EasyMap[K, V]':
        return self.add(key, value)
