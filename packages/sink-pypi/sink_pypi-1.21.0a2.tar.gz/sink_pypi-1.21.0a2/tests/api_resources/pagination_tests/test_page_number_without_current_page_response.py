...
class TestPageNumberWithoutCurrentPageResponse:
    ...
    def test_streaming_response_list(self, client: Sink) -> None:
        with client.pagination_tests.page_number_without_current_page_response.with_streaming_response.list() as response:
...
class TestAsyncPageNumberWithoutCurrentPageResponse:
    ...
    async def test_streaming_response_list(self, async_client: AsyncSink) -> None:
        async with async_client.pagination_tests.page_number_without_current_page_response.with_streaming_response.list() as response:
            assert not response.is_closed
