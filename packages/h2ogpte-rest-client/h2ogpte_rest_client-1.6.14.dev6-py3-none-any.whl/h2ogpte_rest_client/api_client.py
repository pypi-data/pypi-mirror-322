...
from h2ogpte_rest_client.api_response import ApiResponse, T as ApiResponseT
import h2ogpte_rest_client.models
from h2ogpte_rest_client import rest
from h2ogpte_rest_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/1.6.14-dev6/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(h2ogpte_rest_client.models, klass)
