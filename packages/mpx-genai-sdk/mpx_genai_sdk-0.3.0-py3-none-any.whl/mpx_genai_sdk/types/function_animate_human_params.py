...
__all__ = ["FunctionAnimateHumanParams"]


class FunctionAnimateHumanParams(TypedDict, total=False):
    ...
    animation_prompt: Annotated[str, PropertyInfo(alias="animationPrompt")]
    """The prompt to use for the animation if animationType is set to **animate**."""

    animation_type: Annotated[str, PropertyInfo(alias="animationType")]
    """The type of animation to use for the character.

    Allowed values are (none, rig_only, animate)
    """
