...
class VisionInit:
    def __init__(self, camera, model_path="https://github.com/UmarBalak/PerceptionPro/raw/refs/heads/main/yolov8s.pt"):
        """
        Initialize the VisionInit with camera and speech settings.
