...
```python
import my_giphy_hive_ti_client
```
...
import my_giphy_hive_ti_client
from my_giphy_hive_ti_client.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to https://api.giphy.com/v1
# See configuration.py for a list of all supported configuration parameters.
configuration = my_giphy_hive_ti_client.Configuration(
...
# Configure API key authorization: bpi_key
configuration.api_key['bpi_key'] = os.environ["API_KEY"]

# Uncomment below to setup prefix (e.g. Bearer) for API key, if needed
# configuration.api_key_prefix['bpi_key'] = 'Bearer'


# Enter a context with an instance of the API client
with my_giphy_hive_ti_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = my_giphy_hive_ti_client.GifsApi(api_client)
