...
def collect_central_plant_data(hvac_info):
    ...
    central_plant_data["Total Cooling Towers"] = hvac_counts.get("cooling_tower_count", 0)
    ...
    feature_details = {
        ...
        "Cooling Towers with Temp Sensors": hvac_features.get("cooling_tower_temp_count", 0),
    }
