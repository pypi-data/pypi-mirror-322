...
from sberpm.nlp.label_propagation._net import train, evaluate, predict, ConvNeuralNet
from sberpm.nlp.label_propagation._custom_dataset import CustomLabeledDataset, CustomNonLabeledDataset
from sberpm.nlp.label_propagation._custom_exceptions import NotEnoughSamplesForLabelError
...
class LabelPropagation:
    ...
    Examples
    --------
    >>> from sberpm.nlp.label_propagation import LabelPropagation
    >>>
    >>> lp = LabelPropagation(
    ... my_data,
