...
from models.generic_base_models import ExceptionResponse
...
class BaseObj(object):
    ...
    def _generate_exception_obj(self, exc: Exception) -> ExceptionResponse:
        ...
        err_str = "EXCEPTION IN ({}, LINE {} '{}'): {}".format(filename, lineno, line.strip(), exc)
        ...
        return ExceptionResponse(
            ...
            lineno=lineno,
            codeLine=line.strip().replace("\\", "/").replace("\r", "").replace("\n", " ").replace('"', "'"),
