...
```python
import my_test_hive_1_ti_client
```
...
import my_test_hive_1_ti_client
from my_test_hive_1_ti_client.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to https://api.giphy.com/v1
# See configuration.py for a list of all supported configuration parameters.
configuration = my_test_hive_1_ti_client.Configuration(
...
with my_test_hive_1_ti_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = my_test_hive_1_ti_client.GifsApi(api_client)
