...
class StatusEnum(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): * `active` - active * `inactive` - inactive * `invalid` - invalid., must be one of ["active", "inactive", "invalid", ]  # noqa: E501

        Keyword Args:
            value (str): * `active` - active * `inactive` - inactive * `invalid` - invalid., must be one of ["active", "inactive", "invalid", ]  # noqa: E501
