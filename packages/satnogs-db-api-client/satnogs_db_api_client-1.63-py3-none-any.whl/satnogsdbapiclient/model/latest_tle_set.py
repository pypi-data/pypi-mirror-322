...
class LatestTleSet(ModelNormal):
    ...
    def _from_openapi_data(cls, tle0, tle1, tle2, tle_source, sat_id, norad_cat_id, updated, *args, **kwargs):  # noqa: E501
        ...
        Args:
            tle0 (str): Returns TLE line 0
            tle1 (str): Returns TLE line 1
            tle2 (str): Returns TLE line 2
            tle_source (str): Returns TLE source
            sat_id (str): Returns Satellite Satellite Identifier
            norad_cat_id (int): Returns Satellite NORAD ID
            updated (datetime): Returns TLE updated datetime
