...
class UpgradeAsaDeviceInput(BaseModel):
    ...
    """ # noqa: E501
    asa_version: StrictStr = Field(description="The target ASA firmware version to upgrade the device to. This field cannot be blank.", alias="asaVersion")
    ...
    __properties: ClassVar[List[str]] = ["asaVersion", "asdmVersion"]
