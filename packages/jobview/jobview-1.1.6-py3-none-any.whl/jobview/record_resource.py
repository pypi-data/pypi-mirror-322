        ...
        if usage_match: 
            ...
            for part in parts:
                ...
                if len(key_value) == 2:
                    ...
                    value = value.strip()
                    if key == 'cpu':
                        usage['cpu_time_sec_str'] = cpu_match.group()
                        if value.lower() == 'n/a':
                        ...
                        if value.lower() == 'n/a':
                            ...
                            usage['accumulate_memory_gbs'] = humanfriendly.parse_size(value,binary=False)
                        ...
                        if value.lower() == 'n/a':
                            ...
                            usage['max_vmem_gb'] = humanfriendly.parse_size(value,binary=False)
            break
    if usage:
        # 添加当前时间
