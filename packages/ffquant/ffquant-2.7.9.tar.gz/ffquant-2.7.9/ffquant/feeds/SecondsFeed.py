...
class SecondsFeed(bt.feeds.DataBase):
    ...
    def fill_gap(self):
        ...
        for i in range(0, len(self.cache_data_list)):
            ...
            if cur_data['timeClose'] / 1000 - prev_data['timeClose'] / 1000 > self.p.compression:
                for j in range(1, int((cur_data['timeClose'] / 1000 - prev_data['timeClose'] / 1000) / self.p.compression)):
                    inherited_data = {}
                    inherited_data['timeOpen'] = prev_data['timeOpen'] + self.p.compression * j * 1000
                    inherited_data['timeClose'] = inherited_data['timeOpen'] + self.p.compression * 1000
                    inherited_data['createTime'] = inherited_data['timeClose']
                    inherited_data['updateTime'] = inherited_data['timeClose']
