 ...
 * TDDFT, TDA, TDHF or CIS. See [1] F. Furche, R. Ahlrichs, J. Chem. Phys. 117, 16 (2002)
 */
...
class TDDFTGradientCalculator {
 ...
 private:
  ...
  SpinPolarizedData<SCFMode, Eigen::MatrixXd> hPlus(SpinPolarizedData<SCFMode, Eigen::MatrixXd> V);
  SpinPolarizedData<SCFMode, Eigen::MatrixXd> hMinus(SpinPolarizedData<SCFMode, Eigen::MatrixXd> V);
