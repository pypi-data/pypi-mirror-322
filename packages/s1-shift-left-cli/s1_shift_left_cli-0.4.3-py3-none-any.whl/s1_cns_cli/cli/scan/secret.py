...
def secret_pre_evaluation(args):
    ...
    if args.publish_result and (args.repo_url == "" or args.repo_full_name == "" or args.provider == ""):
        raise MissingRequiredFlags(
            "Please provide mandatory flags (--repo-url, --repo-full-name, --provider) to publish results to SentinelOne CNS.")
