...
# Remove create-autonomous-database-azure-key-details from oci db autonomous-database
database_cli.autonomous_database_group.commands.pop(database_cli.create_autonomous_database_azure_key_details.name)


# Remove create-autonomous-database-oci-key-details from oci db autonomous-database
database_cli.autonomous_database_group.commands.pop(database_cli.create_autonomous_database_oci_key_details.name)


# Remove create-autonomous-database-oracle-managed-key-details from oci db autonomous-database
database_cli.autonomous_database_group.commands.pop(database_cli.create_autonomous_database_oracle_managed_key_details.name)
...
# Simplifying the parameter ssh_public_keys to take an ssh_authorized_keys_file input optional parameter
...
@cli_util.option('--ssh-authorized-keys-file', type=click.File('r'), help="""A file containing one or more public SSH keys to use for SSH access to the Exadb VM Cluster. Use a newline character to separate multiple keys. The length of the combined keys cannot exceed 10,000 characters.""")
@click.pass_context
@json_skeleton_utils.json_skeleton_generation_handler(input_params_to_complex_types={'ssh-public-keys': {'module': 'database', 'class': 'list[string]'}, 'vm-file-system-storage': {'module': 'database', 'class': 'ExadbVmClusterStorageDetails'}, 'nsg-ids': {'module': 'database', 'class': 'list[string]'}, 'backup-network-nsg-ids': {'module': 'database', 'class': 'list[string]'}, 'freeform-tags': {'module': 'database', 'class': 'dict(str, string)'}, 'defined-tags': {'module': 'database', 'class': 'dict(str, dict(str, object))'}, 'data-collection-options': {'module': 'database', 'class': 'DataCollectionOptions'}}, output_type={'module': 'database', 'class': 'ExadbVmCluster'})
@cli_util.wrap_exceptions
