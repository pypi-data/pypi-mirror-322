...
def embed_view(
    ...
    **kwargs,
    ...
    response = invoke_view(request, path_name, *args, **kwargs, GET=GET, POST=POST)
...
class SingletonPathMixin:
    ...
    def invoke(
        ...
        **kwargs,
        ...
        return invoke_view(request, path_name, *args, **kwargs, GET=GET, POST=POST)
    ...
    def embed(
        ...
        **kwargs,
        ...
        if path_name is None:
            raise Exception(f"View {cls} was not registered with create_path().")
        return embed_view(request, path_name, *args, **kwargs, GET=GET, POST=POST)
    ...
    def swap_oob(
        ...
        **kwargs,
        ...
        self_response = cls.invoke(request, *args, **kwargs, GET=GET, POST=POST)
