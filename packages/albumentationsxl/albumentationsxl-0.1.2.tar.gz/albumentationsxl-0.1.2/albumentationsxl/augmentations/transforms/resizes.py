...
from ..functional import resizes as F
...
class RandomScale(DualTransform):
    ...
    Args:
        ...
        interpolation (OpenCV flag): flag that is used to specify the interpolation algorithm. Should be one of:
            pyvips.enums.Kernel.LINEAR, pyvips.enums.Kernel.NEAREST, pyvips.enums.Kernel.CUBIC
            Default: pyvips.enums.Kernel.LINEAR
    ...
    def __init__(
        ...
        interpolation: pyvips.enums.Kernel = pyvips.enums.Kernel.LINEAR,
...
class LongestMaxSize(DualTransform):
    ...
    Args:
        ...
        interpolation (OpenCV flag): interpolation method. Default: pyvips.enums.Kernel.LINEAR.
