"""
    Comp128v1 - A Python implementation of the COMP128v1 algorithm used in GSM SIM cards
...
class Comp128v1:
    """
    A Python implementation of the COMP128v1 algorithm used in GSM SIM cards
    """
    def __init__(self):
    ...
    def comp128v1(self, ki: bytearray, rand: bytearray):
        """
        Calculates SRES and KC using Comp128 V1
