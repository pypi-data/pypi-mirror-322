...
// invoked via F key
  ...
  key_down: function (event) {
    ...
    else if (key == 37 | key == 33 | key == 01 | key == 01 | key == 01 | key == 01 | key == 01) // Left arrow
    {
    ...
    else if (key == 39 | key == 34 | key == 01 | key == 01 | key == 01 | key == 01 | key == 01) // Right arrow
    {
