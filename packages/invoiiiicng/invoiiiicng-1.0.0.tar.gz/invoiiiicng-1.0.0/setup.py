...
setup(
  name = 'invoiiiicng',         #* Your package will have this name
  packages = ['invoiiiicing'],   #* Name the package again
  ...
  keywords = ['invoice', 'excel', 'pdf', 'silver30003000', 'simarpreet'],   # Keywords users can search on pypi.org
