...
class DriverFinderUtils:
    ...
    def find_elements_by_class(driver: webdriver.Remote, name: Optional[str], class_name: Optional[str] = None, parent_name: Optional[str] = None, parent_control_type: Optional[ControlType] = None):
        if parent_name:
            ...
            return DriverFinderUtils.__find_element_by_class(driver, name, class_name)
    ...
    @staticmethod
    def __find_element_by_class(driver: webdriver.Remote, name: Optional[str], class_name: Optional[str] = None):
        target_element = None
