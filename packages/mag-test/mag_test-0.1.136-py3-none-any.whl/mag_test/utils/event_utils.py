...
class EventUtils:
    ...
    @staticmethod
    def process_single_element(driver: AppDriver, element: WebElement, control: Control):
        ...
        if control_type in {ControlType.BUTTON, ControlType.SPLIT_BUTTON, ControlType.MENU_ITEM, ControlType.LABEL, ControlType.EDIT, ControlType.DOC, ControlType.COMBO_BOX}:
            EventUtils.__process_simple(element, control.action, control.value)
        # 树项
        elif control_type in {ControlType.TREE_ITEM}:
            EventUtils.__process_tree(driver, element, control.action, control.value)
        # TAB项、列表项
        ...
        # 表格
            ...
            if control.value:
                value_array = JsonFileUtils.load_json(control.value)
        ...
        # 复选按钮、单选按钮
            ...
            value = StringUtils.to_value(control.value, DataType.BOOLEAN)
        ...
        # 窗口
            ...
            EventUtils.__click_window(driver, control.value)
        # 工具栏
