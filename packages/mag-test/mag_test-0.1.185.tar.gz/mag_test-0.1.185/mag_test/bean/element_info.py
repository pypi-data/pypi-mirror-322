...
class ElementInfo:
    ...
    def __init__(self, element_type:ControlType, name_path:Optional[str]=None, id_path:Optional[str]=None,
        ...
        if parent_name or parent_type or parent_class:
            parent_name = parent_name if parent_name and not parent_name.isdigit() else None
            self.__parent = Control(name=parent_name, control_type=parent_type, class_name=parent_class)
