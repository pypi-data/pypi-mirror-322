...
class ElementFinder:
    ...
    def find(driver:AppDriver, element_info:ElementInfo):
        ...
        # 日期时间
            ...
            if main_element and element_info.is_composite:
                offset = ElementUtils.get_parent_offset(element_info.value, main_element)
                EventUtils.click_offset(driver, main_element, offset)
            else:
                EventUtils.process_single_element(driver, main_element, element_info.main_element)

            # 查找子控件并处理响应事件
            child_element = ElementFinder.__find_child_element(driver, main_element, element_info)
            EventUtils.process_single_element(driver, child_element, element_info.child)
