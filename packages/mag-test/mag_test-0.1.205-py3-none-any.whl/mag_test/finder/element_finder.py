            ...
            try:
                ...
                if menu_Info.menu_type == MenuType.MENU_ITEM:
                    ...
                    if menu_Info.automation_id:
                        ...
                        menu = DriverFinderUtils.find_element_by_class_wait(driver, None, 'PopupMenu')
                        print(menu)
                        # menu_item = DriverFinderUtils.find_element_by_type(driver, menu_Info.name, ControlType.MENU_ITEM)
                        menu_item = DriverFinderUtils.find_element_by_class_wait(driver, menu_Info.name, 'MenuItem')
                else:
