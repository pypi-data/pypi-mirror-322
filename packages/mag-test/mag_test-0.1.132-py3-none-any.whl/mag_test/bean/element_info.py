...
class ElementInfo:
    ...
    def __init__(self, element_type:ControlType, name_path:Optional[str]=None, id_path:Optional[str]=None,
        ...
        self.value = value
        if self.main_type == ControlType.TABLE and value and '.json' in value:
    ...
    def set_main_type(self, control_type:ControlType):
        self.__main_element.control_type = control_type
    ...
    @property
    def main_info(self):
        return self.__main_element.__str__()
    ...
    def parent_info(self):
        return self.__parent.__str__() if self.__parent else None

    @property
    def has_child(self) -> bool:
        return self.__child is not None
    ...
    def is_composite(self):
        return self.__main_element.control_type.is_composite
