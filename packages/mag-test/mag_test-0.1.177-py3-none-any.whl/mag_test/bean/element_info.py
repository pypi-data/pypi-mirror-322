    ...
    def __parse_name_id_path(self, name_path:Optional[str]) -> None:
        ...
        if name_path:
            if name_path.count('/') == 2:
                ...
                # 解析菜单控件
                if menu_item:
                    menu_item_name, menu_item_id, menu_type_str, _ = Control.parse_name_id_path(menu_item, None)
    ...
    def __parse_id_path(self, id_path:Optional[str]) -> None:
        ...
        if id_path:
            if id_path.count('/') == 2:
                ...
                # 解析菜单控件
                if menu_item:
                    menu_item_id, menu_type_str, _ = Control.parse_id_path(menu_item, None)
