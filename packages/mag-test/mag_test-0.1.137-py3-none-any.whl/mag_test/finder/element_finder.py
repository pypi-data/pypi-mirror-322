...
class ElementFinder:
    ...
    def find(driver:AppDriver, element_info: ElementInfo):
        ...
        # 日期时间
            ...
            # 查找主控件并处理响应事件
            main_element = ElementFinder.__find_main_element(driver, parent, element_info.main_info)
    ...
    @staticmethod
    def __find_main_element(driver: AppDriver, parent: WebElement, main_info: Control):
        try:
            ...
            if main_info.is_composite:
                offset = ElementUtils.get_parent_offset(main_info.value, element)
                EventUtils.click_offset(driver, element, offset)
            else:
                EventUtils.process_single_element(driver, element, main_info)
