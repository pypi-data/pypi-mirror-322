...
class ApiShieldOperation(
    ...
    def __init__(
        ...
        *,
        ...
        :param endpoint: The endpoint which can contain path parameter templates in curly braces, each will be replaced from left to right with ``{varN}``, starting with ``{var1}``. This will then be `Cloudflare-normalized <https://developers.cloudflare.com/rules/normalization/how-it-works/>`_ Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/api_shield_operation#endpoint ApiShieldOperation#endpoint}
        :param host: RFC3986-compliant host. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/api_shield_operation#host ApiShieldOperation#host}
        :param method: The HTTP method used to access the endpoint. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/api_shield_operation#method ApiShieldOperation#method}
        :param zone_id: The zone identifier to target for the resource. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/api_shield_operation#zone_id ApiShieldOperation#zone_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing ApiShieldOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.51.0/docs/resources/api_shield_operation#import import section} in the documentation of this resource for the id to use
