...
def _get_access_key(access_key=None):
    return (
        access_key or
...
def _get_bearer_token(bearer_token=None):
    return (
        bearer_token or
...
def load_credentials(access_key=None, secret_key=None):
    access_key = _get_access_key(access_key)
...
def include_authorization(
    ...
    bearer_token = _get_bearer_token(bearer_token)
    if bearer_token:
