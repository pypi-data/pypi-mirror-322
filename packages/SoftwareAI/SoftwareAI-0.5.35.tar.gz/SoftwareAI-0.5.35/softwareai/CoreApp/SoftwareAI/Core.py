            ...
            for message in messages:
                for mensagem_contexto in message.content:
                    ...
                    if DebugTokens:
                        ...
                        if lang == "en":
                            log_message(f'📜 Tokens consumed in the document: {run_status.usage.total_tokens} 💸${price:.4f}',
                                        f'📜 Tokens consumed in the document: {run_status.usage.total_tokens} 💸${price:.4f}', 'yellow', bold=True)
                        elif lang == "pt":
                            log_message(f'📜 Tokens Consumidos no documento: {run_status.usage.total_tokens} 💸 ${price:.4f}',
                                        f'📜 Tokens Consumidos no documento: {run_status.usage.total_tokens} 💸 ${price:.4f}', 'yellow', bold=True)
