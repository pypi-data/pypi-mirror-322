...
class PwpMain:
    ...
    def clean_auto_configs(self, path, config, album_dirs):
        """
        ...
        :param path:
        :param config:
        :param album_dirs: list of dirs that are under cleaning, contains paths relative to BASE
        :return: None
        """
        if not config['enable-auto-configuration']:  # pragma: no cover
    ...
    def run_stage_dir(self, stage: str, p_config: PwpConfig, current_dir: PwpDirEntry, recursive=True):
        ...
        for album_dir in album_dirs:
            ...
            self.clean_auto_configs(album_dir, new_conf, album_dirs)
