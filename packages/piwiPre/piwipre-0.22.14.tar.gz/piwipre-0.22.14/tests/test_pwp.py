...
class PwpTester:
    ...
    def program_44(self):
        ...
        self.assert_file("tests/results/ALBUM/2007/2007-06-Juin-26-Errors/2007-06-26-23h45-27-Errors.jpg")
    ...
    def program_211(self):
        ...
        LOGGER.test_msg('')
        LOGGER.test_msg('We also copy a PNG file in the ALBUM, because this could happen in real-life')
        LOGGER.test_msg('')
        ACTOR.copy('tests/sources/PICTURES/Forêt-de-la-Corbière/2023-06-11-17h02-40-Forêt-de-la-Corbière.png',   # noqa
                   'tests/results/ALBUM/2023/2023-07-Juillet-04-BBQ/Forest.png')                                 # noqa
        ...
        # so the date is taken from the enclosing dir
        # and the time from the file creation time
        self.assert_file('tests/results/ALBUM/2023/2023-07-Juillet-04-BBQ/'       # noqa
                         '2023-07-04-18h53-38-BBQ.jpg')                        # noqa
