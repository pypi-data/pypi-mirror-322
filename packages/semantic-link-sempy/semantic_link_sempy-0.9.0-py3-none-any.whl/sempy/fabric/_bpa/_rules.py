    ...
    def get_default_rules() -> List[BestPracticeRule]:
        ...
        return [
            ...
            BestPracticeRule(
                ...
                lambda obj, tom, deps: obj.Expression.replace(" ", "").startswith("0+")
            ...
            BestPracticeRule(
                ...
                lambda obj, tom, deps: obj.Type == TOM.ColumnType.Calculated
                and bool(re.search(r"related\s*\(", obj.Expression, flags=re.IGNORECASE)),
            ...
            BestPracticeRule(
                ...
                lambda obj, tom, deps: len(obj.Expression) == 0,
            ...
            BestPracticeRule(
                ...
                and any(
                    itertools.chain(
                        deps.all_measure_dependencies(obj),
                        deps.all_column_dependencies(obj),
                        deps.all_table_dependencies(obj)
                    )
                ),
