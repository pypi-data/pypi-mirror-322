...
def get_parameters_ridge_fit(power:str):
...
def get_parameters_ridge_classifier(power: str):
    alpha_options = [0.1, 0.5, 1.0, 2.0, 5.0, 10.0, 20.0]
    if power == 'low':
        alpha_options = [0.1, 0.5, 1.0]
    elif power == 'medium':
...
def get_parameters_svc_fit(power:str):
    kernel_options = ['linear', 'poly', 'rbf', 'sigmoid']
    if power == 'low':
        C_options = [0.1, 1.0]
        gamma_options = ['scale']
...
def get_parameters_decision_tree_classifier(power: str):
    max_depth_options = [None, 5, 10, 20]
    min_samples_split_options = [2, 5, 10]
    if power == 'low':
        max_depth_options = [None, 5]
...
def get_parameters_random_forest_classifier(power:str):
    n_estimators_options = [50, 100, 200]
    max_depth_options = [None, 5, 10, 20]
    min_samples_split_options = [2, 5, 10]
    if power == 'low':
...
def get_parameters_gradient_boosting_classifier(power:str):
    n_estimators_options = [50, 100, 200]
    learning_rate_options = [0.01, 0.1, 0.5]
    max_depth_options = [3, 5, 7]
    min_samples_split_options = [2, 5, 10]
...
def get_parameters_knn_classifier(power:str):
    n_neighbors_values = [3, 5, 7, 10, 15]
    weights_options = ['uniform', 'distance']
