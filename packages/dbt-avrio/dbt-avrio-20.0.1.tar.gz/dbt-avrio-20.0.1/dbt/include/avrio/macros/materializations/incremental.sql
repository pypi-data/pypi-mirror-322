...
{% materialization incremental, adapter='avrio', supported_languages=['sql'] -%}
...
{% macro avrio__get_delete_insert_merge_sql(target, source, unique_key, dest_columns, incremental_predicates) -%}
...
{% macro avrio__get_merge_sql(target, source, unique_key, dest_columns, incremental_predicates) -%}
...
{% macro avrio__get_incremental_microbatch_sql(arg_dict) %}
