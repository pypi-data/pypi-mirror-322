...
from dbt.adapters.avrio import AvrioColumn, AvrioConnectionManager, AvrioRelation


@dataclass
class AvrioConfig(AdapterConfig):
    properties: Optional[Dict[str, str]] = None
    view_security: Optional[str] = "definer"


class AvrioAdapter(SQLAdapter):
    Relation = AvrioRelation
    Column = AvrioColumn
    ConnectionManager = AvrioConnectionManager
    AdapterSpecificConfigs = AvrioConfig
