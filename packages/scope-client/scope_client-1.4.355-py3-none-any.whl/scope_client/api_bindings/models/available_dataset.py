...
class AvailableDataset(BaseModel):
    ...
    connector_id: StrictStr = Field(description="Connector ID associated with the dataset.")
    __properties: ClassVar[List[str]] = ["name", "dataset_locator", "dataset_schema", "arthur_shield_dataset", "model_problem_type", "created_at", "updated_at", "id", "connector_id"]
