...
import temp_giphy_3_ti_client
from temp_giphy_3_ti_client.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to https://api.giphy.com/v1
# See configuration.py for a list of all supported configuration parameters.
configuration = temp_giphy_3_ti_client.Configuration(
...
with temp_giphy_3_ti_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = temp_giphy_3_ti_client.GifsApi(api_client)
