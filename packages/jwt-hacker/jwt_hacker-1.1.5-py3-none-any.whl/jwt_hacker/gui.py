...
def main():
    ...
    # Button to open company website
    def open_company_website():
        webbrowser.open("https://greynodesecurity.com")

    org_button = ttk.Button(header_frame, text="Visit Website", command=open_company_website, style="TButton")
    ...
    # Button to open coder's X (Twitter) profile
    def open_twitter_profile():
        webbrowser.open("https://x.com/Z3r0_S3c")

    coder_button = ttk.Button(header_frame, text="Follow Me", command=open_twitter_profile, style="TButton")
    coder_button.pack(side="right", padx=10)
