    ...
    def crop_all_thread(self):
        ...
        with ThreadPoolExecutor(max_workers=10) as executor:
            ...
            with tqdm(as_completed(futures), total=len(futures), desc="Processing") as pbar:
                for future in pbar:
                    try:
                        is_valid = future.result()  # 获取任务结果，捕获异常
                        if not is_valid:
                            error_labels += 1
...
if __name__ == "__main__":
    ...
    # output_path = "/mnt/mydisk/zzl/zn/train_police0120_4nc_crop/train"
    # dataset_path = "/home/dgxuser/zl/yolo-gesture/yoloProcess/yoloproc/yolo/data"
    # output_path = dataset_path+'_crop'
