...
def run_checkm_(
    ...
    **kwargs
    ...
    db_dir (str): The path to the checkm database.
    ...
    **kwargs: Additional arguments.
    ...
    if container == "none":
        ...
        bind_dir = " -v ".join(set([bins_dir+":"+bins_dir, output_dir_parent+":"+output_dir_parent, db_dir+":"+db_dir]))
        command = f"docker run -it{bind_dir} {config.docker_container} checkm lineage_wf {bins_dir} {output_dir}"
    
    elif container == "singularity":
        bind_dir = ",".join(set([bins_dir+":"+bins_dir, output_dir_parent+":"+output_dir_parent, db_dir+":"+db_dir]))
