...
class LiszDataMixin:
    ...
    def _refresh_oaio_refs(self):
        ...
        self.vpo(f"      refreshed oaio refs; {self.oaio_refs=} {self.unused_oaio_refs=}")
    ...
    def _refresh_oaio_values(self):
        ...
        self.vpo(f"      updated oaio values; {self.oaio_refs=} from refreshed {self.oaio_client.client_objectz=}")
    ...
    def on_key_press(self, modifiers: str, key_code: str) -> bool:
        ...
        if self.popups_opened():    # pragma: no cover
            self.vpo(f"      ignored key press because of opened popups {self.popups_opened()}")
            return False
