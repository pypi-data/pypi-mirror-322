...
from .utils import get_if_grad_enabled as get_if_grad_enabled, get_if_show_bp_info as get_if_show_bp_info, is_opt_einsum_available as is_opt_einsum_available
...
from pyvqnet.dtype import dtype_map as dtype_map, get_default_dtype as get_default_dtype, get_readable_dtype_str as get_readable_dtype_str, kbool as kbool, kcomplex128 as kcomplex128, kcomplex64 as kcomplex64, kfloat32 as kfloat32, kfloat64 as kfloat64
...
class QTensor:
    ...
    def any(self):
        ...
        Examples::
            ...
            flag = t.any()
        """
    def fill_rand_uniform_with_bound_(self, min_value, max_value):
    ...
    def fill_rand_signed_uniform_(self, v: int = 1):
        ...
        """
    def fill_rand_normal_(self, m: int = 0, s: int = 1, fast_math: bool = True):
