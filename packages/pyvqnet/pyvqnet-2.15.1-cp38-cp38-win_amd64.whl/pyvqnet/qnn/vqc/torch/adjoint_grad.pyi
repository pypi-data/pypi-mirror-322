import torch
from . import Operation as Operation, QMachine as QMachine, TorchModule as TorchModule, apply_unitary_bmm as apply_unitary_bmm
from .. import load_measure_obs as load_measure_obs, op_history_to_modulelist as op_history_to_modulelist, operation_derivative as operation_derivative
...
class QuantumLayerAdjoint(TorchModule):
