...
class ACTION_MODE: 
    ...
    MARQN_FORWARD=      0x01
    MARQN_BACKWARD=     0x02
    MARQN_MOVE_STOP=    0x03
    MARQN_SPIN_LEFT=    0x04
    MARQN_SPIN_RIGHT=   0x05
    MARQN_LEFT=         0x06
    MARQN_RIGHT=        0x07
    MARQN_SPEED=        0x08
    MARQN_MOTOR=        0x09
    MARQN_PATROL=       0x10
    MAQN_ULTRASONIC=    0x11
    MAQN_SERVO=         0x12
    MAQN_RGB=           0x13
    MAQN_BRIGHT=        0x14      
...
class XGO_ACTION:
    ...
    TURN_YAW=         'TURN_YAW'
    TREEAXIS_ROTAION= 'TREEAXIS_ROTAION'
    PEE=              'PEE'
    SIT_DOWN=         'SIT_DOWN'
    WAVE_HAND=         'WAVE_HAND'
    STRETCH=          'STRETCH'
    WAVE_BODY=        'WAVE_BODY'
    SWING=            'SWING'
    BEGGING_FOR_FOOD= 'BEGGING_FOR_FOOD'
