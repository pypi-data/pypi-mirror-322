...
public class SimilarityMeasures {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Similarity Vector Float12: "+Arrays.toString(calculateSimilarityVector(sample1, sample2)));
        System.out.println("Similarity Vector Int12:   "+Arrays.toString(calculateSimilarityVector(sample1i, sample2i)));
        System.out.println("Similarity Vector Int13:   "+Arrays.toString(calculateSimilarityVector(sample1i, sample3i)));
        System.out.println("Similarity Vector Int14:   "+Arrays.toString(calculateSimilarityVector(sample1i, sample4i)));
    }
    ...
    public static float[] calculateSimilarityVector(float[] a, float[] b) {
//        float cosineSimilarity=cosineSimilarity(a, b);
    ...
    public static float calculateSimilarityAverage(int[] a, int[] b) {
    ...
    public static float[] calculateSimilarityVector(int[] a, int[] b) {
    	float inva=1f/Tools.max(1, Tools.sum(a));
    	float invb=1f/Tools.max(1, Tools.sum(b));
