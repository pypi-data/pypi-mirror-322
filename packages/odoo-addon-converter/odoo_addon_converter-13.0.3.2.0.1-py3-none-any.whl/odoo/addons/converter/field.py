...
class Field(Converter):
    ...
    def __init__(
        ...
        message_formatter: Optional[Callable[[Any, bool], Any]] = None,
        odoo_formatter: Optional[Callable[[Any], Any]] = None,
    ):
        """
        ...
        :param send_empty: False when the field should be skipped
