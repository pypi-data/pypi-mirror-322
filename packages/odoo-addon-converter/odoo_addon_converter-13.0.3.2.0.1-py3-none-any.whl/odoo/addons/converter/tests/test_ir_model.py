...
class Test(TransactionCase):
    def test_get_xmlid_present(self):
        ...
        view_menu = self.env["ir.model.data"].xmlid_to_object("base.view_menu")
        module, xref = self.env["ir.model.data"].object_to_module_and_name(
            view_menu
        )
        ...
        self.assertEqual(
            ...
            .xmlid_to_object("{}.{}".format(module, xref))
            .id,
            view_menu.id,
        )

    def test_get_xmlid_absent(self):
        obj = self.env["ir.config_parameter"].create(
        ...
        # Also check the standard ir.model.data method here.
        new_recset = self.env["ir.model.data"].xmlid_to_object(
            "{}.{}".format(module, xref)
        )
