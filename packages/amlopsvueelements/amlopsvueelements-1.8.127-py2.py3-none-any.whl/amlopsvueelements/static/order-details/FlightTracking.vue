<template>
  <LMap
    ...
    :zoom="zoom"
    :center="
      flightsData?.length && flightsData[0].departure_from
        ? [
            parseFloat(flightsData[0].departure_from.airport_details.latitude),
            parseFloat(flightsData[0].departure_from.airport_details.longitude)
          ]
        : defaultCenter as PointExpression
    "
...
const defaultCenter = [-47.41322, -1.219482];
