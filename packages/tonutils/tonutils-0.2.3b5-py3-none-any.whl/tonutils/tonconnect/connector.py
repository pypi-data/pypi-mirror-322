...
from .utils import create_transfer_message
...
class Connector:
    ...
    async def send_transfer(
        ...
        """
        message = create_transfer_message(destination, amount, body, state_init)
    ...
    async def send_batch_transfer(self, data_list: List[TransferData]) -> int:
        ...
        """
        messages = [create_transfer_message(**data.__dict__) for data in data_list]
