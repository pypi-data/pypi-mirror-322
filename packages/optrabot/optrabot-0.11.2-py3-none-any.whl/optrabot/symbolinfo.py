...
class SymbolInfo:
	...
	def __init__(self, symbol: str, option_symbol_suffix: str, strike_interval: float, quote_step: float, multiplier: float, exchange: str) -> None:
		self.symbol = symbol
...
def initialize_symbol_infos() -> Dict[str, SymbolInfo]:
	symbol_info_dict = {
		"SPX" : SymbolInfo("SPX", "W", 5, 0.05, 100, "SMART"),
	}
