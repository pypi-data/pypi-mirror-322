...
class magnetic_field(Operator):
    """Read/compute Magnetic Field by calling the readers defined by the
    ...
    @staticmethod
    def _spec():
        description = """Read/compute Magnetic Field by calling the readers defined by the
