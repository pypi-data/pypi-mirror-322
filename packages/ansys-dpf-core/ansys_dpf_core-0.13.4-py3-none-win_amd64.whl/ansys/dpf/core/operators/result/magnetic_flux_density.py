...
class magnetic_flux_density(Operator):
    """Read/compute Magnetic Flux Density by calling the readers defined by
    ...
    @staticmethod
    def _spec():
        description = """Read/compute Magnetic Flux Density by calling the readers defined by
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsMagneticFluxDensity
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsMagneticFluxDensity
        """
