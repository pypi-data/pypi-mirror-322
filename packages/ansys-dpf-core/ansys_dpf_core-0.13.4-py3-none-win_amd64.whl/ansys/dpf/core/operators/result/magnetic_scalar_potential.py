...
class magnetic_scalar_potential(Operator):
    """Read/compute Magnetic Scalar Potential by calling the readers defined
    by the datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read/compute Magnetic Scalar Potential by calling the readers defined
            by the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsMagneticScalarPotential
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsMagneticScalarPotential
        """
