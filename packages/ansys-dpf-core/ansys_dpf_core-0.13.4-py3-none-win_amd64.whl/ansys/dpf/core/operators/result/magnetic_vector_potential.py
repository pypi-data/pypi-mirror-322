...
class magnetic_vector_potential(Operator):
    """Read/compute Magnetic Vector Potential by calling the readers defined
    by the datasources.
    ...
    @staticmethod
    def _spec():
        description = """Read/compute Magnetic Vector Potential by calling the readers defined
            by the datasources."""
        spec = Specification(
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsMagneticVectorPotential
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsMagneticVectorPotential
        """
