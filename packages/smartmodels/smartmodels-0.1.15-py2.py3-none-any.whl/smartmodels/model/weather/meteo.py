...
class MeteorologicalStationStats(BaseModel):
    """
    ...
    precipitation_max_ts: Optional[Datetime] = Field(
        None,
        description="TBD",
    )
    ...
    precipitation_min_ts: Optional[Datetime] = Field(
        None,
        description="TBD",
    )
    ...
    air_temperature_max_ts: Optional[Datetime] = Field(
        None,
        description="TBD",
    )
    ...
    air_temperature_min_ts: Optional[Datetime] = Field(
        None,
        description="TBD",
    )
    ...
    air_humidity_max_ts: Optional[Datetime] = Field(
        None,
        description="TBD",
    )
    ...
    air_humidity_min_ts: Optional[Datetime] = Field(
        None,
        description="TBD",
    )
    ...
    wind_speed_max_ts: Optional[Datetime] = Field(
        None,
        description="TBD",
    )
    ...
    wind_speed_min_ts: Optional[Datetime] = Field(
        None,
        description="TBD",
    )
    ...
    wind_direction_max_freq_value: Optional[float] = Field(
        None,
        description="Valor cuantizado que se repite más (max historgram)",
    )
    wind_direction_max_freq_ts: Optional[Datetime] = Field(
        None,
        description="Valor cuantizado que se repite más (max historgram)",
    )
    wind_direction_min_freq_value: Optional[float] = Field(
        None,
        description="Valor cuantizado que se repite menos (max historgram)",

    )
    wind_direction_min_freq_ts: Optional[Datetime] = Field(
        None,
        description="Valor cuantizado que se repite más (max historgram)",
    )
#
...
#     )
    ...
    pressure_max_value_ts: Optional[Datetime] = Field(
        None,
        description="TBD",
    )
    ...
    pressure_min_value_ts: Optional[Datetime] = Field(
        None,
        description="TBD",
    )
...
#     )
    ...
    insolation_max_value_ts: Optional[Datetime] = Field(
        None,
        description="TBD",
    )
    ...
    insolation_min_value_ts: Optional[Datetime] = Field(
        None,
        description="TBD",
    )
