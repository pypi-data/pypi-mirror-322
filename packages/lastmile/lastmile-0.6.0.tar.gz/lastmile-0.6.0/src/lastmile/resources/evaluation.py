...
class EvaluationResource(SyncAPIResource):
    ...
    def evaluate(
        ...
        *,
        ...
        input: List[str],
        labels: List[str],
        metadata: Iterable[evaluation_evaluate_params.Metadata],
        metric: evaluation_evaluate_params.Metric,
        output: List[str],
        common_metadata: evaluation_evaluate_params.CommonMetadata | NotGiven = NOT_GIVEN,
        ...
        Args:
          common_metadata: Common metadata relevant to the application configuration from which all request
    ...
    def evaluate_dataset(
        ...
        *,
        ...
        common_metadata: evaluation_evaluate_dataset_params.CommonMetadata | NotGiven = NOT_GIVEN,
        project_id: str | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
    ...
    def evaluate_run(
        ...
        *,
        ...
        input: List[str],
        labels: List[str],
        metadata: Iterable[evaluation_evaluate_run_params.Metadata],
        metric: evaluation_evaluate_run_params.Metric,
        output: List[str],
        common_metadata: evaluation_evaluate_run_params.CommonMetadata | NotGiven = NOT_GIVEN,
        project_id: str | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
