...
from .schemas import validate_output_with_json_schema, validate_json_schema, validate_json_structure, BaseModel
...
class Supervisor:
    ...
    def create_agent(
        ...
        if tools_description:
            ...
            default_system_prompt += (
                ...
                "Observation: (the tool result) OR (evidence or data gathered during reasoning, if applicable)\n\n"
            )
        else:
            ...
            default_system_prompt += (
                ...
                "Repeat the Plan, Observation and Thought steps as necessary.\n\n"
            )
        
        # Add output schema details if provided
        if output_schema:
            default_system_prompt += (
                f"\nFinally, provide a 'Final Answer:' that conforms to the following JSON schema:\n"
    ...
    def run_agent(
        ...
        for iteration in range(1, agent_iterations + 1):
            ...
            if action_name and action_name in self.tools_registry:
                ...
                if missing_params:
                    ...
                    memory.add_message("system", obs_err)
                ...
                try:
                    ...
                    memory.add_message("system", observation_text)
        ...
        if not final_answer:
            final_answer = "No final answer after max iterations."
        ...
        if output_schema:
            try:
                ...
                validated = parsed_answer  # No schema enforcement, just return the parsed JSON
