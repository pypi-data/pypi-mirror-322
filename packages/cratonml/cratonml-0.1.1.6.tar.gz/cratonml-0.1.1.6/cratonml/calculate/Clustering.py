...
class KMeansClassifier:
    ...
    @staticmethod
    def find_the_best_number_of_clusters(data: np.ndarray) -> tuple[range, ndarray[Any, dtype[Any]], int]:
        """
    ...
    @staticmethod
    def calculate(data: np.ndarray, n_clusters: int) -> tuple[KMeans, ndarray[Any, dtype[Any]] | Any]:
        """
...
class GaussianMixtureClassifier:
    ...
    @staticmethod
    def calculate(data: np.ndarray, n_clusters: int) -> tuple[GaussianMixture, ndarray[Any, dtype[Any]] | Any]:
        """
...
class HDBSCANClassifier:
    ...
    def calculate(data: np.ndarray,
                  ...
                  cluster_selection_epsilon: float = 0.0) -> tuple[HDBSCAN, Any]:
        """
