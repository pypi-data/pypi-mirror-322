...
from logafault.faults import FaultsAPIError, get_all_faults, log_fault_my_address, log_fault_other_address
...
class TestLogFaultOtherAddress:
    def setup_method(self):
        ...
        self.fault_data = {
            "workType": "NS",
            "childWorkType": "NSIP",
            "customLookupCode2": "Large Power User",
