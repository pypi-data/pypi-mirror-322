...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, no_content_change_since=None, base_path=None, pulp_labels=None, base_url=None, prn=None, content_guard=None, hidden=False, pulp_created=None, pulp_href=None, pulp_last_updated=None, name=None, local_vars_configuration=None):  # noqa: E501
