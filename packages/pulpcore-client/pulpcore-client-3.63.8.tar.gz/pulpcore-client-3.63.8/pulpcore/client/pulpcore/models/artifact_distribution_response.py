...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, prn=None, pulp_labels=None, pulp_href=None, base_url=None, name=None, no_content_change_since=None, hidden=False, base_path=None, pulp_created=None, content_guard=None, local_vars_configuration=None):  # noqa: E501
