...
def async_getGenesisSignature(address, limit=1000, until=None,encoding='jsonParsed',commitment=0,get_signature_function=None,errorProof=True,url_1_only=True,url_2_only=False):
...
def getGenesisSignature(*args,**kwargs):
    return call_async_function(async_getGenesisSignature,*args,**kwargs)
