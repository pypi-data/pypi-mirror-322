...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_ceylon_checksum_method_adminagent_details() != 22456:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_method_adminagent_send_direct() != 62086:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_ceylon_checksum_method_workeragent_details() != 34993:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_method_workeragent_send_direct() != 55953:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_ceylon_checksum_constructor_adminagent_new() != 19623:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_constructor_unifiedagent_new() != 21911:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_ceylon_fn_method_adminagent_send_direct.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_ceylon_fn_method_adminagent_send_direct.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_ceylon_fn_method_workeragent_send_direct.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_ceylon_fn_method_workeragent_send_direct.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_ceylon_checksum_method_adminagent_send_direct.argtypes = (
)
_UniffiLib.uniffi_ceylon_checksum_method_adminagent_send_direct.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_ceylon_checksum_method_workeragent_send_direct.argtypes = (
)
_UniffiLib.uniffi_ceylon_checksum_method_workeragent_send_direct.restype = ctypes.c_uint16
...
class AdminAgent:
    ...
    async def send_direct(self, to_peer: "str",message: "bytes") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_ceylon_fn_method_adminagent_send_direct(
                self._uniffi_clone_pointer(), 
...
class UnifiedAgent:
    _pointer: ctypes.c_void_p
    def __init__(self, config: "typing.Optional[UnifiedAgentConfig]",config_path: "typing.Optional[str]",on_message: "MessageHandler",processor: "Processor",on_event: "EventHandler"):
...
class WorkerAgent:
    ...
    async def send_direct(self, to_peer: "str",message: "bytes") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_ceylon_fn_method_workeragent_send_direct(
                self._uniffi_clone_pointer(), 
        _UniffiConverterString.lower(to_peer),
        _UniffiConverterBytes.lower(message)
            ),
...
class AdminAgentConfig:
    ...
    def __str__(self):
        return "AdminAgentConfig(name={}, port={}, buffer_size={})".format(self.name, self.port, self.buffer_size)
...
class _UniffiConverterTypeAdminAgentConfig(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return AdminAgentConfig(
            ...
            buffer_size=_UniffiConverterUInt16.read(buf),
        )
    ...
    def check_lower(value):
        ...
        _UniffiConverterUInt16.check_lower(value.buffer_size)

    @staticmethod
    def write(value, buf):
        _UniffiConverterString.write(value.name, buf)
        _UniffiConverterUInt16.write(value.port, buf)
        _UniffiConverterUInt16.write(value.buffer_size, buf)
...
class WorkerAgentConfig:
    ...
    admin_ip: "str"
    buffer_size: "int"
    def __init__(self, *, name: "str", conf_file: "typing.Optional[str]" = _DEFAULT, work_space_id: "str", admin_peer: "str", role: "str", admin_port: "int", admin_ip: "str", buffer_size: "int"):
        self.name = name
    ...
    def __str__(self):
        return "WorkerAgentConfig(name={}, conf_file={}, work_space_id={}, admin_peer={}, role={}, admin_port={}, admin_ip={}, buffer_size={})".format(self.name, self.conf_file, self.work_space_id, self.admin_peer, self.role, self.admin_port, self.admin_ip, self.buffer_size)
