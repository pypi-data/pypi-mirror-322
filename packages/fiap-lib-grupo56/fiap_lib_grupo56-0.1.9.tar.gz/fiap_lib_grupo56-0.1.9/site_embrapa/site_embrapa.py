...
class SiteEmbrapa:
    ...
    def carregaRepoTodosProcessamentosFromArquivoCSV(self):
        ...
        self.repositorio_cultivares_proc = RepositorioCultivar_proc()
        self.repositorio_processamentos = RepositorioProcessamentosAnuais()
        self.carregaRepoProcessamentoFromArquivoCSV("./arquivos_csv/ProcessaViniferas.csv", EnumTipoUva_proc.VINIFERAS, ";")
        self.carregaRepoProcessamentoFromArquivoCSV("./arquivos_csv/ProcessaAmericanas.csv", EnumTipoUva_proc.AMERICANASEHIBRIDAS, "\t")
        self.carregaRepoProcessamentoFromArquivoCSV("./arquivos_csv/ProcessaMesa.csv", EnumTipoUva_proc.UVASDEMESA, "\t")
        self.carregaRepoProcessamentoFromArquivoCSV("./arquivos_csv/ProcessaSemclass.csv", EnumTipoUva_proc.SEMCLASSIFICACAO, "\t")

    def carregaRepoTodasImportacoesFromArquivoCSV(self):
        self.repositorio_importacoes = RepositorioImportacoesAnuais()
        self.carregaRepoImportacaoFromArquivoCSV("./arquivos_csv/ImpVinhos.csv", EnumCategoria_im_ex.VINHOSDEMESA, ";")
        self.carregaRepoImportacaoFromArquivoCSV("./arquivos_csv/ImpEspumantes.csv", EnumCategoria_im_ex.ESPUMANTES, ";")
        self.carregaRepoImportacaoFromArquivoCSV("./arquivos_csv/ImpFrescas.csv", EnumCategoria_im_ex.UVASFRESCAS, ";")
        self.carregaRepoImportacaoFromArquivoCSV("./arquivos_csv/ImpPassas.csv", EnumCategoria_im_ex.UVASPASSAS, ";")
        self.carregaRepoImportacaoFromArquivoCSV("./arquivos_csv/ImpSuco.csv", EnumCategoria_im_ex.SUCODEUVA, ";")

    def carregaRepoTodasExportacoesFromArquivoCSV(self):
        self.repositorio_exportacoes = RepositorioExportacoesAnuais()
        self.carregaRepoExportacaoFromArquivoCSV("./arquivos_csv/ExpVinho.csv", EnumCategoria_im_ex.VINHOSDEMESA, ";")
        self.carregaRepoExportacaoFromArquivoCSV("./arquivos_csv/ExpEspumantes.csv", EnumCategoria_im_ex.ESPUMANTES, ";")
        self.carregaRepoExportacaoFromArquivoCSV("./arquivos_csv/ExpUva.csv", EnumCategoria_im_ex.UVASFRESCAS, ";")
        self.carregaRepoExportacaoFromArquivoCSV("./arquivos_csv/ExpSuco.csv", EnumCategoria_im_ex.SUCODEUVA, ";")


    def carregaRepoExportacaoFromArquivoCSV(self, path_arquivo_csv: str, categoria: EnumCategoria_im_ex, delimitador_arquivo: str):
        with open(path_arquivo_csv, mode='r', encoding='utf-8') as file:
    ...
    def carregaRepoImportacaoFromArquivoCSV(self, path_arquivo_csv: str, categoria: EnumCategoria_im_ex, delimitador_arquivo: str):
        with open(path_arquivo_csv, mode='r', encoding='utf-8') as file:
            reader = csv.DictReader(file, delimiter = delimitador_arquivo)
    ...
    def carregaRepoProcessamentoFromArquivoCSV(self, path_arquivo_csv: str, tipo_uva: EnumTipoUva_proc, delimitador_arquivo: str):
    ...
    def carregaRepoProdutividadeFromArquivoCSV(self):
        ...
        caminho_csv = files("fiap_lib_grupo56.arquivos_csv").joinpath("producao.csv")
        self.repositorio_categorias_prod = RepositorioCategorias_prod()
        self.repositorio_produtos_prod = RepositorioProdutos_prod()
        self.repositorio_produtividades = RepositorioProdutividadesAnuais()
        categoria_atual = None
