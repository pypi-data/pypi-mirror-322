...
class ShopsSdk:
    ...
    def query(self,id=None,p_name=None,es_name=None,es_id=None,ps_name=None,ps_id=None):
        '''查询'''
        shops = Shops.select()
        if id:
    ...
    def insert(self, p_name: str, es_name: str = None, es_id: int = None, ps_name: str = None, ps_id: int = None,
               c1: str = None,
    ...
    def update(self, id, p_name, es_name: str = None, es_id: int = None, ps_name: str = None, ps_id: int = None,
               c1: str = None,
               c2: str = None, c3: str = None):
        '''更新'''
        obj = Shops.get(id=id)
