...
from fastapi3.exceptions import RequestErrorModel
from fastapi3.types import IncEx, ModelNameMap, UnionType
...
if PYDANTIC_V2:
    ...
    from fastapi3.openapi.constants import REF_PREFIX as REF_PREFIX
