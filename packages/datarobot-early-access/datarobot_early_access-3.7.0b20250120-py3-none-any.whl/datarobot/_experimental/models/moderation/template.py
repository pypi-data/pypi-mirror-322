...
from datarobot._experimental.models.moderation.intervention import GuardInterventionForTemplate
from datarobot._experimental.models.moderation.model_info import GuardModelInfo
from datarobot._experimental.models.moderation.nemo_info import GuardNemoInfo
from datarobot._experimental.models.moderation.utils import exclude_if
...
class ModerationTemplate(APIObject):
    ...
    _converter = t.Dict(
        {
            ...
            t.Key("type"): t.Enum(*[e.value for e in ModerationGuardType]),
    ...
    def __init__(
        ...
        self.id = id
        self.name = name
        self.type = ModerationGuardType(type)
    ...
    def update(
        ...
        type: Optional[ModerationGuardType] = None,
