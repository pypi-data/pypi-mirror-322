...
class YamlUtil(BaseLoggingFeature):
    def __init__(  # pylint: disable=too-many-positional-arguments
            self, verbose: bool, version_num: str, target_dir: str, changelog_desc: str, sdk_num: str) -> None:
    ...
    def _update_yaml_version_history_tag(self):
        ...
        yaml_data["version_history"] = [f"{self.version_num} - {self.changelog_desc}"] + yaml_data.get("version_history")
