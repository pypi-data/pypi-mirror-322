...
class Conversation:
    ...
    def __str__(self) -> str:
        ...
        out += f"Between {', '.join(self.speakers)}\n"
...
class InMemoryConversationStore(ConversationStore):
    ...
    def __init__(self):
        ...
        self.__speakers: Dict[str, set[str]] = {}
        self.__lock = Lock()
    ...
    def _add_conversation(self, conversation: Conversation):
        with self.__lock:
            ...
            for speaker in conversation.speakers:
                if speaker not in self.__speakers:
                    self.__speakers[speaker] = set()
                self.__speakers[speaker].add(conversation.id)
        ...
        with self.__lock:
            ...
            if speakers:
                conversations = [
                    ...
                    if all(speaker in conv.speakers for speaker in speakers)
                ]
