...
class ModeUnsupportedForFeatureView(TectonValidationError):
    def __init__(self, mode: str, has_transformation: bool):
        if has_transformation:
            ...
            msg = 'Instantiating a Realtime Feature View directly for Calculation features is currently in Private Preview. To enable this functionality, enable the feature flag using `from tecton import conf; conf.set("ALLOW_REALTIME_FEATURE_VIEW_NO_TRANSFORMATION", "true")`.'
        else:
