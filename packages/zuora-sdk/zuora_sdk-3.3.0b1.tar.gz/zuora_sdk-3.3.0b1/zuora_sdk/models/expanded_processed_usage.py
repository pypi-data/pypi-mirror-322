...
class ExpandedProcessedUsage(BaseModel):
    ...
    billing_period_end_date: Optional[date] = Field(default=None, alias="billingPeriodEndDate")
    billing_period_start_date: Optional[date] = Field(default=None, alias="billingPeriodStartDate")
