...
class OrderActionRatePlanAmendment(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["code", "contractEffectiveDate", "createdBy", "createdDate", "customerAcceptanceDate", "description", "effectiveDate", "id", "name", "serviceActivationDate", "type", "updatedBy", "updatedDate", "customFields"]
