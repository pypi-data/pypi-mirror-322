...
class BufferElementCursor:
    ...
    @property
    def _type_layout(self) -> TypeLayoutReflection:
        """N/A"""

    @property
    def _type(self) -> TypeReflection:
        """N/A"""
...
SGL_GIT_VERSION: str = 'commit: bc9b8da / branch: main (local changes)'

SGL_VERSION: str = '0.7.0'

SGL_VERSION_MAJOR: int = 0

SGL_VERSION_MINOR: int = 7
