...
class NorgateDataBlankCheckCompany(Filter):
    """
    A Filter that computes True or False for whether a given asset was a Blank Check Company (True or False)
    """
    ...
    def __new__(cls):
        return super(NorgateDataBlankCheckCompany, cls).__new__(cls)

    def _init(self, *args, **kwargs):
        return super(NorgateDataBlankCheckCompany, self)._init(*args, **kwargs)

    @classmethod
    def _static_identity(cls, *args, **kwargs):
        return super(NorgateDataBlankCheckCompany, cls)._static_identity(
            *args, **kwargs
        )
    ...
    def _compute(self, arrays, dates, assets, mask):
        ...
        norgatetimeseriesfunction = norgatedata.black_check_company_listed_timeseries
        result = ConvertNorgateBoolTimeSeriesToFilter(
            assets, norgatetimeseriesfunction, dates, mask
        )
