...
def enviar_correo_electronico(template_path, datos, asunto, destinatarios, cc=None, cco=None, adjuntos=None):
    ...
    # Reemplazar los marcadores con los valores de datos
