...
class CreateSendTestCase:
    ...
    def test_make_request_fails_when_unexpected_request_body_is_faked(self):
        ...
        c.stub_request("clients.json", "create_client.json",
                       201, "unexpected request body")
        self.assertRaises(Exception, c.create, "Client Company Name",
    ...
    def test_bad_request_on_get(self):
        self.cs.stub_request(
            'countries.json', 'custom_api_error.json', status=400)
        self.assertRaises(self.error_responses[400], self.cs.countries)

    def test_unauthorized_on_get(self):
        self.cs.stub_request(
            'countries.json', 'custom_api_error.json', status=401)
    ...
    def test_bad_request_on_post(self):
        ...
        client.stub_request(
            'clients.json', 'custom_api_error.json', status=400)
    ...
    def test_unauthorized_on_post(self):
        client = Client(self.cs.auth_details, "uhiuhiuhiuhiuhiuhiuh")
        client.stub_request(
            'clients.json', 'custom_api_error.json', status=401)
    ...
    def test_bad_request_on_put(self):
        ...
        template.stub_request(
            'templates/uhiuhiuhiuhiuhiuhiuh.json', 'custom_api_error.json', status=400)
