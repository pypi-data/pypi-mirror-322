...
_cipher: str = env_get_str(key=f"{APP_PREFIX}_CRYPTO_DEFAULT_SYMMETRIC_CIPHER",
                           values=list(map(str, SymmetricMode)),
                           def_value="EAX")
CRYPTO_DEFAULT_SYMMETRIC_CIPHER: Final[SymmetricMode] = SymmetricMode(_cipher)
