...
def create_pint_series(
    ...
    unit: str,
    uncertainties: Iterable[float | int] | None = None,
    **kwargs,
) -> pd.Series:
    """
    ...
    Args:
        ...
        uncertainties (Iterable[float | int] | None, optional): The uncertainties
...
class UncertaintyDataFrameAccessor:
    ...
    def add(self, column: str, uncrts: Iterable[float | int]) -> None:
        """
    ...
    def convolute(
        ...
        Args:
            column (str | None): The name of the column to convolute. If None, all columns
    ...
    def deconvolute(
        ...
        Args:
            column (str | None): The name of the column to deconvolute. If None, all columns
