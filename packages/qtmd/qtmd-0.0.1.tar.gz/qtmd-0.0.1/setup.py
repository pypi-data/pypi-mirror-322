...
HOMEPAGE_URL = 'https://github.com/uliontse/qtmd'
DESCRIPTION = 'QTMD: Quick Tool of Model Development.'
LONG_DESCRIPTION = pathlib.Path('README.md').read_text(encoding='utf-8')
VERSION = re.search(r'^__version__\s*=\s*[\'"]([^\'"]*)[\'"]', pathlib.Path('qtmd/__init__.py').read_text(), re.M).group(1)
