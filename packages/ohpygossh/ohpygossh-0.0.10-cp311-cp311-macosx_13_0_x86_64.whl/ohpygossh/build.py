# python build stubs for package gohpygossh
...
mod = Module('_gohpygossh')
mod.add_include('"gohpygossh_go.h"')
...
mod.add_function('gohpygossh_KeysForSsh_CTor', retval('int64_t'), [])
mod.add_function('gohpygossh_KeysForSsh_CloudUser_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('gohpygossh_KeysForSsh_CloudUser_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('gohpygossh_KeysForSsh_PrivKeyAbsPath_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('gohpygossh_KeysForSsh_PrivKeyAbsPath_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('gohpygossh_KeysForSsh_PublicKeyAbsPath_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('gohpygossh_KeysForSsh_PublicKeyAbsPath_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('gohpygossh_KeysForSsh_Err_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('gohpygossh_KeysForSsh_Err_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('gohpygossh_KeysAndInit_CTor', retval('int64_t'), [])
mod.add_function('gohpygossh_KeysAndInit_CloudInitPath_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('gohpygossh_KeysAndInit_CloudInitPath_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('gohpygossh_KeysAndInit_SshKeyPath_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('gohpygossh_KeysAndInit_SshKeyPath_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('gohpygossh_KeysAndInit_CloudUser_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('gohpygossh_KeysAndInit_CloudUser_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('gohpygossh_KeysAndInit_Err_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('gohpygossh_KeysAndInit_Err_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
add_checked_function(mod, 'gohpygossh_GenerateKeysForSsh', retval('int64_t'), [param('char*', 'destinationDir'), param('char*', 'cloudUser')])
add_checked_function(mod, 'gohpygossh_GenerateKeyPairAndCloudInit', retval('int64_t'), [param('char*', 'destinationDir'), param('char*', 'cloudUser')])
add_checked_function(mod, 'gohpygossh_PublicKeyFile', retval('int64_t'), [param('char*', 'file')])
add_checked_string_function(mod, 'gohpygossh_Run', retval('char*'), [param('char*', 'hostname'), param('char*', 'username'), param('char*', 'privateKey'), param('char*', 'command')])
add_checked_string_function(mod, 'gohpygossh_GenerateShortUUID', retval('char*'), [param('int64_t', 'length')])
add_checked_string_function(mod, 'gohpygossh_Hello', retval('char*'), [])

mod.generate(open('gohpygossh.c', 'w'))
