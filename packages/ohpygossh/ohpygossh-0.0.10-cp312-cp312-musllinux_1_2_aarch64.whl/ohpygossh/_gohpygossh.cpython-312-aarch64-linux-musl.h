...
/* package gohpygossh/build/lib.linux-aarch64-cpython-312/ohpygossh */
...
//
extern long long int gohpygossh_KeysAndInit_CTor();
extern char* gohpygossh_KeysAndInit_CloudInitPath_Get(long long int handle);
extern void gohpygossh_KeysAndInit_CloudInitPath_Set(long long int handle, char* val);
extern char* gohpygossh_KeysAndInit_SshKeyPath_Get(long long int handle);
extern void gohpygossh_KeysAndInit_SshKeyPath_Set(long long int handle, char* val);
extern char* gohpygossh_KeysAndInit_CloudUser_Get(long long int handle);
extern void gohpygossh_KeysAndInit_CloudUser_Set(long long int handle, char* val);
extern char* gohpygossh_KeysAndInit_Err_Get(long long int handle);
extern void gohpygossh_KeysAndInit_Err_Set(long long int handle, char* val);

// --- wrapping struct: gohpygossh.KeysForSsh ---
//
extern long long int gohpygossh_KeysForSsh_CTor();
extern char* gohpygossh_KeysForSsh_CloudUser_Get(long long int handle);
extern void gohpygossh_KeysForSsh_CloudUser_Set(long long int handle, char* val);
extern char* gohpygossh_KeysForSsh_PrivKeyAbsPath_Get(long long int handle);
extern void gohpygossh_KeysForSsh_PrivKeyAbsPath_Set(long long int handle, char* val);
extern char* gohpygossh_KeysForSsh_PublicKeyAbsPath_Get(long long int handle);
extern void gohpygossh_KeysForSsh_PublicKeyAbsPath_Set(long long int handle, char* val);
extern char* gohpygossh_KeysForSsh_Err_Get(long long int handle);
extern void gohpygossh_KeysForSsh_Err_Set(long long int handle, char* val);
extern long long int gohpygossh_GenerateKeyPairAndCloudInit(char* destinationDir, char* cloudUser);
extern long long int gohpygossh_GenerateKeysForSsh(char* destinationDir, char* cloudUser);
extern char* gohpygossh_Run(char* hostname, char* username, char* privateKey, char* command);
extern char* gohpygossh_GenerateShortUUID(long long int length);
extern char* gohpygossh_Hello();
extern long long int gohpygossh_PublicKeyFile(char* file);
