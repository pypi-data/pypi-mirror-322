...
class CSMHP(torch.nn.Module):
    ...
    def __init__(self, T, num_clusters, params, model, X_train, step=3, unit='Week', mini_batch = True, batch_input = False, printer = False):
        ...
        self.alpha_kernel.to(self.device)
        self.beta_kernel.to(self.device)
    ...
    def log_likelihood(self, probability, event_times, is_test=False):
        ...
        event_times = event_times.to(self.device)
