...
SUPPORTED_REASONING_MODELS = ["o1-mini", "o1-preview"]
ReasoningModel = Literal["o1-mini", "o1-preview"]

class OpenAIClient:
    def __init__(self, model: str = "gpt-4o", reasoning_model: ReasoningModel = "o1-preview"):
        """Initialize OpenAI client.
        
        Args:
            model: Model to use for general chat/completion
            reasoning_model: Model to use for reasoning (o1-mini or o1-preview)
