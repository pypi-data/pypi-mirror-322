...
class HandleAuthorizationCallback(BaseModel):
    ...
    code_verifier: Optional[StrictStr] = Field(default=None, description="A code verifier for PKCE. This is returned from the get_authorization_url operation if PKCE is enabled.")
    __properties: ClassVar[List[str]] = ["client_id", "client_secret", "redirect_uri_with_code", "state", "code_verifier"]
