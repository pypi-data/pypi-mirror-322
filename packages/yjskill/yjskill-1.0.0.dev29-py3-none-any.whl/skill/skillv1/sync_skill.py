...
def run():
    ...
    job_failed_count = 0
    sync_skill_metric_display_name = "技能下发"
    for edge in edges:
        ...
        if tags["errorCode"] != "0":
            ...
            model_skill_task_and_job_failed(job_client=job_client,
                                            ...
                                            reason="更新设备状态为下发中失败",
                                            metric_local_name=MetricLocalName.Failed,
                                            metric_display_name=sync_skill_metric_display_name,
        ...
        if tags["errorCode"] != "0":
            ...
            skill_task_and_job_failed(job_client=job_client,
                                      ...
                                      message=tags["errorMessage"][:500],
                                      reason=event_reason.format(
                                          edge_display_name, edge_local_name, "创建技能失败"),
                                      metric_local_name=MetricLocalName.Failed,
                                      metric_display_name=sync_skill_metric_display_name,
                                      skill_failed_count=skill_failed_count,
                                      job_failed_count=job_failed_count)
        ...
        if artifact_version is not None:
            ...
            if tags["errorCode"] != "0":
                ...
                skill_task_and_job_failed(job_client=job_client,
                                          ...
                                          message=tags["errorMessage"][:500],
                                          reason=event_reason.format(
                                              edge_display_name, edge_local_name, "技能上线失败"),
                                          metric_local_name=MetricLocalName.Failed,
                                          metric_display_name=sync_skill_metric_display_name,
                                          skill_failed_count=skill_failed_count,
                                          job_failed_count=job_failed_count)
        ...
        create_metric(
            ...
            display_name=sync_skill_metric_display_name,
...
def skill_task_and_job_failed(job_client: JobClient,
                              workspace_id: str,
                              job_name: str,
                              skill_task_name: str,
                              event_kind: EventKind,
