...
def list_devices(
    ...
    try:
        ...
        while current_count < total:
            ...
            if resp is None:
                bcelogger.error(
                    "SyncSkillListDevice list device resp is None, list_device_req=%s", list_device_req)
                break
            ...
            if result is None:
                bcelogger.error(
                    "SyncSkillListDevice list device resp.result is None, list_device_req=%s", list_device_req)
                break
