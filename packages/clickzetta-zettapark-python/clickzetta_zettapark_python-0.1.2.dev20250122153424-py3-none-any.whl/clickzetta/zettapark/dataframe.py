    ...
    def select(
        ...
        *cols: Union[
        ...
        for idx, name in enumerate(names):
            if isinstance(name, UnresolvedAlias) and isinstance(name.child, UDF):
                udf_alias = self._session._analyzer.analyze(
                    name.child, {}, parse_local_name=True, generate_udf_alias=True
                )
                names[idx] = Alias(name.child, udf_alias)
