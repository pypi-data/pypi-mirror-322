...
export default class StaticVertex extends multipleClasses(GraphObject,VertexContainer,EdgeContainer,TypedObject,LabelProvider,SizableObject,LocatableObject,EObjectOwner){
    ...
    isMovable(){
        return this.type.model.get("isMovable")?true:false
    }
