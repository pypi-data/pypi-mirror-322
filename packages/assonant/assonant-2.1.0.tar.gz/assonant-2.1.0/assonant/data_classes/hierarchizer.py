...
class Hierarchizer:
    ...
    def __init__(self, schema_file_path: str, data_retriever: AssonantDataRetriever = None):
        """Assonant Data Class Hierarchizer Constructor.

        Args:
            schema_file_path (str): Path to schema file.
            data_retriever (AssonantDataRetriever, optional): An already instantiate AssonantDataRetriever
        ...
        if data_retriever is not None:
            ...
            try:
                self.data_retriever = AssonantDataRetriever(self.schema_file_path)
    ...
    def _mount_tree_node_set(self, component_info_tuple: Tuple[str, Union[str, None]]) -> set[str]:
        ...
        a data_retriever is needed to allow searching for missing nodes in the schema.
        ...
        if component_info_tuple[COMPONENT_PARENT] is not None:
            ...
            parent_component_info = self.data_retriever.get_component_info(component_info_tuple[COMPONENT_PARENT])
    ...
    def hierarchize_components(self, components: List[Component]) -> List[Component]:
        ...
        for component in components:
            ...
            if isinstance(component, Entry) or isinstance(component, Beamline):
                ...
                component_retrieved_info = self.data_retriever.get_component_info(component.name)
