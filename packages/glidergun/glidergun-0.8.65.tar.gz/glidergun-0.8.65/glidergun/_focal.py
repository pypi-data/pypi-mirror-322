...
from glidergun._utils import batch_process
...
class Focal:
    def focal(
        ...
        return batch_process(cast("Grid", self), f, 8000 // buffer, buffer, max_workers)
    ...
    def fill_nan(self, max_exponent: int = 4, max_workers: int = 1):
        ...
        return batch_process(cast("Grid", self), f, 256, 2**max_exponent, max_workers)
