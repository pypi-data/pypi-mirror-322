...
class SubClip:
    ...
    def copy(self):
        ...
        copy._resizes = self._resizes.copy() if self._resizes is not None else None
        copy._rotations = self._rotations.copy() if self._rotations is not None else None
        copy._positions = self._positions.copy() if self._positions is not None else None
