# TODO: Read this from the other const I have
SMALL_FIX_AMOUNT = 0.000001


# def test():
#     video_t = 1 / 30
#     audio_t = 1 / 44100
#     print(f't base {VideoFrameTHelper.get_frame_t_base(video_t, 30)}')
#     print(f'video index {VideoFrameTHelper.get_frame_index_from_frame_t(video_t, 30)}')
#     print(f't from index 2 {VideoFrameTHelper.get_frame_t_from_frame_index(2, 30)}')
#     print(f'audio tts:')
#     #print(VideoFrameTHelper.get_video_audio_tts_from_video_frame_t(video_t, 30, 44100))
#     print(f'video t from audio t: {VideoFrameTHelper.get_video_frame_t_from_video_audio_frame_t(audio_t, 30)}')
#     print(f'video index from audio index: {VideoFrameTHelper.get_video_frame_index_from_video_audio_frame_index(200, 30, 44100)}')
#     print(f'video t from audio index: {VideoFrameTHelper.get_video_frame_t_from_video_audio_frame_index(200, 30, 44100)}')
#     print(f'video index from audio t: {VideoFrameTHelper.get_video_frame_index_from_video_audio_frame_t(audio_t, 30, 44100)}')
...
class VideoFrameTHelper:
    ...
    @staticmethod
    def get_video_frames_indexes_from_fps_and_duration(fps: float, duration: float):
        """
    ...
    @staticmethod
    def get_video_frames_ts_from_fps_and_duration(fps: float, duration: float):
        """
        ...
        """
        return [
            VideoFrameTHelper.get_frame_t_from_frame_index(i)
            for i in VideoFrameTHelper.get_video_frames_indexes_from_duration(fps, duration)
        ]
    
    @staticmethod
    def get_video_frames_ts_from_number_of_frames(number_of_frames: int):
        """
        Get all the 't' frames time moments for a video
    ...
    def get_frame_t_base(t: float, fps: float):
        ...
        """
        return VideoFrameTHelper.get_frame_index_from_frame_t(t, fps) / fps + SMALL_FIX_AMOUNT
    ...
    def get_frame_index_from_frame_t(t: float, fps: float):
        ...
        return int((t + SMALL_FIX_AMOUNT) // frame_duration)
    ...
    def get_frame_t_from_frame_index(index: int, fps: float):
        ...
        frame 'index'.
        """
        return index / fps + SMALL_FIX_AMOUNT
