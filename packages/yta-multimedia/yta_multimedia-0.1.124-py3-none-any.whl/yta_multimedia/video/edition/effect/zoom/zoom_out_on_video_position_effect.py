...
class ZoomOutOnVideoPositionEffect(Effect):
    ...
    """
    def apply(cls, video: Clip, video_position: Union[tuple, Coordinate, Position], zoom_start_region_size: tuple, rate_function: RateFunctionArgument = RateFunctionArgument.default()):
        """
        ...
        resizes = [
            TFunctionResize.resize_from_to(t, video.duration, resize_factor, 1, RateFunctionArgument.default())
