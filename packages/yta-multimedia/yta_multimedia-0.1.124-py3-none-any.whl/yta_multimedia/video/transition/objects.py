...
class TransitionMethod:
    ...
    def slide(video1: VideoClip, video2: VideoClip, side: Position = Position.OUT_LEFT, **kwargs):
        ...
        t1_arg = MoviepyArgument((0, 0), t1_end_position, TFunctionSetPosition.linear, RateFunctionArgument.default())
        transition_clip_1 = MoviepyWith.apply(video1, with_position = t1_arg)

        t1_position = transition_clip_1.pos(t = 0)
        t2_arg = MoviepyArgument(t2_start_position, (t1_position[0], t1_position[1]), TFunctionSetPosition.linear, RateFunctionArgument.default())
