...
from yta_multimedia.video.edition.video_frame_t_helper import SMALL_FIX_AMOUNT
...
class SubClip:
    ...
    def __init__(self, video: Clip):
        ...
        self._resizes = [(1, 1) for _ in range(self.number_of_frames)]
        self._rotations = [0 for _ in range(self.number_of_frames)]
        # TODO: Use constants
        self._positions = [(1920 / 2, 1080 / 2) for _ in range(self.number_of_frames)]
    ...
    def number_of_frames(self):
        ...
        # the warnings
        return int(self.duration * self.fps + SMALL_FIX_AMOUNT)
    ...
    def number_of_audio_frames(self):
        ...
        pre-processed one).
        """
        return int(self.video.audio.duration * self.video.audio.fps + SMALL_FIX_AMOUNT)
