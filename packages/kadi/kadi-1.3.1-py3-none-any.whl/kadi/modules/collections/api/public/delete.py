...
def delete_collection(id):
    ...
    Until being removed automatically, a deleted collection may be :http:post:`restored
    </api/collections/(int:id)/restore>` or :http:post:`purged
    </api/collections/(int:id)/purge>`.
    """
