...
class Client(_OperationContainer):
    ...
    **Handling Exceptions**
    ...
    def get_branches(
        ...
        :return: A BranchesIterableResponse object.
        """
        params = {
            'filter_by_name': _get_optional_string('name', name),
            'filter_by_user': _get_optional_string('user', user),
        }
        limit = _get_optional_positive_int('limit', limit)
        itersize = _get_optional_positive_int('itersize', itersize) or self.profile.catalog_max_records
        path = _get_quoted_url('v0', 'branches')

        return GetBranchesResponse(
            data_fetcher=self._new_paginate_api_data_fetcher('get', path, params),
    ...
    def get_branch(
        ...
        """
        branch_name = _get_ref_name('branch', branch)
    ...
    def get_namespaces(
        ...
        *,  # From here only keyword arguments are allowed
        ...
        params = {
            'filter_by_name': _get_optional_string('filter_by_name', filter_by_name),
        }
        limit = _get_optional_positive_int('limit', limit)
        itersize = _get_optional_positive_int('itersize', itersize) or self.profile.catalog_max_records
    ...
    def get_tables(
        ...
        *,  # From here only keyword arguments are allowed
        ...
        :return: A TableTablesIterableResponse object.
        """
        ref_name = _get_ref_name('ref', ref)
        params = {
            'filter_by_name': _get_optional_string('filter_by_name', filter_by_name),
            'filter_by_namespace': _get_optional_namespace_name('filter_by_namespace', filter_by_namespace)
            or _get_optional_namespace_name('namespace', namespace),
        }
        limit = _get_optional_positive_int('limit', limit)
        itersize = _get_optional_positive_int('itersize', itersize) or self.profile.catalog_max_records
    ...
    def get_commits(
        ...
        *,  # From here only keyword arguments are allowed
        ...
        :param filter_by_message: Optional, filter the commits by message.
        :param filter_by_author_name: Optional, filter the commits by author name.
        :param filter_by_author_email: Optional, filter the commits by author email.
        ...
        :param filter_by_committer_name: Optional, filter the commits by committer name.
        :param filter_by_committer_email: Optional, filter the commits by committer email.
        :param filter_by_committed_date: Optional, filter the commits by the exact committed date.
        :param filter_by_committed_date_start_at: Optional, filter the commits by committed date start at.
        :param filter_by_committed_date_end_at: Optional, filter the commits by committed date end at.
        ...
        :return: A CommitsIterableResponse object.
        """
        ref = _get_ref_name('ref', ref)

        params = {
            'filter_by_message': _get_optional_string('filter_by_message', filter_by_message),
            'filter_by_author_name': _get_optional_string('filter_by_author_name', filter_by_author_name),
            'filter_by_author_email': _get_optional_string('filter_by_author_email', filter_by_author_email),
            'filter_by_authored_date': _get_optional_timestamp(
                'filter_by_authored_date', filter_by_authored_date
            ),
            'filter_by_authored_date_start_at': _get_optional_timestamp(
                'filter_by_authored_date_start_at', filter_by_authored_date_start_at
            ),
            'filter_by_authored_date_end_at': _get_optional_timestamp(
                'filter_by_authored_date_end_at', filter_by_authored_date_end_at
            ),
            'filter_by_committer_name': _get_optional_string(
                'filter_by_committer_name', filter_by_committer_name
            ),
            'filter_by_committer_email': _get_optional_string(
                'filter_by_committer_email', filter_by_committer_email
            ),
            'filter_by_committed_date': _get_optional_timestamp(
                'filter_by_committed_date', filter_by_committed_date
            ),
            'filter_by_committed_date_start_at': _get_optional_timestamp(
                'filter_by_committed_date_start_at', filter_by_committed_date_start_at
            ),
            'filter_by_committed_date_end_at': _get_optional_timestamp(
                'filter_by_committed_date_end_at', filter_by_committed_date_end_at
            ),
            'filter_by_parent_hash': _get_optional_string('filter_by_parent_hash', filter_by_parent_hash),
            'filter': _get_optional_string('filter', filter),
        }
        limit = _get_optional_positive_int('limit', limit)
        itersize = _get_optional_positive_int('itersize', itersize) or self.profile.catalog_max_records
        path = _get_quoted_url('v0', 'refs', ref, 'commits')
