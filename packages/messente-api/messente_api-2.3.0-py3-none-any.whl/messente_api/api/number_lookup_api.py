...
class NumberLookupApi:
    ...
    def fetch_info(
        self,
        numbers_to_investigate: Annotated[NumbersToInvestigate, Field(description="Numbers for lookup")],
        ...
        _param = self._fetch_info_serialize(
            numbers_to_investigate=numbers_to_investigate,
    ...
    def fetch_info_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SyncNumberLookupSuccess]:
        """Requests info about phone numbers
    ...
    @validate_call
    def fetch_info_without_preload_content(
        self,
        numbers_to_investigate: Annotated[NumbersToInvestigate, Field(description="Numbers for lookup")],
        _request_timeout: Union[
            None,
    ...
    def _fetch_info_serialize(
        ...
        if numbers_to_investigate is not None:
            _body_params = numbers_to_investigate
