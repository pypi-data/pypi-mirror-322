...
class GroupsApi:
    ...
    def _create_group_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/phonebook/groups',
    ...
    def _delete_group_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/phonebook/groups/{groupId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def fetch_group(
        ...
        _param = self._fetch_group_serialize(
            group_id=group_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def fetch_group_with_http_info(
        self,
        group_id: Annotated[StrictStr, Field(description="String in UUID format")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def fetch_group_without_preload_content(
        self,
        group_id: Annotated[StrictStr, Field(description="String in UUID format")],
        _request_timeout: Union[
            None,
    ...
    def fetch_groups(
        ...
        _param = self._fetch_groups_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def fetch_groups_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def fetch_groups_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
