...
from ..utilities.exception import exception_to_dict, RequestException
from ..utilities.logging import leave_a_footprint
from ..utilities.response import return_json_response
    ...
    async def __call__(self, request: Request, call_next):
        ...
        try:
            ...
            return return_json_response(
                data='An unexpected issue has occurred; our team has been notified and is working diligently to resolve it promptly.' if get_settings(attr='hide_response_error') else payload,
                status_code=500
            )
        else:
