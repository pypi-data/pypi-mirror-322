...
def get_handlers_data():
    ...
    service_name = get_settings(attr='service_name')
    logging_api_url = get_settings(attr='logging_ms_url')
    logging_api_key = get_settings(attr='logging_ms_key')

    log_print = get_settings(attr='log_print')
    log_store = get_settings(attr='log_store')
    log_level = getattr(logging, str(get_settings(attr='log_level')).upper())
