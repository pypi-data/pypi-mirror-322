    ...
    async def __call__(self, request: Request, call_next):
        ...
        try:
            ...
            return return_json_response(
                data='An unexpected issue has occurred; our team has been notified and is working diligently to resolve it promptly.' if self.settings.hide_response_error else payload,
                status_code=500
            )
        else:
