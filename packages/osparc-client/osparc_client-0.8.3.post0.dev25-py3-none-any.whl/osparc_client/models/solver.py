...
class Solver(BaseModel):
    ...
    """ # noqa: E501
    id: Annotated[str, Field(strict=True)] = Field(description="Solver identifier")
    version: Annotated[str, Field(strict=True)] = Field(description="semantic version number of the node")
    title: StrictStr = Field(description="Human readable name")
    description: Optional[StrictStr] = None
    maintainer: StrictStr
    url: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2083)]]
    __properties: ClassVar[List[str]] = ["id", "version", "title", "description", "maintainer", "url"]

    @field_validator('id')
    def id_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^simcore\/services\/comp\/([a-z0-9][a-z0-9_.-]*\/)*([a-z0-9-_]+[a-z0-9])$", value):
            raise ValueError(r"must validate the regular expression /^simcore\/services\/comp\/([a-z0-9][a-z0-9_.-]*\/)*([a-z0-9-_]+[a-z0-9])$/")
        return value
