...
from balto.constants import MANIFEST_FILE_NAME
from balto.contracts.graph.manifest import Manifest
from balto.contracts.graph.nodes import ResultNode
from balto.exceptions import AmbiguousCatalogMatchError
from balto.graph import ResourceTypeSelector
from balto.graph.graph import UniqueId
from balto.node_types import EXECUTABLE_NODE_TYPES, NodeType
from balto.parser.manifest import write_manifest
from balto.task.compile import CompileTask
from balto.task.docs import DOCS_INDEX_FILE_PATH
...
class GenerateTask(CompileTask):
    def run(self) -> CatalogArtifact:
        ...
        catalog_data: List[PrimitiveDict] = [
            dict(zip(catalog_table.column_names, map(balto.utils._coerce_decimal, row)))
