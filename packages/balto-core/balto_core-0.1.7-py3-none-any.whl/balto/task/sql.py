...
from balto.contracts.sql import (
    RemoteCompileResult,
    RemoteCompileResultMixin,
    RemoteRunResult,
    ResultTable,
)
from balto.events.types import SQLRunnerException
from balto.task.compile import CompileRunner
...
class GenericSqlRunner(CompileRunner, Generic[SQLResult]):
    ...
    def handle_exception(self, e, ctx):
        ...
        if isinstance(e, balto.exceptions.Exception):
