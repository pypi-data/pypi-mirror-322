...
from balto.adapters.factory import get_include_paths, load_plugin
from balto.config.profile import read_profile
from balto.contracts.util import Identifier as ProjectName
...
from balto.version import _get_adapter_plugin_names
...
class InitTask(BaseTask):
    def copy_starter_repo(self, project_name: str) -> None:
        ...
        from balto.include.starter_project import (
    ...
    def ask_for_adapter_choice(self) -> str:
        ...
        if not available_adapters:
            raise balto.exceptions.NoAdaptersAvailableError()
    ...
    def get_valid_project_name(self) -> str:
        ...
        # Lazy import to avoid ModuleNotFoundError
        from balto.include.global_project import PROJECT_NAME as GLOBAL_PROJECT_NAME
