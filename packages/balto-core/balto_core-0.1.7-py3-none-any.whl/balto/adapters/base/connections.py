...
from balto.adapters.base.query_headers import MacroQueryStringSetter
...
from balto.adapters.exceptions import FailedToConnectError, InvalidConnectionError
...
class BaseConnectionManager(metaclass=abc.ABCMeta):
    ...
    def __init__(self, profile: AdapterRequiredConfig, mp_context: SpawnContext) -> None:
        ...
        self.lock: RLock = RLock() if os.environ.get('DBT_DISABLE_MP') else mp_context.RLock()
