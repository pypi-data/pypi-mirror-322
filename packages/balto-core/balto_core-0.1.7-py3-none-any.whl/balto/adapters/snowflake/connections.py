...
from balto.adapters.exceptions.connection import FailedToConnectError
from balto.adapters.contracts.connection import AdapterResponse, Connection, Credentials
from balto.adapters.sql import SQLConnectionManager
from balto.adapters.events.logging import AdapterLogger
from dbt_common.events.functions import warn_or_error
from balto.adapters.events.types import AdapterEventWarning, AdapterEventError
from dbt_common.ui import line_wrap_message, warning_tag
from balto.adapters.snowflake.record import SnowflakeRecordReplayHandle, DummyReplayHandle

from balto.adapters.snowflake.auth import private_key_from_file, private_key_from_string
...
class SnowflakeConnectionManager(SQLConnectionManager):
    ...
    def open(cls, connection):
        ...
        def connect():
            if os.environ.get('DBT_DISABLE_CONNECTIONS'):
                handle = DummyReplayHandle()
            else:
                session_parameters = {}
