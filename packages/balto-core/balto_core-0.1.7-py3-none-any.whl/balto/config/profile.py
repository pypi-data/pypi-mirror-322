...
from balto.adapters.contracts.connection import Credentials, HasCredentials
from balto.clients.yaml_helper import load_yaml_text
from balto.contracts.project import ProfileConfig
from balto.events.types import MissingProfileTarget
...
class Profile(HasCredentials):
    ...
    def _credentials_from_profile(
        ...
        from balto.adapters.factory import load_plugin
