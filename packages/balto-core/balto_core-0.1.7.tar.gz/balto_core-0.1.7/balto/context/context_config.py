...
from balto.adapters.factory import get_config_class_by_name
from balto.config import IsFQNResource, Project, RuntimeConfig
from balto.contracts.graph.model_config import get_config_for
from balto.node_types import NodeType
from balto.utils import fqn_search
...
class UnrenderedConfig(ConfigSource):
    ...
    def get_config_dict(self, resource_type: NodeType) -> Dict[str, Any]:
        ...
        elif resource_type == NodeType.Schedule:
            model_configs = unrendered.get("schedules")
...
class RenderedConfig(ConfigSource):
    ...
    def get_config_dict(self, resource_type: NodeType) -> Dict[str, Any]:
        if resource_type == NodeType.Seed:
            ...
            model_configs = self.project.schedules
        elif resource_type == NodeType.SemanticModel:
