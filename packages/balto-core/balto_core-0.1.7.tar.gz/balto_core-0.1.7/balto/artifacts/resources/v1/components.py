...
from balto.artifacts.resources.base import Docs, FileHash, GraphResource
from balto.artifacts.resources.types import NodeType, TimePeriod
...
class FreshnessThreshold(dbtClassMixin, Mergeable):
    ...
    def status(self, age: float) -> "dbt.artifacts.schemas.results.FreshnessStatus":  # type: ignore # noqa F821
        from balto.artifacts.schemas.results import FreshnessStatus
