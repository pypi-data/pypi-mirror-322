...
from balto import hooks
from balto.artifacts.resources.base import Docs
from balto.artifacts.resources.types import ModelHookType
from balto.artifacts.utils.validation import validate_color
