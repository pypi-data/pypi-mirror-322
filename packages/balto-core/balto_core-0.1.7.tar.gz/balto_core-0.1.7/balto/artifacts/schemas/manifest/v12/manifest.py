...
from balto.artifacts.schemas.upgrades import upgrade_manifest_json
...
class WritableManifest(ArtifactMixin):
    ...
    schedules: Mapping[UniqueID, Schedule] = field(
        metadata=dict(description=("The schedules defined in the dbt project"))
    )
