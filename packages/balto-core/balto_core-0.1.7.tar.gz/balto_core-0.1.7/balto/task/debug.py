...
from balto.adapters.factory import get_adapter, register_adapter
from balto.artifacts.schemas.results import RunStatus
from balto.cli.flags import Flags
from balto.clients.yaml_helper import load_yaml_text
from balto.config import PartialProject, Profile, Project
from balto.config.renderer import DbtProjectYamlRenderer, ProfileRenderer
from balto.events.types import DebugCmdOut, DebugCmdResult, OpenCommand
from balto.links import ProfileConfigDocs
from balto.mp_context import get_mp_context
from balto.task.base import BaseTask, get_nearest_project_dir
from balto.version import get_installed_version
...
class DebugTask(BaseTask):
    ...
    def _choose_profile_names(self) -> Tuple[List[str], str]:
        ...
        if os.path.exists(self.project_path):
            ...
            except balto.exceptions.DbtProjectError:
                pass
    ...
    def validate_connection(cls, target_dict) -> None:
        ...
        if result is not None:
            raise balto.exceptions.DbtProfileError(result, result_type="connection_failure")
