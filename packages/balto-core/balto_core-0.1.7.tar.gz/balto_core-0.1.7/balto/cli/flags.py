...
from balto.cli.exceptions import DbtUsageException
from balto.cli.resolvers import default_log_path, default_project_dir
from balto.cli.types import Command as CliCommand
from balto.config.project import read_project_flags
from balto.contracts.project import ProjectFlags
from balto.deprecations import fire_buffered_deprecations, renamed_env_var
from balto.events import ALL_EVENT_NAMES
...
def args_to_context(args: List[str]) -> Context:
    ...
    from balto.cli.main import cli
