...
from balto.adapters.factory import adapter_management, get_adapter, register_adapter
from balto.cli.exceptions import ExceptionExit, ResultExit
from balto.cli.flags import Flags
from balto.config import RuntimeConfig
from balto.config.runtime import UnsetProfile, load_profile, load_project
from balto.context.providers import generate_runtime_macro_context
from balto.context.query_header import generate_query_header_context
from balto.events.logging import setup_event_logger
...
from balto.exceptions import DbtProjectError, FailFastError
from balto.flags import get_flag_dict, set_flags
from balto.mp_context import get_mp_context
from balto.parser.manifest import parse_manifest
from balto.plugins import set_up_plugin_manager
from balto.profiler import profiler
from balto.utils import try_get_max_rss_kb
from balto.version import installed as installed_version
...
def preflight(func):
    def wrapper(*args, **kwargs):
        ...
        @contextmanager
        def dummy_tracker(run_command=None):
            yield

        ctx.with_resource(dummy_tracker(run_command=flags.WHICH))
