...
from balto.artifacts.resources import RefArgs
from balto.artifacts.resources.v1.model import TimeSpine
from balto.clients.jinja_static import statically_parse_ref_or_source
from balto.clients.yaml_helper import load_yaml_text
from balto.config import RuntimeConfig
from balto.context.configured import SchemaYamlVars, generate_schema_yml_context
from balto.context.context_config import ContextConfig
from balto.contracts.files import SchemaSourceFile, SourceFile
...
from balto.parser.base import SimpleParser
from balto.parser.common import (
    ParserRef,
    TargetBlock,
    TestBlock,
    VersionedTestBlock,
...
from balto.parser.schema_generic_tests import SchemaGenericTestParser
from balto.parser.schema_renderer import SchemaYamlRenderer
from balto.parser.search import FileBlock
from balto.utils import coerce_dict_str
...
#      ScheduleParser (schedules) [schema_yaml_readers.py]
...
class SchemaParser(SimpleParser[YamlBlock, ModelNode]):
    ...
    def parse_file(self, block: FileBlock, dct: Optional[Dict] = None) -> None:
        ...
        if dct:
            ...
            if "schedules" in dct:
                from balto.parser.schema_yaml_readers import ScheduleParser

                schedule_parser = ScheduleParser(self, yaml_block)
                schedule_parser.parse()

            # ExposureParser.parse()
            if "exposures" in dct:
                from balto.parser.schema_yaml_readers import ExposureParser
            ...
            # MetricParser.parse()
            if "metrics" in dct:
                from balto.parser.schema_yaml_readers import MetricParser
