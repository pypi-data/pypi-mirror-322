...
from balto.adapters.relation_configs import RelationConfigChange, RelationResults
...
from balto.adapters.snowflake.relation_configs.base import SnowflakeRelationConfigBase
