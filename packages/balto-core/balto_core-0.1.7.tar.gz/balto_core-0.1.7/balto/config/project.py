...
from balto.adapters.contracts.connection import QueryComment
from balto.clients.yaml_helper import load_yaml_text
from balto.config.selectors import SelectorDict
from balto.config.utils import normalize_warn_error_options
...
from balto.contracts.project import PackageConfig
from balto.contracts.project import Project as ProjectContract
from balto.contracts.project import ProjectFlags, ProjectPackageMetadata, SemverString
...
from balto.graph import SelectionSpec
from balto.node_types import NodeType
from balto.utils import MultiDict, coerce_dict_str, md5
...
def read_project_flags(project_dir: str, profiles_dir: str) -> ProjectFlags:
    try:
        ...
        from balto.config.profile import read_profile
