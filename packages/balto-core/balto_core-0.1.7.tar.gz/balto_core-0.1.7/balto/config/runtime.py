...
from balto.adapters.contracts.connection import (
    AdapterRequiredConfig,
    Credentials,
    HasCredentials,
)
from balto.adapters.contracts.relation import ComponentName
from balto.adapters.factory import get_include_paths, get_relation_class_by_name
from balto.config.project import load_raw_project
from balto.contracts.graph.manifest import ManifestMetadata
from balto.contracts.project import Configuration
from balto.events.types import UnusedResourceConfigPath
...
class RuntimeConfig(Project, Profile, AdapterRequiredConfig):
    ...
    def get_resource_config_paths(self) -> Dict[str, PathSet]:
        ...
        return {
            ...
            "schedules": self._get_config_paths(self.schedules),
