...
class LRMSupplier:
    ...
    def make_lrm(self, temperature: float, max_tokens: int) -> BaseChatModel:
        pass
...
class OpenAiLrmSupplier(LRMSupplier):
    ...
    def make_lrm(self, temperature, max_tokens):
        load_openai_key()
        return ChatOpenAI(model=DEFAULT_OPENAI_LRM_MODEL_KEY, temperature=temperature, max_tokens=max_tokens)
