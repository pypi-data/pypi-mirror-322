...
def init_db_client(p_db_name_str,
	...
	if p_from_aws_secrets_bool:
		# SECRETS
		db_user_str, db_pass_str, db_host_str, db_port_str = gf_rds_db_creds_from_secrets(p_env_str)
	else:
		# ENV
		db_user_str, db_pass_str, db_host_str, db_port_str = get_db_creds_from_env(p_env_str)
...
#---------------------------------------------------------------------------------
def get_db_creds_from_env(p_db_env_str,
	p_prefix_str="GF_DB"):
...
#---------------------------------------------------------------------------------
def get_db_creds_from_secrets(p_db_env_str,
	p_prefix_str="gf_rds"):
