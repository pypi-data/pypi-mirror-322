...
from radioactivedecay.converters import AVOGADRO
...
@pd.api.extensions.register_series_accessor(NUCS_ACC_S)
class NuclideSeriesAccessor:
    ...
    def _validate(obj):
        ...
        try:
            ...
            raise AttributeError(f"First value {e}")
    ...
    def specific_activity(self) -> pd.Series:
        ...
        n_a = pd.Series([AVOGADRO], dtype="pint[1/mol]")[0]
