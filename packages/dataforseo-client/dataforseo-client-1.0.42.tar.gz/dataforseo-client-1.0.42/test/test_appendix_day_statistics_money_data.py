        ...
        if include_optional:
            return AppendixDayStatisticsMoneyData(
                serp = dataforseo_client.models.appendix_serp_day_statistics_money_data.AppendixSerpDayStatisticsMoneyData(
                    ...
                    errors = 1.337, 
                    tasks_fixed = 1.337, 
                    jobs = dataforseo_client.models.appendix_day_limits_rates_data_info.AppendixDayLimitsRatesDataInfo(
                        task_post = 1.337, ), 
                    screenshot = 1.337, 
                    ai_summary = 1.337, 
                    refund_money = 1.337, ),
                ...
                keywords_data = dataforseo_client.models.appendix_keywords_data_day_statistics_money_data.AppendixKeywordsDataDayStatisticsMoneyData(
                    ...
                    audience_estimation = dataforseo_client.models.appendix_day_limits_rates_data_info.AppendixDayLimitsRatesDataInfo(
                        task_post = 1.337, ), 
                    keyword_suggestions_for_url = dataforseo_client.models.appendix_day_limits_rates_data_info.AppendixDayLimitsRatesDataInfo(
                        task_post = 1.337, ), 
                    search_volume_history = , 
                ...
                total_reviews = 1.337,
                reviews = dataforseo_client.models.appendix_day_limits_rates_data_info.AppendixDayLimitsRatesDataInfo(
                    task_post = 1.337, )
            )
        else:
            return AppendixDayStatisticsMoneyData(
