...
__all__ = [
    ...
    "get_id_to_pickcode", "filter_na_ids", "iter_stared_dirs_raw", "iter_stared_dirs", "ensure_attr_path", 
...
def iter_files_with_path(
    ...
    **request_kwargs, 
    ...
    def gen_step():
        ...
        for names in dirpatht_to_names.values():
            for name in names:
                name_to_isuniq[name] = name in name_to_isuniq
        # 对名字列表进行排序然后计算摘要值
