...
class FiinSession:
    ...
    def VN30Rebalance(self) -> VN30Rebalance: 
        """Use this class for VN30Rebalance"""
...
class FindDateCorrelation(object):
    ...
    def intraday_Correlation(self, Tickers: Union[str, list], Timeframe: str, 
...
class VN30Rebalance(object):
    """Use this class for VN30Rebalance."""
    def __init__(self, access_token: str) -> None:...
    def get(self, Budget: int) -> pd.DataFrame:...
class SimilarChart(object):
    """Use this class for find Similar Pattern."""
    def __init__(self, access_token: str)->None:...
    def plot(self, Ticker:str, t1:str, t2:str)->None:
