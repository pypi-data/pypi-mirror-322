...
@click.command()
@click.option("--target-ids", multiple=True, help="The target IDs of the reprocess.")
@click.option("--target-urls", multiple=True, help="The target URLs (bucket::object-key) of the reprocess.")
@click.option("--target-object-keys", multiple=True, help="The target object keys of the reprocess. This option assumes the default bucket that was previously set with the `set-bucket` command.")
@click.pass_context
