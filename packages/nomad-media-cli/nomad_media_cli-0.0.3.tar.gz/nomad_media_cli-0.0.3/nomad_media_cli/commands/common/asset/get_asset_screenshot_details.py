...
@click.command()
@click.option("--id", help="The ID of the asset to get the screenshot details for.")
@click.option("--url", help="The Nomad URL of the Asset (file or folder) to get the screenshot details for (bucket::object-key).")
@click.option("--object-key", help="Object-key of the Asset (file or folder) to get the screenshot details for. This option assumes the default bucket that was previously set with the `set-bucket` command.")
