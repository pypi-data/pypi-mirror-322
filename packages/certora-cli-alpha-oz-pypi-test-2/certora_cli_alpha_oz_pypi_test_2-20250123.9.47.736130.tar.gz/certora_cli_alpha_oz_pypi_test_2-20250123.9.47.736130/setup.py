...
setuptools.setup(
    name="certora_cli_alpha_oz_pypi_test_2",
    version="20250123.9.47.736130",
    author="Certora",
    author_email="support@certora.com",
    description="Runner for the Certora Prover",
    long_description="Commit 259cc53.                    Build and Run scripts for executing the Certora Prover on Solidity smart contracts.",
    long_description_content_type="text/markdown",
    url="https://pypi.org/project/certora_cli_alpha_oz_pypi_test_2",
