...
CENTRAL_DIGITAL_PLATFORM_DATA = {
    ...
    "contactPoint": {
        "name": None,
        "email": "dmp.test@user.marketplace.team",
        "telephone": None,
        "url": "http://www.dmp.com",
    },
    "roles": ["tenderer"],
    "details": {
        "legalForm": {
...
class SupplierStub(BaseAPIModelStub):
    ...
    default_data = {
        ...
        "vatNumber": "111222333",
        "centralDigitalPlatformOrganisationId": None,
        "centralDigitalPlatformShareCode": None,
        "centralDigitalPlatformData": None,
    }
    optional_keys = [
    ...
    def __init__(self, **kwargs):
        ...
        if kwargs.get('with_cdp_data'):
            ...
            self.response_data["identifier"] = \
                CENTRAL_DIGITAL_PLATFORM_DATA["identifier"]
            self.response_data["additionalIdentifiers"] = \
                CENTRAL_DIGITAL_PLATFORM_DATA["additionalIdentifiers"]
