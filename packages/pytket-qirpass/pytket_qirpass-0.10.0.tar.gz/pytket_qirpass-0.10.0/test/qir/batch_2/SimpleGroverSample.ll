...
define internal void @Microsoft__Quantum__Samples__SimpleGrover__CCX__body(%Qubit* %control1, %Qubit* %control2, %Qubit* %target) {
entry:
...
define internal void @Microsoft__Quantum__Samples__SimpleGrover__CCX__adj(%Qubit* %control1, %Qubit* %control2, %Qubit* %target) {
entry:
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %target)
...
define internal void @Microsoft__Quantum__Samples__SimpleGrover__SearchForMarkedInput__body() {
entry:
  ...
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %5)
  ...
  call void @Microsoft__Quantum__Samples__SimpleGrover__CCX__body(%Qubit* %11, %Qubit* %14, %Qubit* %outputQubit)
  ...
  call void @Microsoft__Quantum__Intrinsic__X__adj(%Qubit* %17)
  ...
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %20)
  ...
  call void @Microsoft__Quantum__Intrinsic__Z__body(%Qubit* %26)
  ...
  call void @Microsoft__Quantum__Intrinsic__CNOT__body(%Qubit* %29, %Qubit* %32)
  ...
  call void @Microsoft__Quantum__Intrinsic__Z__adj(%Qubit* %35)
  ...
  call void @Microsoft__Quantum__Intrinsic__X__adj(%Qubit* %38)
  ...
  call void @Microsoft__Quantum__Intrinsic__H__adj(%Qubit* %41)
  ...
  %46 = call %String* @__quantum__rt__result_to_string(%Result* %r0)  
  %47 = call %String* @__quantum__rt__result_to_string(%Result* %r1)
  call void @__quantum__rt__message(%String* %46)
  call void @__quantum__rt__message(%String* %47)
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic___9263709d6fe346409adc80be8d79db6c___QsRef23__ApplyWithLessControlsA____body(%Callable* %47, { %Array*, %Qubit* }* %49)
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic___9263709d6fe346409adc80be8d79db6c___QsRef23__ApplyWithLessControlsA____body(%Callable* %14, { %Array*, %Qubit* }* %16)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___e6f248f54cdb4f8192bb826708a52eaa___QsRef23__ApplyWithLessControlsA____body(%Callable* %10, { %Array*, { %Qubit*, %Qubit* }* }* %12)
...
define internal void @Microsoft__Quantum__Intrinsic___e6f248f54cdb4f8192bb826708a52eaa___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___9263709d6fe346409adc80be8d79db6c___QsRef23__ApplyWithLessControlsA____body(%Callable* %7, { %Array*, %Qubit* }* %9)
...
define internal void @Microsoft__Quantum__Intrinsic___9263709d6fe346409adc80be8d79db6c___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___28c7a7620bff4a6cb58433a78f33e926___QsRef23__ApplyWithLessControlsA____body(%Callable* %15, { %Array*, { double, %Qubit* }* }* %17)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___28c7a7620bff4a6cb58433a78f33e926___QsRef23__ApplyWithLessControlsA____body(%Callable* %16, { %Array*, { double, %Qubit* }* }* %18)
...
define internal void @Microsoft__Quantum__Intrinsic___28c7a7620bff4a6cb58433a78f33e926___QsRef23__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
...
else__1:                                          ; preds = %test1__1
  ...
  store %Qubit* %qubit, %Qubit** %17, align 8
  call void @Microsoft__Quantum__Intrinsic___9263709d6fe346409adc80be8d79db6c___QsRef23__ApplyWithLessControlsA____body(%Callable* %13, { %Array*, %Qubit* }* %15)
...
define internal void @Microsoft__Quantum__Intrinsic___e6f248f54cdb4f8192bb826708a52eaa___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { %Qubit*, %Qubit* }* }, { %Array*, { %Qubit*, %Qubit* }* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___9263709d6fe346409adc80be8d79db6c___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, %Qubit* }, { %Array*, %Qubit* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___28c7a7620bff4a6cb58433a78f33e926___QsRef23__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { double, %Qubit* }* }, { %Array*, { double, %Qubit* }* }* %0, i32 0, i32 0
...
define void @Microsoft__Quantum__Samples__SimpleGrover__SearchForMarkedInput__Interop() #1 {
entry:
  call void @Microsoft__Quantum__Samples__SimpleGrover__SearchForMarkedInput__body()
  ret void
}

define void @Microsoft__Quantum__Samples__SimpleGrover__SearchForMarkedInput() #2 {
entry:
  call void @Microsoft__Quantum__Samples__SimpleGrover__SearchForMarkedInput__body()
