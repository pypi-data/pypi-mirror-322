...
then0__60:                                        ; preds = %continue__111
  ...
  br i1 %57, label %then0__62, label %continue__117
...
continue__117:                                    ; preds = %then0__62, %then0__60
  ...
  br i1 %58, label %then0__63, label %continue__107
...
continue__107:                                    ; preds = %else__9, %then0__63, %continue__117, %continue__94
  ...
  call void @__quantum__qis__reset__body(%Qubit* nonnull inttoptr (i64 1 to %Qubit*))
  call void @__quantum__qis__mz__body(%Qubit* nonnull inttoptr (i64 2 to %Qubit*), %Result* nonnull inttoptr (i64 20 to %Result*))
