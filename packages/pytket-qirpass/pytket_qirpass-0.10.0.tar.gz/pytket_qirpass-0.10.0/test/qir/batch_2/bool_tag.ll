; ModuleID = '566418dc-0696-49ff-90be-89f867fef948.bc'
...
entry:
  ...
  call void @__quantum__rt__bool_record_output(i1 %1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @1, i32 0, i32 0))
