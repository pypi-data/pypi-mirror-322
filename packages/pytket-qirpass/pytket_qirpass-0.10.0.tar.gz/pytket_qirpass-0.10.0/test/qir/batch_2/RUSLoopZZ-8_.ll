...
then0__53:                                        ; preds = %continue__98
  ...
  call void @__quantum__qis__reset__body(%Qubit* nonnull inttoptr (i64 1 to %Qubit*))
  %50 = call i1 @__quantum__qis__read_result__body(%Result* nonnull inttoptr (i64 15 to %Result*))
  br i1 %50, label %then0__55, label %continue__104
...
continue__104:                                    ; preds = %then0__55, %then0__53
  ...
  br i1 %51, label %then0__56, label %continue__94
...
continue__94:                                     ; preds = %else__8, %then0__56, %continue__104, %continue__81
  ...
  call void @__quantum__qis__reset__body(%Qubit* nonnull inttoptr (i64 1 to %Qubit*))
  call void @__quantum__qis__mz__body(%Qubit* nonnull inttoptr (i64 2 to %Qubit*), %Result* nonnull inttoptr (i64 18 to %Result*))
  call void @__quantum__qis__reset__body(%Qubit* nonnull inttoptr (i64 2 to %Qubit*))
  %52 = call i1 @__quantum__qis__read_result__body(%Result* nonnull inttoptr (i64 18 to %Result*))
  br i1 %52, label %then0__59, label %continue__110

then0__59:                                        ; preds = %continue__94
  call void @__quantum__qis__x__body(%Qubit* nonnull inttoptr (i64 2 to %Qubit*))
  br label %continue__110

continue__110:                                    ; preds = %then0__59, %continue__94
  call void @__quantum__rt__tuple_start_record_output()
  ;call void @__quantum__rt__result_record_output(%Result* nonnull inttoptr (i64 16 to %Result*), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @0, i64 0, i64 0))
  ;call void @__quantum__rt__result_record_output(%Result* nonnull inttoptr (i64 17 to %Result*), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @1, i64 0, i64 0))
  ...
  call void @__quantum__rt__result_record_output(%Result* nonnull inttoptr (i64 18 to %Result*), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @2, i64 0, i64 0))
...
attributes #0 = { "EntryPoint" "maxQubitIndex"="2" "maxResultIndex"="18" "requiredQubits"="3" "requiredResults"="19" }
