...
then0__32:                                        ; preds = %continue__59
  ...
  call void @__quantum__qis__reset__body(%Qubit* nonnull inttoptr (i64 1 to %Qubit*))
  %29 = call i1 @__quantum__qis__read_result__body(%Result* nonnull inttoptr (i64 9 to %Result*))
  br i1 %29, label %then0__34, label %continue__65
...
continue__65:                                     ; preds = %then0__34, %then0__32
  ...
  br i1 %30, label %then0__35, label %continue__55
...
continue__55:                                     ; preds = %else__5, %then0__35, %continue__65, %continue__42
  ...
  call void @__quantum__qis__reset__body(%Qubit* nonnull inttoptr (i64 1 to %Qubit*))
  call void @__quantum__qis__mz__body(%Qubit* nonnull inttoptr (i64 2 to %Qubit*), %Result* nonnull inttoptr (i64 12 to %Result*))
  call void @__quantum__qis__reset__body(%Qubit* nonnull inttoptr (i64 2 to %Qubit*))
  %31 = call i1 @__quantum__qis__read_result__body(%Result* nonnull inttoptr (i64 12 to %Result*))
  br i1 %31, label %then0__38, label %continue__71

then0__38:                                        ; preds = %continue__55
  call void @__quantum__qis__x__body(%Qubit* nonnull inttoptr (i64 2 to %Qubit*))
  br label %continue__71

continue__71:                                     ; preds = %then0__38, %continue__55
  call void @__quantum__rt__tuple_start_record_output()
  ;call void @__quantum__rt__result_record_output(%Result* nonnull inttoptr (i64 10 to %Result*), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @0, i64 0, i64 0))
  ;call void @__quantum__rt__result_record_output(%Result* nonnull inttoptr (i64 11 to %Result*), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @1, i64 0, i64 0))
  ...
  call void @__quantum__rt__result_record_output(%Result* nonnull inttoptr (i64 12 to %Result*), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @2, i64 0, i64 0))  
...
attributes #0 = { "EntryPoint" "maxQubitIndex"="2" "maxResultIndex"="12" "requiredQubits"="3" "requiredResults"="13" }
