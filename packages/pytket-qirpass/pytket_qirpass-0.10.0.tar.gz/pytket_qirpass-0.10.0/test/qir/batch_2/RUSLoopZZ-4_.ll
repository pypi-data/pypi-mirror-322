...
then0__25:                                        ; preds = %continue__46
  ...
  call void @__quantum__qis__reset__body(%Qubit* nonnull inttoptr (i64 1 to %Qubit*))
  %22 = call i1 @__quantum__qis__read_result__body(%Result* nonnull inttoptr (i64 7 to %Result*))
  br i1 %22, label %then0__27, label %continue__52
...
continue__52:                                     ; preds = %then0__27, %then0__25
  ...
  br i1 %23, label %then0__28, label %continue__42
...
continue__42:                                     ; preds = %else__4, %then0__28, %continue__52, %continue__29
  ...
  call void @__quantum__qis__reset__body(%Qubit* nonnull inttoptr (i64 1 to %Qubit*))
  call void @__quantum__qis__mz__body(%Qubit* nonnull inttoptr (i64 2 to %Qubit*), %Result* nonnull inttoptr (i64 10 to %Result*))
  call void @__quantum__qis__reset__body(%Qubit* nonnull inttoptr (i64 2 to %Qubit*))
  %24 = call i1 @__quantum__qis__read_result__body(%Result* nonnull inttoptr (i64 10 to %Result*))
  br i1 %24, label %then0__31, label %continue__58

then0__31:                                        ; preds = %continue__42
  call void @__quantum__qis__x__body(%Qubit* nonnull inttoptr (i64 2 to %Qubit*))
  br label %continue__58

continue__58:                                     ; preds = %then0__31, %continue__42
  call void @__quantum__rt__tuple_start_record_output()
  ;call void @__quantum__rt__result_record_output(%Result* nonnull inttoptr (i64 8 to %Result*), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @0, i64 0, i64 0))
  ;call void @__quantum__rt__result_record_output(%Result* nonnull inttoptr (i64 9 to %Result*), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @1, i64 0, i64 0))
  ...
  call void @__quantum__rt__result_record_output(%Result* nonnull inttoptr (i64 10 to %Result*), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @2, i64 0, i64 0))
...
attributes #0 = { "EntryPoint" "maxQubitIndex"="2" "maxResultIndex"="10" "requiredQubits"="3" "requiredResults"="11" }
