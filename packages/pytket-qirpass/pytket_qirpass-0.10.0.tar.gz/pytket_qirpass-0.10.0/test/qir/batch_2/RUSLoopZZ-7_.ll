...
then0__46:                                        ; preds = %continue__85
  ...
  br i1 %43, label %then0__48, label %continue__91
...
continue__91:                                     ; preds = %then0__48, %then0__46
  ...
  br i1 %44, label %then0__49, label %continue__81
...
continue__81:                                     ; preds = %else__7, %then0__49, %continue__91, %continue__68
  ...
  call void @__quantum__qis__reset__body(%Qubit* nonnull inttoptr (i64 1 to %Qubit*))
  call void @__quantum__qis__mz__body(%Qubit* nonnull inttoptr (i64 2 to %Qubit*), %Result* nonnull inttoptr (i64 16 to %Result*))
