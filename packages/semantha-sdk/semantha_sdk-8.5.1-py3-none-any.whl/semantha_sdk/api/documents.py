...
class DocumentsEndpoint(RestEndpoint):
    ...
    x (int): X position in pixel (72dpi) of the area to return as image. Only for accept=image/png
    y (int): Y position in pixel (72dpi) of the area to return as image. Only for accept=image/png
    width (int): Width in pixel (72dpi) of the area to return as image. Only for accept=image/png
    height (int): Height in pixel (72dpi) of the area to return as image. Only for accept=image/png
