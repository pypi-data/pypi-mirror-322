...
from gisdo.mock import create_mock_server


def main():
    parser = argparse.ArgumentParser(
        description=u'Создание mock-сервера для принятия федеральной '
                    u'отчётности')

    parser.add_argument('path', help=u'Путь для создания сервера')
