...
INDEXES = [
    ...
    (INDEX_ADVISORY_CENTR_NUM_HITS_PERSONALLY,
     f'Тег "num_hits_personally" ({ADVISORY_CENTR})'),
    (INDEX_ADVISORY_CENTR_NUM_HITS_DISTANT,
     f'Тег "num_hits_distant" ({ADVISORY_CENTR})'),
    ...
    (INDEX_EARLY_ASSISTANT_NUM_HITS_PERSONALLY,
     f'Тег "num_hits_personally" ({EARLY_ASSISTANT})'),
    (INDEX_EARLY_ASSISTANT_NUM_HITS_DISTANT,
     f'Тег "num_hits_distant" ({EARLY_ASSISTANT})'),
...
REPORT_FIELDS = (
    'id', 'children__date_of_birth', 'desired_date',
    'children_id', 'children__fullname'
)


QUEUE_INDEXES = (
    INDEX_7, INDEX_7_1, INDEX_7_2, INDEX_7_3, INDEX_7_4, INDEX_7_5,
    INDEX_7_6, INDEX_7_7, INDEX_12, INDEX_12_1, INDEX_13, INDEX_13_1,
    INDEX_14, INDEX_15, INDEX_16, INDEX_17, INDEX_17_1, INDEX_18,
    INDEX_18_1, INDEX_18_2, INDEX_18_3, INDEX_18_4, INDEX_18_5,
    INDEX_20, INDEX_20_1, INDEX_20_2, INDEX_20_3, INDEX_20_4, INDEX_20_5,
    INDEX_20_6, INDEX_20_7, INDEX_20_8,
)
...
XML_TAGS = (
    INDEX_LEKOTEKA, INDEX_PASSPORT,

    INDEX_ADVISORY_CENTR_FACT, INDEX_ADVISORY_CENTR_NUM_HITS_PERSONALLY,
    INDEX_ADVISORY_CENTR_NUM_HITS_DISTANT,
    INDEX_ADVISORY_CENTR_NUM_HITS_DISTANT,
    INDEX_NUM_STAFF_MEMBER, INDEX_NUM_FREELANCER,
    INDEX_ADVISORY_CENTR_FORMA_1, INDEX_ADVISORY_CENTR_FORMA_2,
    INDEX_ADVISORY_CENTR_FORMA_3, INDEX_ADVISORY_CENTR_FORMA_4,

    INDEX_EARLY_ASSISTANT_FACT, INDEX_EARLY_ASSISTANT_NUM_HITS_PERSONALLY,
    INDEX_EARLY_ASSISTANT_NUM_HITS_DISTANT,
    INDEX_EARLY_ASSISTANT_FORMA_1, INDEX_EARLY_ASSISTANT_FORMA_2,
    INDEX_EARLY_ASSISTANT_FORMA_3, INDEX_EARLY_ASSISTANT_FORMA_4,

    *XML_TAGS_BY_GROUP, *XML_TAGS_BY_GROUP_ONLY_VALUES
)
