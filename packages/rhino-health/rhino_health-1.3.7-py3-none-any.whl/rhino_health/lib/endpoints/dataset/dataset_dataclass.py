...
from rhino_health.lib.constants import BASE_URL_TO_CONTAINER_SERVICE_URL
...
class LTSDataset(WithinProjectModel, WithinWorkgroupModel, BaseDataset, UserCreatedModel):
    ...
    def run_code(self, run_code, print_progress=True, **kwargs):
        ...
        param_dict = {
            ...
            "container_image_uri": f"{BASE_URL_TO_CONTAINER_SERVICE_URL.get(self.session.rhino_api_url)}/rhino-gc-workgroup-rhino-health:generic-python-runner",
