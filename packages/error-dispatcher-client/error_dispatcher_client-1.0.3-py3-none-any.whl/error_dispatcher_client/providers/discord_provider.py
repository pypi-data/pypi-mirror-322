...
class DiscordProvider(ErrorProvider):
    def __init__(self, webhook_url: str, username: str = "Error Dispatch", message_template: TemplateBase = None, thumbnail : str = None):
        """
    ...
    def send(self, error_data: dict):
        ...
        try:
            ...
            embed = DiscordEmbed(
                title=f"⚠️ {error_data.get('app_name')} ⚠️ ",
