...
import tronyx
from tronyx.abi import trx_abi
from tronyx.exceptions import DoubleSpending
from tronyx.keys import to_hex_address
...
class Contract:
    ...
    def update_user_resource_percent(self, percent: int) -> "tronyx.tron.TransactionBuilder":
    ...
    def update_origin_energy_limit(self, limit: int) -> "tronyx.tron.TransactionBuilder":
    ...
    def clear_abi(self) -> "tronyx.tron.TransactionBuilder":
        """Clear contract ABI."""
        if self.origin_address != self.owner_address:
            raise RuntimeError("origin address and owner address mismatch")
...
class ContractMethod:
    ...
    def with_owner(self, addr: str) -> "ContractMethod":
        ...
        Can also be changed through :meth:`TransactionBuilder.with_owner() <tronyx.tron.TransactionBuilder.with_owner>`.
        """
    ...
    def call(self, *args, **kwargs) -> "tronyx.tron.TransactionBuilder":
    ...
    def __call__(self, *args, **kwargs) -> "tronyx.tron.TransactionBuilder":
        """Call the contract method."""
        parameter = self._prepare_parameter(*args, **kwargs)
        return self._trigger_contract(parameter)

    def _prepare_parameter(self, *args, **kwargs) -> "tronyx.tron.TransactionBuilder":
        """Prepare parameter."""
        parameter = ""
...
class ShieldedTRC20:
    ...
    def mint(self, taddr: str, zaddr: str, amount: int, memo: str = "") -> "tronyx.tron.TransactionBuilder":
    ...
    ) -> "tronyx.tron.TransactionBuilder":
