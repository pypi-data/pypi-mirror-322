...
from elluminate.utils import raise_for_status_with_detail, retry_request, run_async
...
class Client:
    ...
    async def agenerate_responses_from_collection(
        ...
        *,
        ...
        return await self.abatch_generate_responses(
            prompt_template,
            batch_template_variables_ids=[template_variables.id for template_variables in entries.variables],
            llm_config=llm_config,
        )
    ...
    def add_criteria(
        ...
        *,
        ...
        """
        return run_async(self.aadd_criteria)(prompt_template, criteria, delete_existing=delete_existing)
    ...
    def get_entries(
        ...
        Returns:
            TemplateVariablesCollectionWithEntries: The collection with entries.
    ...
    def remove_entry(
        ...
        """Removes a template variables entry from its collection.

        Args:
            collection (TemplateVariablesCollection): The collection containing the entry.
            template_variables (TemplateVariables): The template variables entry to remove.
