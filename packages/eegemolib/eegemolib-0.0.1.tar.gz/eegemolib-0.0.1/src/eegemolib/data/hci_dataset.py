...
# define the MAHNOB-HCI dataset class
class HCIDataset(BaseDataset):
    def __init__(self, args):
        ...
        self.win_len = args['window_length']
        ...
        self.len = self.data.shape[1] // self.args['window_length']
