...
import pet_alpha_api_client
from pet_alpha_api_client.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to https://petstore3.swagger.io/api/v3
# See configuration.py for a list of all supported configuration parameters.
configuration = pet_alpha_api_client.Configuration(
...
with pet_alpha_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = pet_alpha_api_client.PetApi(api_client)
    pet = pet_alpha_api_client.Pet() # Pet | Create a new pet in the store
