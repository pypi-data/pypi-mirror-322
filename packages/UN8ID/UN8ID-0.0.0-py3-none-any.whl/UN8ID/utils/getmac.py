"""
This file was copied from the python standard library (uuid.py).

The function getnode was replaced by getmac to prevent automatic creation of a random id.
Factory functions have been removed.
"""
...
def getmac() -> int | None:
    ...
    be quite slow. Return None if all attempts to obtain the hardware address fail.
    """
    global _node
    if _node != -1:
        return _node
