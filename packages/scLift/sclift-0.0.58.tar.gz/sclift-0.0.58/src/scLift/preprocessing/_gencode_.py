...
from ..util import project_name, chrtype

file = StaticMethod(f"{project_name}_preprocessing_gencode")
log = Logger(f"{project_name}_preprocessing_gencode")
...
def get_gene_anno(
    ...
    if gtf_file is not None:
        ...
        log.info(f"Downloading GTF file: {filename}")
