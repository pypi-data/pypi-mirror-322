...
from ..util import path, to_sparse, chrtype, check_adata_get, project_name

file_method = StaticMethod(f"{project_name}_file_write")
...
def to_fragments(
    ...
    if is_gz:
        ...
        try:
            ...
            log.error(f"Compression of {fragments} file failed. \n {e}")
