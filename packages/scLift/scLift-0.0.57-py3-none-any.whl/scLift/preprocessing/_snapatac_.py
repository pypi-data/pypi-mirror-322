...
from scLift.util import path, collection, set_inf_value, chrtype, add_cluster_info, project_cache_path, generate_str, project_name

file_method = StaticMethod(f"{project_name}_preprocessing_snapatac2")
log = Logger(f"{project_name}_preprocessing_snapatac2")
...
def _handler_info_to_adata_(
    ...
    log.info(f"Create data, shape {shape}")
