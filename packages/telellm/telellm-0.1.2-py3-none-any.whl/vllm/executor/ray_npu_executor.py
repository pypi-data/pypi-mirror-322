...
from vllm.executor.distributed_npu_executor import (  # yapf: disable
    DistributedNPUExecutor, DistributedNPUExecutorAsync)
...
class RayNPUExecutor(DistributedNPUExecutor):
    ...
    def _init_workers_ray(self, placement_group: "PlacementGroup",
        ...
        # logger.info(f"init_worker done!")
        self._run_workers("init_device")
        self._run_workers("load_model",
                          max_concurrent_workers=self.parallel_config.
                          max_parallel_loading_workers)
        # logger.info(f"load_model done!")
