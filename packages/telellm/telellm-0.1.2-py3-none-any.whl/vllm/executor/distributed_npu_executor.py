...
class DistributedNPUExecutor(NPUExecutor):
    ...
    def determine_num_available_blocks(self) -> Tuple[int, int]:
        ...
        Returns:
            - tuple[num_npu_blocks, num_cpu_blocks]
        """
        ...
        num_npu_blocks = min(b[0] for b in num_blocks)
    ...
    def initialize_cache(self, num_npu_blocks: int,
        ...
        # have NPUs.
        logger.info("Multi devices, # NPU blocks: %d, # CPU blocks: %d", num_npu_blocks,
                    num_cpu_blocks)
