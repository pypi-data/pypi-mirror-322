...
try:
    ...
    class RayWorkerWrapper(WorkerWrapperBase):
        ...
        def get_node_and_gpu_ids(self) -> Tuple[str, List[int]]:
            ...
            if is_npu():
                gpu_ids = ray.get_runtime_context().get_accelerator_ids()["NPU"]
            else:
...
def initialize_ray_cluster(
    ...
    if is_npu():
        ray.init(address=ray_address,
                ...
                resources={"NPU": parallel_config.world_size})
        device_str = "NPU"
        # logger.info(f"device_str is: {device_str}")
    elif is_hip() or is_xpu():
        ray.init(address=ray_address,
                 ignore_reinit_error=True,
    ...
    if current_placement_group:
        ...
        # logger.info(f"placement_group_specs is: {placement_group_specs}")
