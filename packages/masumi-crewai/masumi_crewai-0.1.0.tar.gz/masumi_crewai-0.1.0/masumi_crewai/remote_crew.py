...
class RemoteCrew:
    ...
    def pay_for_job(self, job_id, seller_vkey, amounts, network="PREPROD", payment_type="WEB3_CARDANO_V1"):
        ...
        Args:
            job_id (str): The job ID to pay for.
            seller_vkey (str): The seller's verification key.
            amounts (list): List of amounts to pay.
            network (str): The blockchain network (default is PREPROD).
            payment_type (str): The payment type (default is WEB3_CARDANO_V1).
        ...
        payload = {
            ...
            "contractAddress": self.contract_address,  # Use the fixed contract address from config
            "amounts": amounts,
            "paymentType": payment_type,
            "unlockTime": "2024-12-01T23:00:00.000Z",  # Example, adjust as needed
            "refundTime": "2024-12-02T23:00:00.000Z",  # Example, adjust as needed
            "submitResultTime": "2024-12-01T22:00:00.000Z"  # Example, adjust as needed
        }
    ...
    def call(self, asset_id, policy_id, input_data, network="PREPROD"):
        ...
        amounts = [{"amount": 1000000, "unit": "lovelace"}]  # Example payment amount
