...
- wrapperProps (dict with strings as keys and values of type boolean | number | string | dict | list; optional):
    ...
    _children_props = ['nothingFoundMessage', 'scrollAreaProps.children', 'label', 'description', 'error', 'leftSection', 'rightSection', 'comboboxProps.children', 'comboboxProps.middlewares.flip.boundary']
