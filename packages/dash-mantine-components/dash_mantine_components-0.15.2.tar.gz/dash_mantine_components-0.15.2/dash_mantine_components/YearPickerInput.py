...
- yearsListFormat (string; optional):
    ...
    _children_props = ['popoverProps.middlewares.flip.boundary', 'modalProps.overlayProps.children', 'modalProps.title', 'leftSection', 'rightSection', 'label', 'description', 'error', 'nextIcon', 'previousIcon']
