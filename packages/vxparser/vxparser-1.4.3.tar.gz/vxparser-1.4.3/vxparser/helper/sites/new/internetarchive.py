...
# Domain Abfrage
DOMAIN = cConfig().getSetting('plugin_' + SITE_IDENTIFIER + '.domain', 'archive.org') # Domain Auswahl \xc3\x83\xc2\xbcber die xStream Einstellungen m\xc3\x83\xc2\xb6glich
...
def showCollections(entryUrl=False, sGui=False):
    ...
    for i in aResults:
        sId = i['identifier'] # ID des Films / Serie f\xc3\x83\xc2\xbcr die weitere URL
        ...
        #if 'is_series' in i: isTvshow = i['is_series'] # Wenn True dann Serie ToDo Pr\xc3\x83\xc2\xbcfen wie sich Serien verhalten
