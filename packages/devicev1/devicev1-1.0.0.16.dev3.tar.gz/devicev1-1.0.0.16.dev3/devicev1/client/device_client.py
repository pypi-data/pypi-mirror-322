...
from .device_api import UpdateDeviceRequest, InvokeMethodHTTPRequest, ListDeviceRequest, GetConfigurationRequest, \
    GetConfigurationResponse, InvokeMethodRequest
...
class DeviceClient(BceInternalClient):
    ...
    """
    def get_configuration(self, req: GetConfigurationRequest) -> GetConfigurationResponse:
        """
    ...
    def _build_base_configuration_uri(
        ...
        Returns:
            str: _description_
        """
        base_uri = f"/v1/workspaces/{workspace_id}/devicehubs/{device_hub_name}/configurations"
