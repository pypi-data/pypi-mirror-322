...
Welcome to `mucklas` contributor's guide.
...
If you experience bugs or general issues with `mucklas`, please have a look
...
You can help improve `mucklas` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`mucklas` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `mucklas`'s files. While this mechanism can
...
```
conda create -n mucklas python=3 six virtualenv pytest pytest-cov
conda activate mucklas
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/mucklas.git
   cd mucklas
   ```
...
5. Install [pre-commit]:
   ...
   `mucklas` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/mucklas
[issue tracker]: https://github.com/<USERNAME>/mucklas/issues
