...
from windmillartifactv1.client.artifact_api_artifact import Artifact
...
class Graph(GraphContent):
    ...
    draft: Optional[GraphContent] = Field(alias="draft")
    artifact: Optional[Artifact] = Field(alias="artifact")
