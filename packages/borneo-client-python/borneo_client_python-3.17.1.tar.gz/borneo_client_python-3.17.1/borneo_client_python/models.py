...
class ResourceStatsData:
    ...
    :param scanned_resources: Number of child resources that have been scanned at
    least once.
    :param unscanned_resources: Number of child resources that have not been scanned
    yet.
