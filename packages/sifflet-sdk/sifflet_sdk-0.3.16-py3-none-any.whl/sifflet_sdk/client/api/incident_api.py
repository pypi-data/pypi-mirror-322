...
class IncidentApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.post_collaboration_tool_item_endpoint = _Endpoint(
            ...
            params_map={
                "all": [
                    "id",
                    "create_collaboration_tool_item_dto",
                ],
                "required": [
                    "id",
                    "create_collaboration_tool_item_dto",
            ...
            root_map={
                ...
                "openapi_types": {
                    "id": (str,),
                    "create_collaboration_tool_item_dto": (CreateCollaborationToolItemDto,),
                },
                "attribute_map": {
                    "id": "id",
                },
                "location_map": {
                    "id": "path",
                    "create_collaboration_tool_item_dto": "body",
                },
                "collection_format_map": {},
            },
            headers_map={
    ...
    def post_collaboration_tool_item(self, id, create_collaboration_tool_item_dto, **kwargs):
        """Create a Collaboration Tool Item linked to an Incident  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_collaboration_tool_item(id, create_collaboration_tool_item_dto, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_request_auths"] = kwargs.get("_request_auths", None)
        kwargs["id"] = id
        kwargs["create_collaboration_tool_item_dto"] = create_collaboration_tool_item_dto
