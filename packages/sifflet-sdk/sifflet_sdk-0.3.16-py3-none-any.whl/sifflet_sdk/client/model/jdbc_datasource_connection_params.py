...
def lazy_import():
    from sifflet_sdk.client.model.mysql_connection_params import MysqlConnectionParams
    from sifflet_sdk.client.model.user_password_connection_params import (
        UserPasswordConnectionParams,
    )

    globals()["MysqlConnectionParams"] = MysqlConnectionParams
