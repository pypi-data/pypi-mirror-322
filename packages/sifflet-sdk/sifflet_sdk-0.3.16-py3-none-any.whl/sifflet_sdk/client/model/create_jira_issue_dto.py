...
class CreateJiraIssueDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, settings, summary, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, settings, summary, *args, **kwargs):  # noqa: E501
        """CreateJiraIssueDto - a model defined in OpenAPI
