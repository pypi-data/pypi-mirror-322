...
class UserUiDto(ModelNormal):
    ...
    def _from_openapi_data(
        cls, domains, email, id, is_active, name, reset_password, role, time_zone_data, type, *args, **kwargs
    ):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, domains, email, id, is_active, name, reset_password, role, time_zone_data, type, *args, **kwargs
    ):  # noqa: E501
        """UserUiDto - a model defined in OpenAPI
