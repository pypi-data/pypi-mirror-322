...
from sifflet_sdk.client.model.get_collaboration_tool_config_dto import (
    GetCollaborationToolConfigDto,
)
from sifflet_sdk.client.model.patch_collaboration_tool_config_dto import (
    PatchCollaborationToolConfigDto,
)
from sifflet_sdk.client.model.search_collection_get_collaboration_tool_config_dto import (
    SearchCollectionGetCollaborationToolConfigDto,
)
...
class CollaborationToolApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.connect_collaboration_tool_endpoint = _Endpoint(
            settings={
                "response_type": (GetCollaborationToolConfigDto,),
                "auth": ["JWT"],
        ...
        self.delete_collaboration_tool_config_by_id_endpoint = _Endpoint(
            settings={
                "response_type": None,
                "auth": ["JWT"],
                "endpoint_path": "/ui/v1/collaboration-tools/configs/{id}",
                "operation_id": "delete_collaboration_tool_config_by_id",
                "http_method": "DELETE",
                "servers": None,
            },
            params_map={
        ...
        self.get_all_collaboration_tool_configs_endpoint = _Endpoint(
            settings={
                "response_type": (SearchCollectionGetCollaborationToolConfigDto,),
                "auth": ["JWT"],
                "endpoint_path": "/ui/v1/collaboration-tools/configs",
        ...
        self.patch_collaboration_tool_config_by_id_endpoint = _Endpoint(
            settings={
                "response_type": (GetCollaborationToolConfigDto,),
                "auth": ["JWT"],
                "endpoint_path": "/ui/v1/collaboration-tools/configs/{id}",
                "operation_id": "patch_collaboration_tool_config_by_id",
                "http_method": "PATCH",
                "servers": None,
            },
            params_map={
    ...
    def delete_collaboration_tool_config_by_id(self, id, **kwargs):
        """Delete Collaboration Tool config by id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_collaboration_tool_config_by_id(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_request_auths"] = kwargs.get("_request_auths", None)
        kwargs["id"] = id
        return self.delete_collaboration_tool_config_by_id_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_collaboration_tool_config_by_id(self, id, patch_collaboration_tool_config_dto, **kwargs):
        """Patch Collaboration Tool config by id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_collaboration_tool_config_by_id(id, patch_collaboration_tool_config_dto, async_req=True)
        >>> result = thread.get()
        ...
        return self.patch_collaboration_tool_config_by_id_endpoint.call_with_http_info(**kwargs)
