...
class S3StorageProviderBackend(StorageProvider):
    ...
    def __init__(self, hs, config):
        ...
        self.local_media_lifetime = getattr(hs.config.media_retention, "local_media_lifetime", None)
        self.remote_media_lifetime = getattr(hs.config.media_retention, "remote_media_lifetime", None)
