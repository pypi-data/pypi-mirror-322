                ...
                try:
                    ...
                    try:
                        ...
                        if not self._store_local:
                            ...
                            # If retention is set, schedule deletion after retention period
                            def delete_after_retention():
                                try:
                                    ...
                                    if not os.path.exists(local_path):
                                        logger.info(f"File already deleted: {local_path}")
                                    else:
                            ...
                            logger.info(f"Scheduled deletion of {local_path} in {self._local_media_lifetime} seconds")
