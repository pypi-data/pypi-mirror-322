    ...
    def store_file(self, path, file_info):
        ...
        def _store_file():
            with LoggingContext(parent_context=parent_logcontext):
                ...
                try:
                    # Get S3 client and verify connection
                    ...
                    try:
                        ...
                        error_msg = f"Failed to access S3 bucket {self.bucket}: {error_code}"
                        logger.error(error_msg)
                        raise Exception(error_msg)
                    ...
                    s3_client.upload_file(
                        ...
                        Callback=lambda bytes_transferred: logger.debug(f"Uploaded {bytes_transferred} bytes")
                    )
                    ...
                    try:
                        ...
                        # Delete local file if store_local is False
