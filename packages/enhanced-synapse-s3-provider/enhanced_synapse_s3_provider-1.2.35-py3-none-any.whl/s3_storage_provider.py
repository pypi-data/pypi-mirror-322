...
class S3StorageProviderBackend(StorageProvider):
    ...
    def __init__(self, hs, config):
        ...
        self.store_local = parse_bool(raw_store_local) if raw_store_local is not None else False
        self.store_remote = parse_bool(raw_store_remote) if raw_store_remote is not None else True
        self.store_synchronous = parse_bool(raw_store_synchronous) if raw_store_synchronous is not None else True
