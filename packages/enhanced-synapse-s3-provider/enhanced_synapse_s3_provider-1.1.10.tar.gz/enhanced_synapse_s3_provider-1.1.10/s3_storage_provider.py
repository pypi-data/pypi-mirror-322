...
class S3StorageProviderBackend(StorageProvider):
    ...
    def __init__(self, hs, config):
        ...
        try:
            # Access retention settings directly from media config
            media_config = hs.config.media
            self.local_media_lifetime = getattr(media_config, 'local_media_lifetime', None)
            self.remote_media_lifetime = getattr(media_config, 'remote_media_lifetime', None)
