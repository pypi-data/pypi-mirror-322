...
class TestCreateEquivalentDocumentPosRequestCompany(unittest.TestCase):
    """CreateEquivalentDocumentPosRequestCompany unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateEquivalentDocumentPosRequestCompany:
        """Test CreateEquivalentDocumentPosRequestCompany
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateEquivalentDocumentPosRequestCompany`
        """
        model = CreateEquivalentDocumentPosRequestCompany()
        if include_optional:
            return CreateEquivalentDocumentPosRequestCompany(
                id = '',
    ...
    def testCreateEquivalentDocumentPosRequestCompany(self):
        """Test CreateEquivalentDocumentPosRequestCompany"""
