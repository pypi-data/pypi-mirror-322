...
class TestCreatePayrollRequest(unittest.TestCase):
    """CreatePayrollRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatePayrollRequest:
        """Test CreatePayrollRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatePayrollRequest`
        """
        model = CreatePayrollRequest()
        if include_optional:
            return CreatePayrollRequest(
                company = openapi_client.models.create_payroll_request_company.createPayroll_request_company(
                    id = '', ),
                prefix = '0',
                number = 1.337,
    ...
    def testCreatePayrollRequest(self):
        """Test CreatePayrollRequest"""
