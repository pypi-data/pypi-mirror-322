...
class TestCreateCreditNoteRequestItemsInner(unittest.TestCase):
    """CreateCreditNoteRequestItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCreditNoteRequestItemsInner:
        """Test CreateCreditNoteRequestItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCreditNoteRequestItemsInner`
        """
        model = CreateCreditNoteRequestItemsInner()
        if include_optional:
            return CreateCreditNoteRequestItemsInner(
                code = '',
                ...
                brand_name = '',
                model_name = '',
                transport_sector = openapi_client.models.create_credit_note_request_items_inner_all_of_transport_sector.createCreditNote_request_items_inner_allOf_transportSector(
    ...
    def testCreateCreditNoteRequestItemsInner(self):
        """Test CreateCreditNoteRequestItemsInner"""
