...
class TestGetCompanies200Response(unittest.TestCase):
    """GetCompanies200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCompanies200Response:
        """Test GetCompanies200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCompanies200Response`
        """
        model = GetCompanies200Response()
        if include_optional:
            return GetCompanies200Response(
                count = 1.337,
                companies = [
                    openapi_client.models.get_companies_200_response_companies_inner.getCompanies_200_response_companies_inner(
                        name = '', 
                        trade_name = '', 
                        identification = '', 
                        dv = '0', 
    ...
    def testGetCompanies200Response(self):
        """Test GetCompanies200Response"""
