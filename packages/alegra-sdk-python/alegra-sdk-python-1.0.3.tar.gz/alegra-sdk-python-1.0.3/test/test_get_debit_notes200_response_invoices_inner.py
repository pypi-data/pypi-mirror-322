...
class TestGetDebitNotes200ResponseInvoicesInner(unittest.TestCase):
    """GetDebitNotes200ResponseInvoicesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDebitNotes200ResponseInvoicesInner:
        """Test GetDebitNotes200ResponseInvoicesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDebitNotes200ResponseInvoicesInner`
        """
        model = GetDebitNotes200ResponseInvoicesInner()
        if include_optional:
            return GetDebitNotes200ResponseInvoicesInner(
                id = '',
    ...
    def testGetDebitNotes200ResponseInvoicesInner(self):
        """Test GetDebitNotes200ResponseInvoicesInner"""
