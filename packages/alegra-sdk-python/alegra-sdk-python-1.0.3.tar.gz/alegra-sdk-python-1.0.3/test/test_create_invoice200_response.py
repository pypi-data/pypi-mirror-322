...
class TestCreateInvoice200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateInvoice200Response:
        """Test CreateInvoice200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateInvoice200Response`
        """
        model = CreateInvoice200Response()
        if include_optional:
            return CreateInvoice200Response(
                invoice = openapi_client.models.get_invoices_200_response_invoices_inner.getInvoices_200_response_invoices_inner(
                    id = '', 
    ...
    def testCreateInvoice200Response(self):
        """Test CreateInvoice200Response"""
