...
class TestGetCreditNotes200ResponseInvoicesInner(unittest.TestCase):
    """GetCreditNotes200ResponseInvoicesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCreditNotes200ResponseInvoicesInner:
        """Test GetCreditNotes200ResponseInvoicesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCreditNotes200ResponseInvoicesInner`
        """
        model = GetCreditNotes200ResponseInvoicesInner()
        if include_optional:
            return GetCreditNotes200ResponseInvoicesInner(
                id = '',
    ...
    def testGetCreditNotes200ResponseInvoicesInner(self):
        """Test GetCreditNotes200ResponseInvoicesInner"""
