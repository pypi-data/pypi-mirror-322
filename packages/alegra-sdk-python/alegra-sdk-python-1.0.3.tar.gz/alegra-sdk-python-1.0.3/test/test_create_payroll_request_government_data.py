...
class TestCreatePayrollRequestGovernmentData(unittest.TestCase):
    """CreatePayrollRequestGovernmentData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatePayrollRequestGovernmentData:
        """Test CreatePayrollRequestGovernmentData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatePayrollRequestGovernmentData`
        """
        model = CreatePayrollRequestGovernmentData()
        if include_optional:
            return CreatePayrollRequestGovernmentData(
    ...
    def testCreatePayrollRequestGovernmentData(self):
        """Test CreatePayrollRequestGovernmentData"""
