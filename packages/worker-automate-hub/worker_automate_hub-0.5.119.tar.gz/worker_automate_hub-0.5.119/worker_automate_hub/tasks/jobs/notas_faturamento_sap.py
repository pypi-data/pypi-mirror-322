...
class NotasFaturamentoSAP:
    ...
    async def start_sap_process(self):
        ...
        if not await self.login():
            console.print("Falha ao realizar login no SAP.")
            raise Exception("Falha ao realizar login no SAP.")
        ...
        if self.driver:
            try:
                ...
                console.print(f"Erro ao fechar o driver: {e}")
    ...
    async def save_process_pid(self):
        try:
            ...
            console.print(f"Erro ao salvar PID: {e}")
    ...
    async def rename_file(self, company: str, file_type: str):
        ...
        try:
            ...
            filename = f"{company}_{file_type}2_{date_now}.xlsx"
            ...
            if final_path and os.path.exists(final_path):
                try:
                    ...
                    console.print(f"Erro ao deletar o arquivo: {e}")

        except FileNotFoundError as fne:
            console.print(f"Não foi possível renomear o arquivo, error: {fne}")
        except Exception as e:
            console.print(f"Erro ao renomear/mover arquivo: {e}")
    ...
    async def send_message_to_webhook(self, message: str):
        ...
        try:
            ...
            console.print(f"Erro ao enviar mensagem ao webhook: {e}")
