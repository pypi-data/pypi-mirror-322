                ...
                with Session(ENGINE) as session:
                    ...
                    while True:
                        try:
                            ...
                            ordering=Prompt.__init2__(None,func=FormBuilderMkText,ptext="Ascending or Descending [False=Desc/True=Asc]",helpText=helpText_exact,data="boolean")
                            if ordering in [None,]:
                                return
                            elif ordering in ['d',]:
                                ordering=False

                            exact=Prompt.__init2__(None,func=FormBuilderMkText,ptext="Exact or Text-Contains [False=Exact/True=Text-Contains]",helpText=helpText_order,data="boolean")
                            if exact in [None,]:
                                return
                            if exact in ['d',]:
                                exact=True
