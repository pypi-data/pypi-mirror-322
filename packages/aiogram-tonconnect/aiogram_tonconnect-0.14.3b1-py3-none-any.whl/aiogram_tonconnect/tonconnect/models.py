...
from tonutils.tonconnect.models import WalletApp, WalletInfo, Account
...
class ATCUser:
    ...
    app_wallet: Optional[WalletApp] = None
    info_wallet: Optional[WalletInfo] = None
    account_wallet: Optional[Account] = None
