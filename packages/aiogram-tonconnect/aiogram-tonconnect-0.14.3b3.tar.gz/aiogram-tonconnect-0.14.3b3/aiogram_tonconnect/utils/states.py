...
class TcState(StatesGroup):
    ...
    def all_states(cls) -> list[str]:
        """
        Returns a list of all states in the TcState class.

        :return: A list of strings representing the names of all states in the TcState class.
        """
        return [state.state for state in cls]
