...
class TransformParamsOperation(TypedDict, total=False):
    ...
    transform_type: Required[Literal["extraction", "classification", "generation", "manual", "api_request"]]
    """An enumeration."""

    api_request: TransformParamsOperationAPIRequest
    """
    If transform_type='api_request', specify the HTTP method, URL, header, and body.
    """
