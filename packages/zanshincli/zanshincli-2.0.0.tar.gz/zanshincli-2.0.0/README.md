...
* `--scan-target-kinds [AWS|GCP|AZURE|HUAWEI|DOMAIN|ORACLE|MS365|GITHUB|ZENDESK|GWORKSPACE|SLACK|BITBUCKET|JIRA|GITLAB|SALESFORCE]`: Only summarize scan targets from the specified kinds
