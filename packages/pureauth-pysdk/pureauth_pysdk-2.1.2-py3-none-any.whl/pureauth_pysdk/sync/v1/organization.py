...
class Organization:
    ...
    def create_group(self, name: str, description: str = "") -> None:
        """Create a new group on PureAUTH
    ...
    def create_role(
        self, name: str, application_username: str, description: str = ""
    ) -> None:
        """Create a new role on PureAUTH

        Args:
            name (str): Role Name
            description (str): Role Description
            application_username (str): Role Username
    ...
    def add_custom_attribute(self, name: str, attribute_type: str = "string") -> None:
        """Add a new attribute to custom dataset in PureAUTH
    ...
    def delete_custom_attribute(self, name: str) -> None:
        """Delete attribute from custom dataset in PureAUTH
