...
from nxcli.utils import which


def setup_procfile(nxcli_path, yes=False, skip_redis=False, skip_web=False, skip_watch=None, skip_socketio=False, skip_schedule=False, with_coverage=False):
	...
	procfile_path = os.path.join(nxcli_path, "Procfile")
