    ...
    def make_instance(self, include_optional) -> GetGifsById200Response:
        ...
        if include_optional:
            return GetGifsById200Response(
                data = [
                    test_hive_10_ti_client.models.gif.Gif(
                        ...
                        id = 'YsTs5ltWtEhnq', 
                        images = test_hive_10_ti_client.models.gif_images.Gif_images(
                            downsized = null, 
                        ...
                        user = test_hive_10_ti_client.models.user.User(
                ...
                meta = test_hive_10_ti_client.models.meta.Meta(
                    msg = 'OK', 
                    response_id = '57eea03c72381f86e05c35d2', 
                    status = 200, ),
                pagination = test_hive_10_ti_client.models.pagination.Pagination(
                    count = 25, 
                    offset = 75, 
                    total_count = 250, )
            )
