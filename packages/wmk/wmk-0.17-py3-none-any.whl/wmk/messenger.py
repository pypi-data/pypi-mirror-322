...
class Messenger:
    ...
    Args:
        socket_server: Path to the Unix domain socket server
        socket_client: Path to the Unix domain socket client
        connection_retry_interval: Time in seconds between connection attempts (default: 1.0)
        connection_timeout: Maximum time in seconds to wait for connection (default: 30.0)
    """
