...
class DefaultApi(object):
    ...
    def list_vault_with_http_info(self, vault_manager, product, **kwargs):  # noqa: E501
        ...
        all_params = ['vault_manager', 'product', 'client_id', 'integration_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def soft_delete_activities(self, integration_id, etl_time, activity_type, **kwargs):  # noqa: E501
        """Create batches to add is_deleted=True to all activities for the matching client, integration, and activity type where the dt_u value of the record is before the etl_time  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.soft_delete_activities(integration_id, etl_time, activity_type, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str integration_id: (required)
        :param datetime etl_time: (required)
        :param str activity_type: (required)
        :param str client_id:
        :param str client_code:
        :return: None
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.soft_delete_activities_with_http_info(integration_id, etl_time, activity_type, **kwargs)  # noqa: E501
        else:
            (data) = self.soft_delete_activities_with_http_info(integration_id, etl_time, activity_type, **kwargs)  # noqa: E501
            return data

    def soft_delete_activities_with_http_info(self, integration_id, etl_time, activity_type, **kwargs):  # noqa: E501
        """Create batches to add is_deleted=True to all activities for the matching client, integration, and activity type where the dt_u value of the record is before the etl_time  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.soft_delete_activities_with_http_info(integration_id, etl_time, activity_type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['integration_id', 'etl_time', 'activity_type', 'client_id', 'client_code']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method soft_delete_activities" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'integration_id' is set
        if ('integration_id' not in local_var_params or
                local_var_params['integration_id'] is None):
            raise ValueError("Missing the required parameter `integration_id` when calling `soft_delete_activities`")  # noqa: E501
        # verify the required parameter 'etl_time' is set
        if ('etl_time' not in local_var_params or
                local_var_params['etl_time'] is None):
            raise ValueError("Missing the required parameter `etl_time` when calling `soft_delete_activities`")  # noqa: E501
        # verify the required parameter 'activity_type' is set
        if ('activity_type' not in local_var_params or
                local_var_params['activity_type'] is None):
            raise ValueError("Missing the required parameter `activity_type` when calling `soft_delete_activities`")  # noqa: E501
        ...
        if 'integration_id' in local_var_params:
            query_params.append(('integration_id', local_var_params['integration_id']))  # noqa: E501
        if 'etl_time' in local_var_params:
            query_params.append(('etl_time', local_var_params['etl_time']))  # noqa: E501
        if 'activity_type' in local_var_params:
            query_params.append(('activity_type', local_var_params['activity_type']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/entity-batches/soft-delete', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_integration(self, integration_id, client_id, **kwargs):  # noqa: E501
        ...
        :param str integration_id: (required)
        :param str client_id: (required)
        :param IntegrationUpdateAllowDisabled body:
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
