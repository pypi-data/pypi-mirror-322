...
class PowerSystemResource(_message.Message):
    __slots__ = ["io", "assetInfoMRID", "locationMRID", "numControls"]
    ...
    locationMRID: str
    numControls: int
    def __init__(self, io: _Optional[_Union[_IdentifiedObject_pb2.IdentifiedObject, _Mapping]] = ..., assetInfoMRID: _Optional[str] = ..., locationMRID: _Optional[str] = ..., numControls: _Optional[int] = ...) -> None: ...
