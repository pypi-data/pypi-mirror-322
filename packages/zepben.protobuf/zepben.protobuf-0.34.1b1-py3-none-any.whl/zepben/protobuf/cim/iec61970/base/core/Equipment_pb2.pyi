...
class Equipment(_message.Message):
    __slots__ = ["psr", "inService", "normallyInService", "equipmentContainerMRIDs", "usagePointMRIDs", "operationalRestrictionMRIDs", "currentContainerMRIDs", "commissionedDate"]
    ...
    COMMISSIONEDDATE_FIELD_NUMBER: _ClassVar[int]
