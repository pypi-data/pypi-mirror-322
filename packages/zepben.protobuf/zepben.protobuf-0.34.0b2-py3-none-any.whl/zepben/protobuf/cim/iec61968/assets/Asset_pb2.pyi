...
class Asset(_message.Message):
    __slots__ = ["io", "organisationRoleMRIDs", "locationMRID"]
    ...
    locationMRID: str
    def __init__(self, io: _Optional[_Union[_IdentifiedObject_pb2.IdentifiedObject, _Mapping]] = ..., organisationRoleMRIDs: _Optional[_Iterable[str]] = ..., locationMRID: _Optional[str] = ...) -> None: ...
