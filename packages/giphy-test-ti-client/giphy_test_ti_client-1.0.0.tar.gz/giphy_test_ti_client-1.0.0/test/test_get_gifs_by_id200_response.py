    ...
    def make_instance(self, include_optional) -> GetGifsById200Response:
        ...
        if include_optional:
            return GetGifsById200Response(
                data = [
                    giphy_test_ti_client.models.gif.Gif(
                        ...
                        id = 'YsTs5ltWtEhnq', 
                        images = giphy_test_ti_client.models.gif_images.Gif_images(
                            downsized = null, 
                        ...
                        user = giphy_test_ti_client.models.user.User(
                ...
                meta = giphy_test_ti_client.models.meta.Meta(
                    msg = 'OK', 
                    response_id = '57eea03c72381f86e05c35d2', 
                    status = 200, ),
                pagination = giphy_test_ti_client.models.pagination.Pagination(
                    count = 25, 
                    offset = 75, 
                    total_count = 250, )
            )
