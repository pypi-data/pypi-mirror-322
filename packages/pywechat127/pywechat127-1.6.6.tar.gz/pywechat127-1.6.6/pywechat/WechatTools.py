...
class API():
    ...
    def open_wechat_miniprogram(program_name:str,load_delay:float=3.5,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True,close_program_pane:bool=True):
        ...
        while not search.exists():
            ...
            up+=5
        search.click_input()
        Systemsettings.copy_text_to_windowsclipboard(program_name)
    ...
    @staticmethod
    def open_wechat_official_account(official_account_name:str,load_delay:float=2,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
        该方法用于打开指定的微信公众号\n
        ...
        search.click_input()
        Systemsettings.copy_text_to_windowsclipboard(official_account_name)
        pyautogui.hotkey('ctrl','v')
        time.sleep(load_delay)
        try:
