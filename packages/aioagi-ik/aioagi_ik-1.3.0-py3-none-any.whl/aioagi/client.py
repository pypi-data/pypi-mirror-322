...
from aioagi.client_exceptions import AGIInvalidMethod, AGIInvalidURL
...
class AGIClientSession:
    def __init__(
        ...
        *,
        ...
        loop=None,
        headers=None,
        request_class=AGIClientRequest,
        response_class=AGIClientResponse,
    ...
    def __del__(self, _warnings=warnings):
        if not self.closed:
            ...
            _warnings.warn("Unclosed client session {!r}".format(self), ResourceWarning)
