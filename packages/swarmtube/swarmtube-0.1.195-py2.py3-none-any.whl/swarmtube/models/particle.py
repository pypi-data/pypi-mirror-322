...
class ParticleDefinition(BaseModel):
    ...
    geo_locator: Optional[str] = Field(None,
        description="geo locator for the particle",
        examples=[
            "region_malaga.districts"
            "grid_mad_2x2",
            # "test://particle/sma",
        ],
    )
    mapper: Optional[str] = Field(None,
        description="mapper to be used for the output data",
        examples=[
            "AEMETMeteorologicalStationMapper"
        ],
    )
    lambda_mapper: Optional[str] = Field(None,
        description="mapper to be used to transform lambda calls",
        examples=[
            "AEMETMeteorologicalStationMapper"
        ],
    )
    exclude: Optional[str] = Field("None",
