...
from cellstitch_cuda.interpolate import full_interpolate, full_interpolate_bbox
...
masks = tifffile.imread(r"E:\1_DATA\Rheenen\tvl_jr\3d stitching\raw4-large\cellstitch_masks.tif")

masks = full_interpolate_bbox(masks, anisotropy=4, verbose=True)
