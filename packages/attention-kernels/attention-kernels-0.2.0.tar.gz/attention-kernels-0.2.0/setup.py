...
class cmake_build_ext(build_ext):
    ...
    def build_extensions(self) -> None:
        ...
        targets = []
        target_name = lambda s: remove_prefix(s, "attention_kernels.")
...
if _build_custom_ops():
    ext_modules.append(CMakeExtension(name="attention_kernels._attention_kernels"))
