...
from .utils.parallel import MPI_RANK, MPI_SIZE, mpi_reduce, mpi_create_op, mpi_wtime
...
cr_reduce = mpi_create_op(_reduce_cr, commute=True)
...
def _info_parallel():
	CHANNEL_DICT_G = mpi_reduce(CHANNEL_DICT,op=cr_reduce,root=0)
