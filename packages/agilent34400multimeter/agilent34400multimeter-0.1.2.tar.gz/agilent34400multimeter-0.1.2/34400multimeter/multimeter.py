...
def measure_dc_voltage():
    ...
    print(f"Gemessene Gleichspannung: {voltage} V")
...
def measure_ac_voltage():
    ...
    voltage = multimeter.read()
    print(f"Gemessene Wechselspannung: {voltage} V")
...
def measure_dc_current():
    ...
    print(f"Gemessener DC-Strom: {current} A")
...
def measure_ac_current():
    ...
    current = multimeter.read()
    print(f"Gemessener AC-Strom: {current} A")
...
def measure_resistance():
    ...
    print(f"Gemessener Widerstand: {resistance} Ohm")


# Beispiel 6: Frequenz messen
def measure_frequency():
    multimeter.write('MEAS:FREQ?')
    frequency = multimeter.read()
...
def diode_test():
    ...
    diode_voltage = multimeter.read()
    print(f"Gemessene Diodenspannung: {diode_voltage} V")
...
def measure_temperature():
    ...
    temperature = multimeter.read()
    print(f"Gemessene Temperatur: {temperature} °C")
...
def measure_multiple_values():
    ...
    multimeter.write('MEAS:RES?')
    resistance = multimeter.read()
    print(f"Gemessene DC-Spannung: {voltage} V, Gemessener Widerstand: {resistance} Ohm")
...
def test_transistor():
    ...
    voltage = multimeter.read()
    print(f"Gemessene Basis-Emitter-Spannung des Transistors: {voltage} V")


# Beispiel 34: Kapazität messen
def measure_capacitance():
    multimeter.write('MEAS:CAP?')
    capacitance = multimeter.read()
    print(f"Gemessene Kapazität: {capacitance} F")


# Beispiel 35: Impedanz messen
def measure_impedance():
    multimeter.write('MEAS:IMP?')
    impedance = multimeter.read()
    print(f"Gemessene Impedanz: {impedance} Ohm")
