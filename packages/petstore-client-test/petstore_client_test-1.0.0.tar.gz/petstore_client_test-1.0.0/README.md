...
import petstore_client_test
from petstore_client_test.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to https://petstore3.swagger.io/api/v3
# See configuration.py for a list of all supported configuration parameters.
configuration = petstore_client_test.Configuration(
...
with petstore_client_test.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = petstore_client_test.PetApi(api_client)
    pet = petstore_client_test.Pet() # Pet | Create a new pet in the store
