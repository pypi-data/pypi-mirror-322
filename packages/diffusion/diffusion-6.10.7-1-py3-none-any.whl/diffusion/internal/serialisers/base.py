...
class ListEncoder(EncodingType):
    ...
    @classmethod
    def create(cls, spec: SerialiserMap, name: str, parents: typing.Optional[List[str]] = None,
               resolver: typing.Optional[Resolver] = None) -> typing.Type[ListEncoder]:
...
class Resolver(object):
    ...
    def __call__(
        self, serialiser_name: str, parents: typing.Optional[List[str]] = None
    ) -> SerialiserMap:
