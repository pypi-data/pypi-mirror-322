...
class RangeQueryResult(MarshalledModel):
    ...
    def from_fields(
        ...
        **kwargs,
        ...
        class RangeQueryResultFields(ModelFields):
            events: typing.List[typing.Any]
            value_data_type: typing.Type[TimeSeriesValueType]

        remaining_fields = RangeQueryResultFields.from_fields(kwargs)
        ...
        for raw_event in remaining_fields.events:
            event = raw_event[0]
            ...
            action = mapping.get(
                ...
                lambda x: process_event(
                    EventTypeFactory.of(ev_code.get_type(), remaining_fields.value_data_type),
                    x,
        ...
        return cls(
            ...
            offsets=offsets,
            value_data_type=remaining_fields.value_data_type,
            **kwargs,
        )
