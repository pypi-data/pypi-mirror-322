...
from tobikodata.http_client.auth import AuthHttpClient
from tobikodata.http_client.public import BearerAuth, HttpMethod
...
def install_executors(project: TCloudProject, tcloud_path: Path = c.TCLOUD_PATH) -> Path:
    ...
    with client.stream(HttpMethod.GET, executors_pex_url) as response:
