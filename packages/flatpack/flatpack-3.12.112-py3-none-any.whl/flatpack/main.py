...
def main():
    ...
    with SessionManager() as session:
        ...
        console.print(
            "[bold red]IMPORTANT (2025-01-20): We have noted that fraudsters are impersonating Flatpack (FPK). Flatpack does NOT endorse any cryptocurrency and will NEVER do so.[/bold red]"
        )
        console.print("")
