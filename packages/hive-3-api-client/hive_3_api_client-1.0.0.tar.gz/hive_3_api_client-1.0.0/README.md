...
with hive_3_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = hive_3_api_client.PetApi(api_client)
    pet = hive_3_api_client.Pet() # Pet | Create a new pet in the store
