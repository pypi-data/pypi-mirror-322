...
class NPSaeEvalType(BaseModel):
    ...
    evals: Optional[List] = Field(None, description='The actual eval results of this type')


class NPSaeEvalListRequest(BaseModel):
    includeDetails: Optional[bool] = Field(
        False, description='Whether or not to include the detailedMetrics in the response (which can be large).'
    )
