...
from .utils import is_too_small_price, is_too_high_price, clean_wb_stocks
...
class Wildberries(Marketplace):
    ...
    def get_stock_by_alter_api(self, nms_id: list[str]):
        ...
        for slice in batched(nms_id, 100):
            ...
            response = self.__request(url=settings.wb_shadow_url, method='GET', params=params)
        ...
        return clean_wb_stocks(results)
