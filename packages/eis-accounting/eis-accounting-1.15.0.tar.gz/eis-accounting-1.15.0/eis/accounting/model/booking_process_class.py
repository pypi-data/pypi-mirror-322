...
class BookingProcessClass(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'booking_entries': ([BookingEntryClass],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, code, custom_fields, status, booking_process_type, booking_entries, created_at, updated_at, created_by, updated_by, *args, **kwargs):  # noqa: E501
        """BookingProcessClass - a model defined in OpenAPI
        ...
        Args:
            ...
            status (str): Represents the current stage of the booking process. It tracks whether the process is still open, invoiced, or paid.
            booking_process_type (str): Defines the type of booking process, indicating the nature of the financial transaction or action such as an initial invoice, claims payment, or termination invoice.
            booking_entries ([BookingEntryClass]): A list of booking entries associated with this booking process.      Each entry represents a booking entry linked to the current booking process.
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, code, custom_fields, status, booking_process_type, booking_entries, created_at, updated_at, created_by, updated_by, *args, **kwargs):  # noqa: E501
        """BookingProcessClass - a model defined in OpenAPI
