...
class ListBookingProcessResponseClass(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([BookingProcessClass],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, next_page_token, *args, **kwargs):  # noqa: E501
        """ListBookingProcessResponseClass - a model defined in OpenAPI

        Args:
            items ([BookingProcessClass]): The list of booking processs.
