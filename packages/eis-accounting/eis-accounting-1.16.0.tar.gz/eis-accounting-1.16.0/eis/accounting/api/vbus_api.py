...
class VbusApi(object):
    ...
    def create_vbu(
        ...
        **kwargs
        ...
        This endpoint will create a vbu message. The call is asynchronous and will return a code to retrieve the vbu when it is ready.  # noqa: E501
    ...
    def create_vbuv(
        ...
        **kwargs
        ...
        This endpoint will create a vbuv message. The call is asynchronous and will return a code to retrieve the vbu when it is ready.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_vbus(
        ...
        **kwargs
        ...
        Keyword Args:
            ...
            order (bool, date, datetime, dict, float, int, list, str, none_type): Order allowing you to specify the desired order of entities retrieved from the server.<br/>     <br/>     <i>Allowed values: id, code, transmissionStart, createdAt, updatedAt, status</i>. [optional]
