...
class Gif(BaseModel):
    ...
    trending_datetime: Optional[datetime] = Field(default=None, description="The date on which this gif was marked trending, if applicable.")
    ...
    __properties: ClassVar[List[str]] = ["bitly_url", "content_url", "create_datetime", "embded_url", "featured_tags", "id", "images", "import_datetime", "rating", "slug", "source", "source_post_url", "source_tld", "tags", "trending_datetime", "type", "update_datetime", "url", "user", "username"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "trending_datetime": obj.get("trending_datetime"),
