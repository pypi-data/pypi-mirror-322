...
class EndpointConditions(BaseModel):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["EndpointConditions"]:
...
class ForZone(BaseModel):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["ForZone"]:
            return ForZone
...
class EndpointHints(BaseModel):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["EndpointHints"]:
        ...
        def for_zones(
            ...
            if callable(value_or_callback):
                value = value_or_callback(ForZone.list_builder()).build()
...
class Endpoint(BaseModel):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["Endpoint"]:
            return Endpoint
        ...
        def conditions(
            ...
            value_or_callback: Union[
                ...
                Callable[[EndpointConditions.Builder], EndpointConditions.Builder],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(EndpointConditions.builder()).build()
        ...
        def hints(
            ...
            value_or_callback: Union[
                ...
                Callable[[EndpointHints.Builder], EndpointHints.Builder],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(EndpointHints.builder()).build()
...
class EndpointSlice(Resource):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["EndpointSlice"]:
        ...
        def endpoints(
            ...
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(Endpoint.list_builder()).build()
