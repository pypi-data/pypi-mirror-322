    ...
    class Builder(BaseBuilder):
        ...
        def parameters(
            ...
            if callable(value_or_callback):
                value = value_or_callback(IngressClassParametersReference)
    ...
    class Builder(BaseBuilder):
        ...
        def ports(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[IngressPortStatus]], List[IngressPortStatus]],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(IngressPortStatus)
    ...
    class Builder(BaseBuilder):
        ...
        def ingress(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[IngressLoadBalancerIngress]], List[IngressLoadBalancerIngress]],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(IngressLoadBalancerIngress)
    ...
    class Builder(BaseBuilder):
        ...
        def port(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[ServiceBackendPort]], ServiceBackendPort],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(ServiceBackendPort)
            return self._set("port", value)
    ...
    class Builder(BaseBuilder):
        ...
        def load_balancer(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[IngressLoadBalancerStatus]], IngressLoadBalancerStatus],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(IngressLoadBalancerStatus)
    ...
    class Builder(BaseBuilder):
        ...
        def resource(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[v1.TypedLocalObjectReference]], v1.TypedLocalObjectReference],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(v1.TypedLocalObjectReference)
        ...
        def service(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[IngressServiceBackend]], IngressServiceBackend],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(IngressServiceBackend)
    ...
    class Builder(BaseBuilder):
        ...
        def spec(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[IngressClassSpec]], IngressClassSpec],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(IngressClassSpec)
...
class NetworkPolicyPeer(BaseModel):
    class Builder(BaseBuilder):
        ...
        def ip_block(
            self,
            value_or_callback: Union[Optional[IPBlock], Callable[[Type[IPBlock]], IPBlock]],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(IPBlock)
...
class HTTPIngressPath(BaseModel):
    class Builder(BaseBuilder):
        ...
        def backend(
            self,
            value_or_callback: Union[
                IngressBackend, Callable[[Type[IngressBackend]], IngressBackend]
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(IngressBackend)
    ...
    class Builder(BaseBuilder):
        ...
        def paths(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[HTTPIngressPath]], List[HTTPIngressPath]],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(HTTPIngressPath)
    ...
    class Builder(BaseBuilder):
        ...
        def http(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[HTTPIngressRuleValue]], HTTPIngressRuleValue],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(HTTPIngressRuleValue)
    ...
    class Builder(BaseBuilder):
        ...
        def default_backend(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[IngressBackend]], IngressBackend],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
        ...
        def rules(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[IngressRule]], List[IngressRule]],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(IngressRule)
        ...
        def tls(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[IngressTLS]], List[IngressTLS]],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(IngressTLS)
    ...
    class Builder(BaseBuilder):
        ...
        def ports(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[NetworkPolicyPort]], List[NetworkPolicyPort]],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(NetworkPolicyPort)
            return self._set("ports", value)
        ...
        def to(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[NetworkPolicyPeer]], List[NetworkPolicyPeer]],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(NetworkPolicyPeer)
    ...
    class Builder(BaseBuilder):
        ...
        def egress(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[NetworkPolicyEgressRule]], List[NetworkPolicyEgressRule]],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(NetworkPolicyEgressRule)
        ...
        def ingress(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[NetworkPolicyIngressRule]], List[NetworkPolicyIngressRule]],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(NetworkPolicyIngressRule)
            return self._set("ingress", value)
...
class Ingress(Resource):
    class Builder(BaseBuilder):
        ...
        def spec(
            self,
            value_or_callback: Union[
                Optional[IngressSpec], Callable[[Type[IngressSpec]], IngressSpec]
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(IngressSpec)
            return self._set("spec", value)

        def status(
            self,
            value_or_callback: Union[
                Optional[IngressStatus], Callable[[Type[IngressStatus]], IngressStatus]
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(IngressStatus)
    ...
    class Builder(BaseBuilder):
        ...
        def spec(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[NetworkPolicySpec]], NetworkPolicySpec],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(NetworkPolicySpec)
            return self._set("spec", value)
