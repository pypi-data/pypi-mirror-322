    ...
    class Builder(BaseBuilder):
        ...
        def on_exit_codes(
            ...
            if callable(value_or_callback):
                value = value_or_callback(PodFailurePolicyOnExitCodesRequirement)
        ...
        def on_pod_conditions(
            ...
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(PodFailurePolicyOnPodConditionsPattern)
    ...
    class Builder(BaseBuilder):
        ...
        def active(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[v1.ObjectReference]], List[v1.ObjectReference]],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
    ...
    class Builder(BaseBuilder):
        ...
        def conditions(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[JobCondition]], List[JobCondition]],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(JobCondition)
        ...
        def uncounted_terminated_pods(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[UncountedTerminatedPods]], UncountedTerminatedPods],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(UncountedTerminatedPods)
    ...
    class Builder(BaseBuilder):
        ...
        def rules(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[PodFailurePolicyRule]], List[PodFailurePolicyRule]],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(PodFailurePolicyRule)
    ...
    class Builder(BaseBuilder):
        ...
        def rules(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[SuccessPolicyRule]], List[SuccessPolicyRule]],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(SuccessPolicyRule)
            return self._set("rules", value)
    ...
    class Builder(BaseBuilder):
        ...
        def pod_failure_policy(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[PodFailurePolicy]], PodFailurePolicy],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(PodFailurePolicy)
        ...
        def success_policy(
            self,
            value_or_callback: Union[
                Optional[SuccessPolicy], Callable[[Type[SuccessPolicy]], SuccessPolicy]
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(SuccessPolicy)
...
class JobTemplateSpec(BaseModel):
    class Builder(BaseBuilder):
        ...
        def spec(
            self,
            value_or_callback: Union[Optional[JobSpec], Callable[[Type[JobSpec]], JobSpec]],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(JobSpec)
...
class CronJobSpec(BaseModel):
    class Builder(BaseBuilder):
        ...
        def job_template(
            self,
            value_or_callback: Union[
                JobTemplateSpec, Callable[[Type[JobTemplateSpec]], JobTemplateSpec]
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(JobTemplateSpec)
...
class Job(Resource):
    class Builder(BaseBuilder):
        ...
        def status(
            self,
            value_or_callback: Union[Optional[JobStatus], Callable[[Type[JobStatus]], JobStatus]],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(JobStatus)
            return self._set("status", value)
...
class CronJob(Resource):
    class Builder(BaseBuilder):
        ...
        def spec(
            self,
            value_or_callback: Union[
                Optional[CronJobSpec], Callable[[Type[CronJobSpec]], CronJobSpec]
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(CronJobSpec)
            return self._set("spec", value)

        def status(
            self,
            value_or_callback: Union[
                Optional[CronJobStatus], Callable[[Type[CronJobStatus]], CronJobStatus]
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(CronJobStatus)
            return self._set("status", value)
