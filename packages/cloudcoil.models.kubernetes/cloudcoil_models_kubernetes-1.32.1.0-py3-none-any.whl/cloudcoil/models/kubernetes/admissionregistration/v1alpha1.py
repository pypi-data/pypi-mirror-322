    ...
    class Builder(BaseBuilder):
        ...
        def apply_configuration(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[ApplyConfiguration]], ApplyConfiguration],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(ApplyConfiguration)
            return self._set("apply_configuration", value)

        def json_patch(
            self,
            value_or_callback: Union[Optional[JSONPatch], Callable[[Type[JSONPatch]], JSONPatch]],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(JSONPatch)
...
class MutatingAdmissionPolicySpec(BaseModel):
    class Builder(BaseBuilder):
        ...
        def mutations(
            self,
            value_or_callback: Union[
                Optional[List[Mutation]], Callable[[Type[Mutation]], List[Mutation]]
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(Mutation)
    ...
    class Builder(BaseBuilder):
        ...
        def spec(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[MutatingAdmissionPolicySpec]], MutatingAdmissionPolicySpec],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(MutatingAdmissionPolicySpec)
...
class MutatingAdmissionPolicyBinding(Resource):
    class Builder(BaseBuilder):
        ...
        def spec(
            ...
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(MutatingAdmissionPolicyBindingSpec)
            return self._set("spec", value)
