    ...
    class Builder(BaseBuilder):
        ...
        def conditions(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[APIServiceCondition]], List[APIServiceCondition]],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(APIServiceCondition)
    ...
    class Builder(BaseBuilder):
        ...
        def spec(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[APIServiceSpec]], APIServiceSpec],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(APIServiceSpec)
        ...
        def status(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[APIServiceStatus]], APIServiceStatus],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(APIServiceStatus)
            return self._set("status", value)
