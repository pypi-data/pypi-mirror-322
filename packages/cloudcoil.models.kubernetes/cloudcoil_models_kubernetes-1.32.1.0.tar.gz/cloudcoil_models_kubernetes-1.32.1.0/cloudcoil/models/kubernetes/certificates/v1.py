...
class CertificateSigningRequestStatus(BaseModel):
    class Builder(BaseBuilder):
        ...
        def conditions(
            ...
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(CertificateSigningRequestCondition)
    ...
    class Builder(BaseBuilder):
        ...
        def spec(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[CertificateSigningRequestSpec]], CertificateSigningRequestSpec],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(CertificateSigningRequestSpec)
        ...
        def status(
            ...
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(CertificateSigningRequestStatus)
            return self._set("status", value)
