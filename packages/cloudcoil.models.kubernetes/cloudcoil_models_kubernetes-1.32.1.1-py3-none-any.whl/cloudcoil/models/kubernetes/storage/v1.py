...
class VolumeNodeResources(BaseModel):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["VolumeNodeResources"]:
...
class CSIDriverSpec(BaseModel):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["CSIDriverSpec"]:
        ...
        def token_requests(
            ...
            if callable(value_or_callback):
                value = value_or_callback(TokenRequest.list_builder()).build()
...
class CSINodeDriver(BaseModel):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["CSINodeDriver"]:
        ...
        def allocatable(
            ...
            value_or_callback: Union[
                ...
                Callable[[VolumeNodeResources.Builder], VolumeNodeResources.Builder],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(VolumeNodeResources.builder()).build()
...
class CSINodeSpec(BaseModel):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["CSINodeSpec"]:
            return CSINodeSpec
        ...
        def drivers(
            ...
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(CSINodeDriver.list_builder()).build()
...
class VolumeError(BaseModel):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["VolumeError"]:
            return VolumeError
...
class CSIDriver(Resource):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["CSIDriver"]:
            return CSIDriver
        ...
        def spec(
            self,
            value_or_callback: Union[
                CSIDriverSpec, Callable[[CSIDriverSpec.Builder], CSIDriverSpec.Builder]
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(CSIDriverSpec.builder()).build()
...
class CSINode(Resource):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["CSINode"]:
            return CSINode
        ...
        def spec(
            self,
            value_or_callback: Union[
                CSINodeSpec, Callable[[CSINodeSpec.Builder], CSINodeSpec.Builder]
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(CSINodeSpec.builder()).build()
            return self._set("spec", value)
...
class CSIStorageCapacity(Resource):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["CSIStorageCapacity"]:
...
class StorageClass(Resource):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["StorageClass"]:
            return StorageClass
        ...
        def allowed_topologies(
            ...
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(v1.TopologySelectorTerm.list_builder()).build()
...
class VolumeAttachmentSource(BaseModel):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["VolumeAttachmentSource"]:
        ...
        def inline_volume_spec(
            ...
            value_or_callback: Union[
                ...
                Callable[[v1.PersistentVolumeSpec.Builder], v1.PersistentVolumeSpec.Builder],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(v1.PersistentVolumeSpec.builder()).build()
...
class VolumeAttachmentSpec(BaseModel):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["VolumeAttachmentSpec"]:
        ...
        def source(
            ...
            value_or_callback: Union[
                ...
                Callable[[VolumeAttachmentSource.Builder], VolumeAttachmentSource.Builder],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(VolumeAttachmentSource.builder()).build()
...
class VolumeAttachmentStatus(BaseModel):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["VolumeAttachmentStatus"]:
        ...
        def attach_error(
            ...
            value_or_callback: Union[
                ...
                Callable[[VolumeError.Builder], VolumeError.Builder],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(VolumeError.builder()).build()
...
class VolumeAttachment(Resource):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["VolumeAttachment"]:
        ...
        def spec(
            ...
            value_or_callback: Union[
                ...
                Callable[[VolumeAttachmentSpec.Builder], VolumeAttachmentSpec.Builder],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(VolumeAttachmentSpec.builder()).build()
            return self._set("spec", value)
        ...
        def status(
            ...
            value_or_callback: Union[
                ...
                Callable[[VolumeAttachmentStatus.Builder], VolumeAttachmentStatus.Builder],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(VolumeAttachmentStatus.builder()).build()
