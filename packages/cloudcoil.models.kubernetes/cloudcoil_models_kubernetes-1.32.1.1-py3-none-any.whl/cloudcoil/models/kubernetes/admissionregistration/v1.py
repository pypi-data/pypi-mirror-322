...
class AuditAnnotation(BaseModel):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["AuditAnnotation"]:
...
class ExpressionWarning(BaseModel):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["ExpressionWarning"]:
...
class TypeChecking(BaseModel):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["TypeChecking"]:
            return TypeChecking
        ...
        def expression_warnings(
            ...
            if callable(value_or_callback):
                value = value_or_callback(ExpressionWarning.list_builder()).build()
...
class Validation(BaseModel):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["Validation"]:
            return Validation
...
class ValidatingAdmissionPolicyBindingSpec(BaseModel):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["ValidatingAdmissionPolicyBindingSpec"]:
...
class ValidatingAdmissionPolicySpec(BaseModel):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["ValidatingAdmissionPolicySpec"]:
        ...
        def audit_annotations(
            ...
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(AuditAnnotation.list_builder()).build()
        ...
        def validations(
            ...
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(Validation.list_builder()).build()
...
class ValidatingAdmissionPolicyStatus(BaseModel):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["ValidatingAdmissionPolicyStatus"]:
        ...
        def type_checking(
            ...
            value_or_callback: Union[
                ...
                Callable[[TypeChecking.Builder], TypeChecking.Builder],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(TypeChecking.builder()).build()
...
class ValidatingAdmissionPolicy(Resource):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["ValidatingAdmissionPolicy"]:
        ...
        def spec(
            ...
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(ValidatingAdmissionPolicySpec.builder()).build()
        ...
        def status(
            ...
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(ValidatingAdmissionPolicyStatus.builder()).build()
...
class ValidatingAdmissionPolicyBinding(Resource):
    class Builder(BaseBuilder):
        @property
        def base_class(self) -> Type["ValidatingAdmissionPolicyBinding"]:
        ...
        def spec(
            ...
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(ValidatingAdmissionPolicyBindingSpec.builder()).build()
            return self._set("spec", value)
