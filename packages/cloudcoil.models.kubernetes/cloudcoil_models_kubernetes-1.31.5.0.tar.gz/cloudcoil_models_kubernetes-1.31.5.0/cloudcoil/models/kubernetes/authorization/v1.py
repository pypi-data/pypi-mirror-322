    ...
    class Builder(BaseBuilder):
        ...
        def non_resource_rules(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[NonResourceRule]], List[NonResourceRule]],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(NonResourceRule)
            return self._set("non_resource_rules", value)

        def resource_rules(
            self,
            value_or_callback: Union[
                List[ResourceRule], Callable[[Type[ResourceRule]], List[ResourceRule]]
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(ResourceRule)
    ...
    class Builder(BaseBuilder):
        ...
        def requirements(
            ...
            value_or_callback: Union[
                ...
                Callable[
                    [Type[apimachinery.FieldSelectorRequirement]],
            ...
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(apimachinery.FieldSelectorRequirement)
    ...
    class Builder(BaseBuilder):
        ...
        def requirements(
            ...
            value_or_callback: Union[
                ...
                Callable[
                    [Type[apimachinery.LabelSelectorRequirement]],
            ...
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(apimachinery.LabelSelectorRequirement)
            return self._set("requirements", value)
    ...
    class Builder(BaseBuilder):
        ...
        def field_selector(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[FieldSelectorAttributes]], FieldSelectorAttributes],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(FieldSelectorAttributes)
        ...
        def label_selector(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[LabelSelectorAttributes]], LabelSelectorAttributes],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(LabelSelectorAttributes)
    ...
    class Builder(BaseBuilder):
        ...
        def non_resource_attributes(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[NonResourceAttributes]], NonResourceAttributes],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(NonResourceAttributes)
        ...
        def resource_attributes(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[ResourceAttributes]], ResourceAttributes],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(ResourceAttributes)
    ...
    class Builder(BaseBuilder):
        ...
        def spec(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[SubjectAccessReviewSpec]], SubjectAccessReviewSpec],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(SubjectAccessReviewSpec)
        ...
        def status(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[SubjectAccessReviewStatus]], SubjectAccessReviewStatus],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(SubjectAccessReviewStatus)
    ...
    class Builder(BaseBuilder):
        ...
        def spec(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[SelfSubjectAccessReviewSpec]], SelfSubjectAccessReviewSpec],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(SelfSubjectAccessReviewSpec)
            return self._set("spec", value)
    ...
    class Builder(BaseBuilder):
        ...
        def spec(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[SelfSubjectRulesReviewSpec]], SelfSubjectRulesReviewSpec],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(SelfSubjectRulesReviewSpec)
            return self._set("spec", value)
        ...
        def status(
            ...
            value_or_callback: Union[
                ...
                Callable[[Type[SubjectRulesReviewStatus]], SubjectRulesReviewStatus],
            ],
        ) -> Self:
            value = value_or_callback
            if callable(value_or_callback):
                value = value_or_callback(SubjectRulesReviewStatus)
            return self._set("status", value)
