...
_Bits = _lit[3, 4, 8, 24]
_ProbabilityType = _tc.ProbabilityType[_T] # expected int
_ProbabilitySeqNoDict = _uni[list, _collections.deque, set, frozenset, tuple]
_ProbabilitySeq = _uni[_ProbabilitySeqNoDict, dict]
_FileType = _tc.FileType
_FileMode = _tc.FileMode
_FileOpener = _tc.FileOpener
_HaveCodeType = _uni[
...
def _is_condition_callback(v: object, /) -> _tc.TypeIs[_cal[[_Any], bool]]:
    return _inspect.isfunction(v)
...
def _is_sequence_helper(v, /, type = _Any):
    ...
    if not isinstance(type, (_builtins_type, tuple)):
...
class Tense(
    ...
    @classmethod
    def abroadHex(self, value1: _AbroadValue1[_T1], /, value2: _AbroadValue2[_T2] = None, modifier: _AbroadModifier[_T3] = None, mode: _constants.AbroadHexMode = ABROAD_HEX_INCLUDE):
        """
        \\@since 0.3.25
        ```ts
        // created 10.07.2024
    ...
    @classmethod
    def toString(self, v: _tc.Object = ..., /):
        """
        \\@since 0.3.26rc3
        ```ts
        "class method" in class Tense
    ...
    @classmethod
    def isNone(self, v, /) -> _tc.TypeIs[None]:
        """
        \\@since 0.3.26b3
        ```ts
        "class method" in class Tense
    ...
    @classmethod
    def isEllipsis(self, v, /) -> _tc.TypeIs[_tc.Ellipsis]:
        """
        \\@since 0.3.26
        ```ts
        "class method" in class Tense
    ...
    @classmethod
    def isBool(self, v: object, /) -> _tc.TypeIs[bool]:
        """
        \\@since 0.3.26b3
        ```ts
        "class method" in class Tense
    ...
    @classmethod
    def isBoolean(self, v: object, /) -> _tc.TypeIs[bool]:
        """
        \\@since 0.3.26rc1
        ```ts
        "class method" in class Tense
    ...
    @classmethod
    def isInt(self, v: object, /) -> _tc.TypeIs[int]:
        """
        \\@since 0.3.26b3
        ```ts
        "class method" in class Tense
    ...
    @classmethod
    def isInteger(self, v: object, /) -> _tc.TypeIs[int]:
        """
        \\@since 0.3.26rc1
        ```ts
        "class method" in class Tense
    ...
    @classmethod
    def isFloat(self, v: object, /) -> _tc.TypeIs[float]:
        """
        \\@since 0.3.26b3
        ```ts
        "class method" in class Tense
    ...
    @classmethod
    def isComplex(self, v: object, /) -> _tc.TypeIs[complex]:
        """
        \\@since 0.3.26b3
        ```ts
        "class method" in class Tense
        ...
        """
        return type(v) is complex
    
    @classmethod
    def isStr(self, v: object, /) -> _tc.TypeIs[str]:
        """
        \\@since 0.3.26b3
        ```ts
        "class method" in class Tense
    ...
    @classmethod
    def isString(self, v: object, /) -> _tc.TypeIs[str]:
        """
        \\@since 0.3.26rc1
        ```ts
        "class method" in class Tense
    ...
    if False:
        ...
        @classmethod
        @_tc.overload
        def isTuple(self, v: object, type: type[_T] = _Any, /) -> _tc.TypeIs[tuple[_T, ...]]:
            """
            \\@since 0.3.26rc1
        ...
        def isTuple(self, v: object, type: type[_T], /, *types: _tc.Unpack[_Ts]) -> _tc.TypeIs[tuple[_T, _tc.Unpack[_Ts]]]:
            """
            \\@since 0.3.26rc1
        ...
        @classmethod
        @_tc.overload
        def isTuple(self, v: object, /, type: tuple[type[_T], ...]) -> _tc.TypeIs[tuple[_T, ...]]: ...
        ...
        @classmethod
        @_tc.overload
        def isList(self, v: object, /, type: type[_T] = _Any) -> _tc.TypeIs[list[_T]]: ...
        
        @classmethod
        @_tc.overload
        def isList(self, v: object, /, type: tuple[type[_T], ...]) -> _tc.TypeIs[list[_T]]: ...
        ...
        @classmethod
        @_tc.overload
        def isDict(self, v: object, /, ktype: type[_KT] = _Any, vtype: type[_VT] = _Any) -> _tc.TypeIs[dict[_KT, _VT]]: ...
        
        @classmethod
        @_tc.overload
        def isDict(self, v: object, /, ktype: tuple[type[_KT], ...], vtype: type[_VT] = _Any) -> _tc.TypeIs[dict[_KT, _VT]]: ...
        
        @classmethod
        @_tc.overload
        def isDict(self, v: object, /, ktype: tuple[type[_KT], ...], vtype: tuple[type[_VT], ...]) -> _tc.TypeIs[dict[_KT, _VT]]: ...
    ...
    @classmethod
    @_tc.overload
    def isSet(self, v: object, /, type: type[_T] = _Any) -> _tc.TypeIs[set[_T]]: ...
    
    @classmethod
    @_tc.overload
    def isSet(self, v: object, /, type: tuple[type[_T], ...]) -> _tc.TypeIs[set[_T]]: ...
    ...
    @classmethod
    @_tc.overload
    def isFrozenSet(self, v: object, /, type: type[_T] = _Any) -> _tc.TypeIs[frozenset[_T]]: ...
    
    @classmethod
    @_tc.overload
    def isFrozenSet(self, v: object, /, type: tuple[type[_T], ...]) -> _tc.TypeIs[frozenset[_T]]: ...
    ...
    @classmethod
    def isBytes(self, v: object, /) -> _tc.TypeIs[bytes]: # not generic
        """
        \\@since 0.3.35
    ...
    @classmethod
    def isByteArray(self, v: object, /) -> _tc.TypeIs[bytearray]: # not generic
        """
        \\@since 0.3.35
    ...
    @classmethod
    def isMemoryView(self, v: object, /) -> _tc.TypeIs[memoryview]: # generic, with default value 'int'
        """
        \\@since 0.3.35
    ...
    @classmethod
    def isClass(self, v: object, /) -> _tc.TypeIs[type[_Any]]:
        """
        \\@since 0.3.35
    ...
    @classmethod
    def isFunction(self, v: object, /) -> _tc.TypeIs[_types.FunctionType]: # not generic
        """
        \\@since 0.3.35
    ...
    @classmethod
    @_tc.overload
    def hasattr(self, o: object, attr: tuple[str, ...], /, mode: _lit["and", "or"] = "or") -> bool: ...
            
    @classmethod
    def hasattr(self, o, attr, /, mode = "or"):
        """
        \\@since 0.3.34
    ...
    def explode(self, s: str, /, separator: _opt[str] = None, max = -1, no_empty = False):
        ...
        """
        _params = [k for k in self.explode.__annotations__ if k not in ("self", "return")]
    ...
    @classmethod
    def clear(self, *v: _tc.Union[_tc.MutableSequence[_T], str]):
        """
        \\@since 0.3.27a4
        ```ts
        "class method" in class Tense
        ...
        for seq in v:
            ...
            elif isinstance(seq, _tc.MutableSequence):
                seq.clear()
    ...
    def randstr(self, lower = True, upper = True, digits = True, special = True, length = 10):
        ...
        conv.clear()
        ret = ""
        _ALPHA = _string.ascii_lowercase # abcdefghijklmnopqrstuvwxyz
        _DIGITS = _string.digits # 0123456789
        _SPECIAL = r"""`~!@#$%^&*()-_=+[]{};:'"\|,.<>/?""" # gimmick from 'string' module
        
        if lower:
            conv.extend([e for e in _ALPHA])
                
        if upper:
            conv.extend([e for e in _ALPHA.upper()])
                
        if digits:
            conv.extend([e for e in _DIGITS])
                
        if special:
            conv.extend([e for e in _SPECIAL])
    ...
    def probability(self, *vf: _ProbabilityType[int], length: _ProbabilityLengthType = PROBABILITY_COMPUTE):
        ...
        *Parameters*:
        ...
        # once parameter names are changed
        # note that 'return' keyword is reserved for return annotation with '->' operator
        _params = [k for k in self.probability.__annotations__ if k not in ("self", "return")]
...
_T_stringOrIterable = _var("_T_stringOrIterable", bound = _uni[str, _tc.Iterable[str]])
