...
def deploy(
    ...
    **kwargs,
    ...
    monitoring_url = "https://docs.databricks.com/en/generative-ai/agent-evaluation/evaluating-production-traffic.html?utm_source=agents.deploy&utm_medium=python-sdk"
    user_message = f"""
    ...
    Monitoring guide: {monitoring_url}
    """
