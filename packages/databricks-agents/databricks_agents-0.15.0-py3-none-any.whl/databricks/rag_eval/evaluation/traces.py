...
def _extract_tool_calls_from_trace(
    ...
    TODO(ML-48960): Make this impl second-class in favor of `mlflow.chat.messages` once it's available
    :param trace: The trace
    :return: List of tool call invocations
    """
    tool_spans = [
        ...
        if _span_is_type(span, mlflow_entities.SpanType.TOOL)
    ]
    ...
    *,
    ...
    try:
        ...
        if trace is not None:
            ...
            return _extract_tool_calls_from_trace(trace)
