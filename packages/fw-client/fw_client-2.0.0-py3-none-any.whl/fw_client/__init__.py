...
httpx.Client.__bases__ = (ProxyBaseClient,)
httpx.AsyncClient.__bases__ = (ProxyBaseClient,)
httpx.Response.json = _json
httpx.Response.raise_for_status = _raise_for_status
httpx.Response.__enter__ = resp__enter__
httpx.Response.__exit__ = resp__exit__
httpx.Response.__aenter__ = resp__aenter__
httpx.Response.__aexit__ = resp__aexit__
httpx.Response.raw = property(raw_prop)
httpx.Response.iter_bytes = iter_bytes
httpx.Response.iter_raw = iter_raw
httpx.Response.iter_text = iter_text
httpx.Response.iter_jsonl = iter_jsonl
httpx.Response.iter_parts = iter_parts
httpx.Response.iter_events = iter_events
httpx.Response.iter_content = httpx.Response.iter_bytes
httpx.Response.aiter_bytes = aiter_bytes
httpx.Response.aiter_raw = aiter_raw
httpx.Response.aiter_text = aiter_text
httpx.Response.aiter_jsonl = aiter_jsonl
httpx.Response.aiter_parts = aiter_parts
httpx.Response.aiter_events = aiter_events

# patch the exceptions for more useful default error messages
setattr(HTTPError, "__getattr__", errors.http_error_getattr)
