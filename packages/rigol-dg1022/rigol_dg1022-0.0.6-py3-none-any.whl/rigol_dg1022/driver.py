"""
Copyright (c) YEAR ABB Stotz Kontakt GmbH <your.email@de.abb.com>
...
class RigolDG1022:
    ...
    def __init__(
        ...
        try:
            # Thread-safe creation of ResourceManager
    ...
    def _send_command(self, command, check_errors=False, delay=0.01):
        """
        Send a command to the device and optionally check for errors.
        ...
        try:
            ...
            self.logger.error(f"Communication error while sending command '{command}': {str(e)}")
            raise
        except Exception as e:
    ...
    def _query(self, query):
        ...
        try:
            ...
            self.logger.error(f"Communication error while querying '{query}': {str(e)}")
            raise
        except Exception as e:
