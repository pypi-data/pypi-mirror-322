...
setuptools.setup(
    name='pollination-ladybug-radiance',                                   # will be used for package name unless it is overwritten using __queenbee__ info.
    ...
    url='https://github.com/pollination/pollination-ladybug-radiance',     # will be translated to home
    project_urls={
        'icon': 'https://raw.githubusercontent.com/ladybug-tools/artwork/master/icons_bugs/grasshopper_tabs/HB-Radiance.png',
        'docker': 'https://hub.docker.com/r/ladybugtools/ladybug-radiance'
    },
    description='Ladybug Radiance plugin for Pollination.',                # will be used as package description
    ...
    keywords='ladybug, radiance, ladybug-tools, daylight',                 # will be used as keywords
