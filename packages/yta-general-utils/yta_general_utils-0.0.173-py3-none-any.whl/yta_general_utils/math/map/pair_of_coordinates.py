...
class PairOfCoordinates:
    ...
    rate_function: RateFunction = None
    ...
    def __init__(self, first_coordinate: Coordinate, second_coordinate: Coordinate, rate_function: RateFunction = RateFunction.EASE_IN_OUT_SINE):
        rate_function = RateFunction.to_enum(rate_function)
    ...
    def get_n_xy_values_to_plot(self, n: int = 100, do_normalize: bool = False) -> list[tuple[NormalizableValue, NormalizableValue]]:
        ...
        xs = [
            ...
            for x in Progression(self.min_x, self.max_x, 100, RateFunction.LINEAR).values
        ]
        ys = [
