...
class Progression:
    ...
    """
    _rate_function: RateFunction = None
    """
    ...
    def __init__(self, start: float, end: float, n: int, rate_function: RateFunction = RateFunction.LINEAR):
    ...
    @staticmethod
    def get_n_normalized_values(n: int, rate_function: RateFunction = RateFunction.LINEAR):
        """
