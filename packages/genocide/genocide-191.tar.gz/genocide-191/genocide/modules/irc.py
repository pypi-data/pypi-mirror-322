...
from genocide.objects import Default, Object, edit, fmt, keys
from genocide.persist import ident, last, write
from genocide.runtime import Event, Reactor, later, launch
