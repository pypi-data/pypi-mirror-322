...
#how to use it in terminal--
 #for batch processing-- python sourcecode.py /FE_Documents/ISIN/ /home/harish/intern/language_clustering/filenames_csv.csv /home/harish 4
 #single pdf processing --python sourcecode.py /FE_Documents/ISIN/ES1316617-ES1028292-ES1430422.pdf
