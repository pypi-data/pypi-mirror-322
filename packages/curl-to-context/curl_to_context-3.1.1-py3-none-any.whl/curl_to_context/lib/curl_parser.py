...
class CurlParser:
    ...
    def parse_curl(curl_command: str) -> Dict[str, Any]:
        ...
        parser.add_argument('-b', '--data-binary', '--data-raw', '--data-raw', default=None)
        parser.add_argument('--data-raw', default=None)  # Add explicit --data-raw support
        ...
        try:
            # Use shlex.split with posix=True to handle quotes properly
            ...
            post_data = (parsed_args.data or 
                        parsed_args.data_binary or 
                        getattr(parsed_args, 'data_raw', None))
