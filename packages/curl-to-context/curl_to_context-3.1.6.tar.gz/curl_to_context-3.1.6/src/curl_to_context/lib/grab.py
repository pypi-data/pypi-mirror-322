...
class GrabCodeWriter:
    ...
    def _generate_params(self) -> str:
        ...
        if not self.parsed.get('data') or 'sunexpress.com/pricing/api/v1/journeys' in self.parsed['url']:
            return ''
    ...
    def _generate_request(self) -> str:
        ...
        # Special case for sunexpress endpoint
        if 'sunexpress.com/pricing/api/v1/journeys' in url:
