...
app = typer.Typer(help="Convert cURL commands to Python code for Grab/Context frameworks")
...
def convert(
    ...
    show: bool = typer.Option(
        ...
        "--show",
        "-s", 
        help="Show the converted code instead of copying to clipboard"
    )
):
