...
class Private(LoggerHelper):
    ...
    def get_column_value(self, schema_json, column_name): # 0.0.39
    ...
    def generate_schema_json(self, params, schema_json):  # 0.0.39
    ...
    def get_date(self, df, input_param): # 0.0.39
