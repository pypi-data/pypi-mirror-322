...
class TestActionsAllActive(TestCase):
    ...
    def test_single_action_lone_msg(self):
        acc_names = []
        acc_count = 5
        for i in range(5):
            acc_names.append(f"user{i}")
        ...
        int_mat[DiscordActivity.Lone_msg][1, 1] = 2
    ...
    def test_multiple_actions_lone_msg(self):
        acc_names = []
        acc_count = 5
        for i in range(5):
            acc_names.append(f"user{i}")
        ...
        int_mat[DiscordActivity.Lone_msg][1, 1] = 2
        int_mat[DiscordActivity.Lone_msg][2, 2] = 3
        int_mat[DiscordActivity.Lone_msg][3, 3] = 1
