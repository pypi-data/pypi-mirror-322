...
class TestAnalyzer40daysRunOnceOverlappign(IsolatedAsyncioTestCase):
    async def test_analyzer_40days_period_run_once_available_analytics_overlapping_period(
        self,
    ):
        """
