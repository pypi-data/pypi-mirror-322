...
class TestAnalyzerThreeMonthsRecomputeAvailableData(IsolatedAsyncioTestCase):
    async def test_analyzer_three_month_period_recompute_available_analytics(self):
        """
