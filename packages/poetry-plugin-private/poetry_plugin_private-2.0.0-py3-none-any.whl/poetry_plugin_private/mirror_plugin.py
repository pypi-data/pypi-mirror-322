...
class SourceStrippedLegacyRepository(LegacyRepository):
    ...
    def __init__(self, name: str, url: str, *, config: Config | None = None, disable_cache: bool = False,
                 pool_size: int = DEFAULT_POOLSIZE) -> None:
        super().__init__(name, url, config=config, disable_cache=disable_cache, pool_size=pool_size)
