...
_shtab_makex_run_option_strings=('-h' '--help' '--python-audit' '--directory' '--force' '--dry' '--cpus')
_shtab_makex_path_option_strings=('-h' '--help' '--python-audit' '--real')
_shtab_makex_dot_option_strings=('-h' '--help' '--python-audit' '--files' '--ignore' '--cpus')
_shtab_makex_affected_option_strings=('-h' '--help' '--python-audit' '--scope' '--cpus')
_shtab_makex_inputs_option_strings=('-h' '--help' '--python-audit' '--ignore' '--cpus')
_shtab_makex_outputs_option_strings=('-h' '--help' '--python-audit' '--ignore' '--cpus')
_shtab_makex_evaluate_option_strings=('-h' '--help' '--python-audit')
_shtab_makex_tasks_option_strings=('-h' '--help' '--python-audit' '--paths' '--prefix')
_shtab_makex_targets_option_strings=('-h' '--help' '--python-audit' '--paths' '--prefix')
_shtab_makex_completions_option_strings=('-h' '--help' '--python-audit' '--shell' '--internal')
_shtab_makex_workspace_option_strings=('-h' '--help' '--python-audit')
_shtab_makex_complete_option_strings=('-h' '--help' '--python-audit')
