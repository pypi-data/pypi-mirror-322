...
setuptools.setup(
    ...
    url='https://github.com/pollination/appendix-g-performance',                   # will be translated to home
    project_urls={
    ...
    description='Run an ASHRAE 90.1 Appendix G simulation and compute the Performance Cost Index (PCI) as well as LEED energy points.',                  # will be used as package description
    ...
    keywords='honeybee, energy, ladybug-tools, energyplus, openstudio, energy, appendix-g-performance',  # will be used as keywords
