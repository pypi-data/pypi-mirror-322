...
class PositionDto(BaseModel):
    ...
    PositionDto
    """ # noqa: E501
    as_of_date_time: datetime = Field(alias="asOfDateTime")
    symbol: StrictStr
    quantity: StrictInt
    price: Union[StrictFloat, StrictInt]
    weight: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["asOfDateTime", "symbol", "quantity", "price", "weight"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "asOfDateTime": obj.get("asOfDateTime"),
