...
'CGC_substrate_plot - Generates syntenic plots for CGC substrate prediction.', required=True)
    ...
    parser_easy_caz.add_argument('--input_raw_data', help='Specify the input fasta file for data preprocessing.')
    parser_easy_caz.add_argument('--mode', help='Check the mode of the input file: prok, meta, or protein')
    ...
    parser_easy_caz.add_argument('--output_dir', default='./output', help='Output folder.')
    parser_easy_caz.add_argument('--db_dir', default='./dbCAN_databases', help='Specify the directory to store the dbCAN database files.')
    ...
    parser_easy_cgc.add_argument('--input_raw_data', help='Specify the input fasta file for data preprocessing.')
    parser_easy_cgc.add_argument('--mode', help='Check the mode of the input file: prok, meta, or protein')
    ...
    parser_easy_cgc.add_argument('--output_dir', default='./output', help='Output folder.')
    parser_easy_cgc.add_argument('--db_dir', default='./dbCAN_databases', help='Specify the directory to store the dbCAN database files.')
    ...
    parser_easy_cgc.add_argument('--input_gff', help='Specify the input gff file for CGC annotation.')
    parser_easy_cgc.add_argument('--input_gff_format', default='NCBI_prok', choices=['NCBI_euk', 'JGI', 'NCBI_prok', 'prodigal'], help='Specify the input format for protein sequences.')
