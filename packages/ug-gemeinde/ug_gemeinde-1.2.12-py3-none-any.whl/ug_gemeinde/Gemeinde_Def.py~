...
def configuration():
    ...
    confDefault = """
        ...
        # Pfad zu den Icons
        #     In der Regel wird das ein symbolischer Link im aktuellen Verzeichnis
        #     sein, der auf die tatsächlichen Icons zeigt.
        #     Es ist sicher zu stellen, dass alle verwendeten Icons dort auch
        #     vorhanden sind.
        #     Programmiert ist das Ganze für Linux-Systeme auf
