...
from . import tasks# Импортируем файл с заданиями из текущего пакета
...
class RobotApp:
    ...
    def __init__(self, root):
        ...
        # Добавляем подменю в главное меню заданий
    ...
    def execute_code(self, code):
        ...
        try:
            ...
            globals_dict = {
                ...
                'running': self.running  # Используем self.running напрямую
            }
